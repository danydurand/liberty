        <?php
            if (isset($_SESSION['User'])) {
                ...
                $strAcceMobi = $objUsuaMobi->FechAcce;
            } else {
        ...
        <div data-role="panel" id="panel" data-position="right" data-theme="a" data-display="overlay">
            ...
            <nav>
                ...
                <div class="ui-block-a"><a href="acerca.php" type="button" data-role="button" id="pbtn" data-theme="b"><i class="fa fa-lg fa-briefcase pull-left"></i>Acerca</a></div>
