<?php 
    ...
    $arrCiudDisp = Ciudad::LoadArrayByEstadoId($intCodiEsta,QQ::OrderBy(QQN::Ciudad()->Nombre));
    ...
    <div data-role="page">
        ...
        <div data-role="content">
            ...
            <form action="registrar_cliente.php" method="post">
                ...
                <div class="ui-field-contain">
                    <label for="movi">Teléfono Móvil:</label>
                    <input type="number" name="movi" id="movi" placeholder="Teléfono Móvil" required>
                </div>                
                <div class="ui-field-contain">
                    <label for="fijo">Teléfono Fijo:</label>
                    <input type="number" name="fijo" id="fijo" placeholder="Teléfono Fijo" required>
                </div>
                <div class="ui-field-contain">
