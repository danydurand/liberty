...
class Registro extends QForm {
    ...
    protected function btnSave_Create() {
        ...
        $this->btnSave->Text = '<i class="fa fa-floppy-o fa-lg pull-left"></i> Guardar';
    ...
    protected function btnSave_Click() {
        ...
        $objCliente->ClaveAcceso        = $this->txtNumeCedu->Text;
        $objCliente->TelefonoMovil      = $this->txtTeleMovi->Text;
        $objCliente->TelefonoFijo       = $this->txtTeleFijo->Text;
        $objCliente->FechaNacimiento    = new QDateTime($this->txtFechNaci->Text);
        $objCliente->Direccion          = strtoupper($this->txtDireEntr->Text);
