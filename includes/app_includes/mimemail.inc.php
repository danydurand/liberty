...
/*
 +-------------------------------------------------------------------+
 |                     M I M E M A I L   (v2.0)                      |
 |                                                                   |
 | Copyright Gerd Tentler               www.gerd-tentler.de/tools    |
 | Created: Nov. 2, 2004                Last modified: Jan. 24, 2007 |
 +-------------------------------------------------------------------+
...
// Configuration
//--------------------------------------------------------------------------------------------------------
    public $type = 'Text';             // default e-mail type ("HTML" or "Text")
    public $senderName = '';           // default sender name
    public $senderMail = '';           // default sender e-mail address
    public $cc = '';                   // default cc (e-mail address)
    public $bcc = '';                  // default bcc (e-mail address)
    public $subject = '';              // default subject line
    public $priority = 'normal';       // default priority ("high", "normal", "low")

    public $documentRoot = '';         // document root (path to images, stylesheets, etc.)
    public $saveDir = '';              // save e-mail to this directory instead of sending it => just for testing :)
//    public $charSet = 'ISO-8859-1';    // character set (ISO)
    public $charSet = 'UTF-8';    // character set (ISO)
    public $useQueue = false;          // use mail queue (true = yes, false = no) => does not work with PHP
...
//--------------------------------------------------------------------------------------------------------
    ...
    public $cnt = 0;
    public $body, $header, $footer, $error, $subjectLine, $bodyText;
    public $uid1, $uid2, $uid3;
    public $created = false;
    public $exclude = array('htm', 'php', 'pl', 'prl', 'cgi', 'py', 'asp');
    public $mimeTypes = array('dwg'     => 'application/acad',
