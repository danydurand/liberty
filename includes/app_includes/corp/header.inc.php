    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="color: white; text-decoration: none" href="<?= __YAMAGUCHI__.'/mg.php'?>">LibertyExpress | Sistema CORP | <?= ucwords(strtolower($strDatoClie)) ?></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href=<?= __YAMAGUCHI__."/cambiar_clave.php"?>><i class="fa fa-key fa-fw"></i> Cambiar Clave</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href=<?= __YAMAGUCHI__."/logout.php"?>><i class="fa fa-sign-out fa-fw"></i> Salir</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
