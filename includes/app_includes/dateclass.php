...
class DateClass
{
	...
	//----------------------------
	protected $_Date;      //base timestamp value for this class
	protected $_datePart; // array of returned by getdate($_Date)
	protected $_format;   // last format passed to ToString()
	
	//========================================================
	// constructor
	//========================================================
	public function DateClass($dateTime="")
	{
	...
	//=========================================================
	public function DatePart($datePart="",$dateTime="")
	{
	...
	public function Minutes($dateTime="")
	{
		if ($dateTime) $this->SetDate($dateTime);
		return $this->DatePart("minutes");
	}
	public function Seconds($dateTime="")
	{
		if ($dateTime) $this->SetDate($dateTime);
	...
	//===========================================================
    public function Add($datePart,$adjustValue,$dateTime="") 
	{
		if ($dateTime) $this->SetDate($dateTime);
	...
	//===========================================================
	public function Quarter($qDate="",$dateTime="")
	{
		if ($dateTime) $this->SetDate($dateTime);		
		switch($this->Month())
		{
	...
	//	not modify existing class value
	//===========================================================
	public function BOQ($quarter=0,$dateTime="")
	{
		if ($dateTime) $this->SetDate($DateTime);
	...
	//	not modify existing class value
	//===========================================================
	public function EOQ($quarter=0,$dateTime="")
	{
		if ($dateTime) $this->SetDate($DateTime);
	...
	//===========================================================
	public function ToString($format="",$dateTime="")
	{
		if ($dateTime) $this->SetDate($dateTime);
...
class DateSpanClass
{
	...
	protected $_format; 
	protected $_years;
	protected $_spandir; // 1 = positive span, -1 = negative span
