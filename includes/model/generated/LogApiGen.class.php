<?php
	/**
	 * The abstract LogApiGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the LogApi subclass which
	 * extends this LogApiGen class.
	 *
	 ...
	 * @property string $Accion the value for strAccion (Not Null)
	 * @property string $Descripcion the value for strDescripcion (Not Null)
	 * @property integer $ResultadoId the value for intResultadoId 
	 ...
	 */
	class LogApiGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column log_api.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column log_api.fecha
		...
		/**
		 * Protected member variable that maps to the database column log_api.hora
		...
		/**
		 * Protected member variable that maps to the database column log_api.tabla
		 * @var string strTabla
		 */
		protected $strTabla;
		const TablaMaxLength = 100;
		const TablaDefault = null;


		/**
		 * Protected member variable that maps to the database column log_api.referencia
		 * @var string strReferencia
		 */
		protected $strReferencia;
		const ReferenciaMaxLength = 50;
		const ReferenciaDefault = null;


		/**
		 * Protected member variable that maps to the database column log_api.nombre
		...
		/**
		 * Protected member variable that maps to the database column log_api.accion
		 * @var string strAccion
		 */
		protected $strAccion;
		const AccionMaxLength = 100;
		const AccionDefault = null;


		/**
		 * Protected member variable that maps to the database column log_api.descripcion
		...
		/**
		 * Protected member variable that maps to the database column log_api.resultado_id
		 * @var integer intResultadoId
		 */
		protected $intResultadoId;
		const ResultadoIdDefault = null;


		/**
		 * Protected member variable that maps to the database column log_api.tipo
		 * @var string strTipo
		 */
		protected $strTipo;
		...
		/**
		 * Protected member variable that maps to the database column log_api.token
		 * @var string strToken
		 */
		protected $strToken;
		const TokenMaxLength = 25;
		...
		{
			$this->intId = LogApi::IdDefault;
			$this->dttFecha = (LogApi::FechaDefault === null)?null:new QDateTime(LogApi::FechaDefault);
			$this->dttHora = (LogApi::HoraDefault === null)?null:new QDateTime(LogApi::HoraDefault);
			$this->strTabla = LogApi::TablaDefault;
			$this->strReferencia = LogApi::ReferenciaDefault;
			$this->strNombre = LogApi::NombreDefault;
			$this->strAccion = LogApi::AccionDefault;
			$this->strDescripcion = LogApi::DescripcionDefault;
			$this->intResultadoId = LogApi::ResultadoIdDefault;
			$this->strTipo = LogApi::TipoDefault;
			$this->strToken = LogApi::TokenDefault;
		}
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'LogApi', $intId);
			...
			$objToReturn = LogApi::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::LogApi()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call LogApi::QueryArray to perform the LoadAll query
			try {
				return LogApi::QueryArray(QQ::All(), $objOptionalClauses);
		...
		public static function CountAll() {
			// Call LogApi::QueryCount to perform the CountAll query
			return LogApi::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = LogApi::GetDatabase();

			// Create/Build out the QueryBuilder object with LogApi-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'log_api');
			...
			if ($blnAddAllFieldsToSelect) {
				LogApi::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('log_api');
		...
		/**
		 * Static Qcubed Query method to query for a single LogApi object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return LogApi the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = LogApi::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new LogApi object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = LogApi::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return LogApi::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of LogApi objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return LogApi[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return LogApi::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of LogApi objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = LogApi::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/logapi', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = LogApi::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this LogApi
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null, QQSelect $objSelect = null) {
            ...
            if ($objSelect) {
			    ...
			    $objBuilder->AddSelectItem($strTableName, 'resultado_id', $strAliasPrefix . 'resultado_id');
		...
		/**
		 * Instantiate a LogApi from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this LogApi::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a LogApi, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			// Create a new instance of the LogApi object
			$objToReturn = new LogApi();
			...
			$strAlias = $strAliasPrefix . 'accion';
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			...
			$strAlias = $strAliasPrefix . 'resultado_id';
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objToReturn->intResultadoId = $objDbRow->GetColumn($strAliasName, 'Integer');
		...
		/**
		 * Instantiate an array of LogApis from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = LogApi::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = LogApi::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single LogApi object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return LogApi next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return LogApi::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		*/
				...
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$objDatabase->NonQuery('
						INSERT INTO `log_api` (
							...
							' . $objDatabase->SqlVariable($this->intResultadoId) . ',
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('log_api', 'id');
				} else {
					...
					$objDatabase->NonQuery('
						...
						SET
							...
							`resultado_id` = ' . $objDatabase->SqlVariable($this->intResultadoId) . ',
		...
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this LogApi with an unset primary key.');
        ...
        /**
 	     * Delete this LogApi ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'LogApi', $this->intId);
		...
		/**
		 * Reload this LogApi from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved LogApi object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = LogApi::Load($this->intId);
			...
			$this->intResultadoId = $objReloaded->intResultadoId;
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'Accion':
					/**
					 * Gets the value for strAccion (Not Null)
					 * @return string
					 */
				...
				case 'ResultadoId':
					/**
					 * Gets the value for intResultadoId 
					 * @return integer
					 */
					return $this->intResultadoId;
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'Accion':
					/**
					 * Sets the value for strAccion (Not Null)
					 * @param string $mixValue
					 * @return string
					 */
					try {
				...
				case 'ResultadoId':
					/**
					 * Sets the value for intResultadoId 
					 * @param integer $mixValue
					 * @return integer
					 */
					try {
						return ($this->intResultadoId = QType::Cast($mixValue, QType::Integer));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[LogApi::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="LogApi"><sequence>';
			...
			$strToReturn .= '<element name="ResultadoId" type="xsd:int"/>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('LogApi', $strComplexTypeArray)) {
				$strComplexTypeArray['LogApi'] = LogApi::GetSoapComplexTypeXml();
			}
		}
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, LogApi::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetObjectFromSoapObject($objSoapObject) {
			...
			if (property_exists($objSoapObject, 'ResultadoId'))
				$objToReturn->intResultadoId = $objSoapObject->ResultadoId;
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, LogApi::GetSoapObjectFromObject($objObject, true));
		...
		public function getIterator() {
			...
			$iArray['Accion'] = $this->strAccion;
			$iArray['Descripcion'] = $this->strDescripcion;
			$iArray['ResultadoId'] = $this->intResultadoId;
     ...
     * @property-read QQNode $Accion
     * @property-read QQNode $Descripcion
     * @property-read QQNode $ResultadoId
     ...
     **/
	class QQNodeLogApi extends QQNode {
		protected $strTableName = 'log_api';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'LogApi';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
				...
				case 'Accion':
					return new QQNode('accion', 'Accion', 'VarChar', $this);
				case 'Descripcion':
					return new QQNode('descripcion', 'Descripcion', 'Blob', $this);
				case 'ResultadoId':
					return new QQNode('resultado_id', 'ResultadoId', 'Integer', $this);
				case 'Tipo':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeLogApi extends QQReverseReferenceNode {
		protected $strTableName = 'log_api';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'LogApi';
		public function __get($strName) {
