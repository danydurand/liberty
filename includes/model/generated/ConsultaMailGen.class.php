<?php
	/**
	 * The abstract ConsultaMailGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the ConsultaMail subclass which
	 * extends this ConsultaMailGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the ConsultaMail class.
	 *
	 ...
	 */
	class ConsultaMailGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column consulta_mail.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.cliente_id
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.cedula
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.guia_id
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.fecha_email
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.fecha_registro
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.hora_registro
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.email
		 * @var string strEmail
		 */
		protected $strEmail;
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.procesado
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.fecha_procesado
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.hora_procesado
		...
		/**
		 * Protected member variable that maps to the database column consulta_mail.status
		...
		{
			$this->intId = ConsultaMail::IdDefault;
			$this->strClienteId = ConsultaMail::ClienteIdDefault;
			$this->strCedula = ConsultaMail::CedulaDefault;
			$this->strGuiaId = ConsultaMail::GuiaIdDefault;
			$this->strFechaEmail = ConsultaMail::FechaEmailDefault;
			$this->dttFechaRegistro = (ConsultaMail::FechaRegistroDefault === null)?null:new QDateTime(ConsultaMail::FechaRegistroDefault);
			$this->strHoraRegistro = ConsultaMail::HoraRegistroDefault;
			$this->strEmail = ConsultaMail::EmailDefault;
			$this->intProcesado = ConsultaMail::ProcesadoDefault;
			$this->dttFechaProcesado = (ConsultaMail::FechaProcesadoDefault === null)?null:new QDateTime(ConsultaMail::FechaProcesadoDefault);
			$this->strHoraProcesado = ConsultaMail::HoraProcesadoDefault;
			$this->strStatus = ConsultaMail::StatusDefault;
		}
		...
		/**
		 * Load a ConsultaMail from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'ConsultaMail', $intId);
			...
			$objToReturn = ConsultaMail::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::ConsultaMail()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call ConsultaMail::QueryArray to perform the LoadAll query
			try {
				return ConsultaMail::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all ConsultaMails
		 * @return int
		 */
		public static function CountAll() {
			// Call ConsultaMail::QueryCount to perform the CountAll query
			return ConsultaMail::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = ConsultaMail::GetDatabase();

			// Create/Build out the QueryBuilder object with ConsultaMail-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'consulta_mail');
			...
			if ($blnAddAllFieldsToSelect) {
				ConsultaMail::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('consulta_mail');
		...
		/**
		 * Static Qcubed Query method to query for a single ConsultaMail object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return ConsultaMail the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = ConsultaMail::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new ConsultaMail object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = ConsultaMail::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return ConsultaMail::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of ConsultaMail objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return ConsultaMail[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return ConsultaMail::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of ConsultaMail objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = ConsultaMail::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/consultamail', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = ConsultaMail::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this ConsultaMail
		...
		/**
		 * Instantiate a ConsultaMail from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this ConsultaMail::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a ConsultaMail, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			// Create a new instance of the ConsultaMail object
			$objToReturn = new ConsultaMail();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'consulta_mail__';
		...
		/**
		 * Instantiate an array of ConsultaMails from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = ConsultaMail::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = ConsultaMail::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single ConsultaMail object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return ConsultaMail next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return ConsultaMail::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single ConsultaMail object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return ConsultaMail
		*/
		public static function LoadById($intId, $objOptionalClauses = null) {
			return ConsultaMail::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::ConsultaMail()->Id, $intId)
				),
				$objOptionalClauses
		...
		/**
		 * Load an array of ConsultaMail objects,
		...
		*/
		public static function LoadArrayByProcesado($intProcesado, $objOptionalClauses = null) {
			// Call ConsultaMail::QueryArray to perform the LoadArrayByProcesado query
			try {
				return ConsultaMail::QueryArray(
					QQ::Equal(QQN::ConsultaMail()->Procesado, $intProcesado),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByProcesado($intProcesado) {
			// Call ConsultaMail::QueryCount to perform the CountByProcesado query
			return ConsultaMail::QueryCount(
				QQ::Equal(QQN::ConsultaMail()->Procesado, $intProcesado)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('consulta_mail', 'id');
				} else {
		...
		/**
		 * Delete this ConsultaMail
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this ConsultaMail with an unset primary key.');
        ...
        /**
 	     * Delete this ConsultaMail ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'ConsultaMail', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all ConsultaMails
		 * @return void
		 */
		...
		/**
		 * Reload this ConsultaMail from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved ConsultaMail object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = ConsultaMail::Load($this->intId);
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[ConsultaMail::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="ConsultaMail"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('ConsultaMail', $strComplexTypeArray)) {
				$strComplexTypeArray['ConsultaMail'] = ConsultaMail::GetSoapComplexTypeXml();
			}
		}
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, ConsultaMail::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, ConsultaMail::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeConsultaMail extends QQNode {
		protected $strTableName = 'consulta_mail';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'ConsultaMail';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeConsultaMail extends QQReverseReferenceNode {
		protected $strTableName = 'consulta_mail';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'ConsultaMail';
		public function __get($strName) {
