<?php
	/**
	 * The abstract SreGuiaCkptGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the SreGuiaCkpt subclass which
	 * extends this SreGuiaCkptGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the SreGuiaCkpt class.
	 *
	 ...
	 */
	class SreGuiaCkptGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK column sre_guia_ckpt.nume_guia
		...
		/**
		 * Protected member variable that maps to the database PK column sre_guia_ckpt.codi_esta
		...
		/**
		 * Protected member variable that maps to the database PK column sre_guia_ckpt.codi_ckpt
		...
		/**
		 * Protected member variable that maps to the database PK column sre_guia_ckpt.fech_ckpt
		...
		/**
		 * Protected member variable that maps to the database PK column sre_guia_ckpt.hora_ckpt
		...
		/**
		 * Protected member variable that maps to the database column sre_guia_ckpt.text_obse
		...
		/**
		 * Protected member variable that maps to the database column sre_guia_ckpt.codi_ruta
		...
		/**
		 * Protected member variable that maps to the database column sre_guia_ckpt.codi_usua
		 ...
		 * in the database column sre_guia_ckpt.nume_guia.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column sre_guia_ckpt.codi_esta.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column sre_guia_ckpt.codi_ckpt.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column sre_guia_ckpt.codi_usua.
		 *
		...
		{
			$this->strNumeGuia = SreGuiaCkpt::NumeGuiaDefault;
			$this->strCodiEsta = SreGuiaCkpt::CodiEstaDefault;
			$this->strCodiCkpt = SreGuiaCkpt::CodiCkptDefault;
			$this->dttFechCkpt = (SreGuiaCkpt::FechCkptDefault === null)?null:new QDateTime(SreGuiaCkpt::FechCkptDefault);
			$this->strHoraCkpt = SreGuiaCkpt::HoraCkptDefault;
			$this->strTextObse = SreGuiaCkpt::TextObseDefault;
			$this->strCodiRuta = SreGuiaCkpt::CodiRutaDefault;
			$this->intCodiUsua = SreGuiaCkpt::CodiUsuaDefault;
		}
		...
		/**
		 * Load a SreGuiaCkpt from PK Info
		...
		public static function Load($strNumeGuia, $strCodiEsta, $strCodiCkpt, $dttFechCkpt, $strHoraCkpt, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'SreGuiaCkpt', $strNumeGuia, $strCodiEsta, $strCodiCkpt, $dttFechCkpt, $strHoraCkpt);
			...
			$objToReturn = SreGuiaCkpt::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::SreGuiaCkpt()->NumeGuia, $strNumeGuia),
					QQ::Equal(QQN::SreGuiaCkpt()->CodiEsta, $strCodiEsta),
					QQ::Equal(QQN::SreGuiaCkpt()->CodiCkpt, $strCodiCkpt),
					QQ::Equal(QQN::SreGuiaCkpt()->FechCkpt, $dttFechCkpt),
					QQ::Equal(QQN::SreGuiaCkpt()->HoraCkpt, $strHoraCkpt)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call SreGuiaCkpt::QueryArray to perform the LoadAll query
			try {
				return SreGuiaCkpt::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all SreGuiaCkpts
		 * @return int
		 */
		public static function CountAll() {
			// Call SreGuiaCkpt::QueryCount to perform the CountAll query
			return SreGuiaCkpt::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = SreGuiaCkpt::GetDatabase();

			// Create/Build out the QueryBuilder object with SreGuiaCkpt-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'sre_guia_ckpt');
			...
			if ($blnAddAllFieldsToSelect) {
				SreGuiaCkpt::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('sre_guia_ckpt');
		...
		/**
		 * Static Qcubed Query method to query for a single SreGuiaCkpt object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return SreGuiaCkpt the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = SreGuiaCkpt::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new SreGuiaCkpt object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = SreGuiaCkpt::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return SreGuiaCkpt::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of SreGuiaCkpt objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return SreGuiaCkpt[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return SreGuiaCkpt::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of SreGuiaCkpt objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = SreGuiaCkpt::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/sreguiackpt', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = SreGuiaCkpt::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this SreGuiaCkpt
		...
		/**
		 * Instantiate a SreGuiaCkpt from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this SreGuiaCkpt::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a SreGuiaCkpt, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (SreGuiaCkpt::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the SreGuiaCkpt object
			$objToReturn = new SreGuiaCkpt();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'sre_guia_ckpt__';
		...
		/**
		 * Instantiate an array of SreGuiaCkpts from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = SreGuiaCkpt::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->strNumeGuia][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = SreGuiaCkpt::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single SreGuiaCkpt object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return SreGuiaCkpt next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return SreGuiaCkpt::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single SreGuiaCkpt object,
		...
		*/
		public static function LoadByNumeGuiaCodiEstaCodiCkptFechCkptHoraCkpt($strNumeGuia, $strCodiEsta, $strCodiCkpt, $dttFechCkpt, $strHoraCkpt, $objOptionalClauses = null) {
			return SreGuiaCkpt::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::SreGuiaCkpt()->NumeGuia, $strNumeGuia),
					QQ::Equal(QQN::SreGuiaCkpt()->CodiEsta, $strCodiEsta),
					QQ::Equal(QQN::SreGuiaCkpt()->CodiCkpt, $strCodiCkpt),
		...
		/**
		 * Load an array of SreGuiaCkpt objects,
		...
		*/
		public static function LoadArrayByCodiEsta($strCodiEsta, $objOptionalClauses = null) {
			// Call SreGuiaCkpt::QueryArray to perform the LoadArrayByCodiEsta query
			try {
				return SreGuiaCkpt::QueryArray(
					QQ::Equal(QQN::SreGuiaCkpt()->CodiEsta, $strCodiEsta),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
		...
		*/
		public static function CountByCodiEsta($strCodiEsta) {
			// Call SreGuiaCkpt::QueryCount to perform the CountByCodiEsta query
			return SreGuiaCkpt::QueryCount(
				QQ::Equal(QQN::SreGuiaCkpt()->CodiEsta, $strCodiEsta)
			);
		}
		...
		*/
		public static function LoadArrayByCodiCkpt($strCodiCkpt, $objOptionalClauses = null) {
			// Call SreGuiaCkpt::QueryArray to perform the LoadArrayByCodiCkpt query
			try {
				return SreGuiaCkpt::QueryArray(
					QQ::Equal(QQN::SreGuiaCkpt()->CodiCkpt, $strCodiCkpt),
					$objOptionalClauses);
		...
		*/
		public static function CountByCodiCkpt($strCodiCkpt) {
			// Call SreGuiaCkpt::QueryCount to perform the CountByCodiCkpt query
			return SreGuiaCkpt::QueryCount(
				QQ::Equal(QQN::SreGuiaCkpt()->CodiCkpt, $strCodiCkpt)
			);
		}
		...
		*/
		public static function LoadArrayByCodiRuta($strCodiRuta, $objOptionalClauses = null) {
			// Call SreGuiaCkpt::QueryArray to perform the LoadArrayByCodiRuta query
			try {
				return SreGuiaCkpt::QueryArray(
					QQ::Equal(QQN::SreGuiaCkpt()->CodiRuta, $strCodiRuta),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByCodiRuta($strCodiRuta) {
			// Call SreGuiaCkpt::QueryCount to perform the CountByCodiRuta query
			return SreGuiaCkpt::QueryCount(
				QQ::Equal(QQN::SreGuiaCkpt()->CodiRuta, $strCodiRuta)
			);
		}
		...
		*/
		public static function LoadArrayByCodiUsua($intCodiUsua, $objOptionalClauses = null) {
			// Call SreGuiaCkpt::QueryArray to perform the LoadArrayByCodiUsua query
			try {
				return SreGuiaCkpt::QueryArray(
					QQ::Equal(QQN::SreGuiaCkpt()->CodiUsua, $intCodiUsua),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByCodiUsua($intCodiUsua) {
			// Call SreGuiaCkpt::QueryCount to perform the CountByCodiUsua query
			return SreGuiaCkpt::QueryCount(
				QQ::Equal(QQN::SreGuiaCkpt()->CodiUsua, $intCodiUsua)
			);
		}
		...
		*/
		public static function LoadArrayByNumeGuia($strNumeGuia, $objOptionalClauses = null) {
			// Call SreGuiaCkpt::QueryArray to perform the LoadArrayByNumeGuia query
			try {
				return SreGuiaCkpt::QueryArray(
					QQ::Equal(QQN::SreGuiaCkpt()->NumeGuia, $strNumeGuia),
					$objOptionalClauses);
		...
		*/
		public static function CountByNumeGuia($strNumeGuia) {
			// Call SreGuiaCkpt::QueryCount to perform the CountByNumeGuia query
			return SreGuiaCkpt::QueryCount(
				QQ::Equal(QQN::SreGuiaCkpt()->NumeGuia, $strNumeGuia)
			);
		}
		...
		public function Delete() {
			if ((is_null($this->strNumeGuia)) || (is_null($this->strCodiEsta)) || (is_null($this->strCodiCkpt)) || (is_null($this->dttFechCkpt)) || (is_null($this->strHoraCkpt)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this SreGuiaCkpt with an unset primary key.');
        ...
        /**
 	     * Delete this SreGuiaCkpt ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'SreGuiaCkpt', $this->strNumeGuia, $this->strCodiEsta, $this->strCodiCkpt, $this->dttFechCkpt, $this->strHoraCkpt);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all SreGuiaCkpts
		 * @return void
		 */
		...
		/**
		 * Reload this SreGuiaCkpt from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved SreGuiaCkpt object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = SreGuiaCkpt::Load($this->strNumeGuia, $this->strCodiEsta, $this->strCodiCkpt, $this->dttFechCkpt, $this->strHoraCkpt);
				...
				case 'NumeGuiaObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->NumeGuia))
							throw new QCallerException('Unable to set an unsaved NumeGuiaObject for this SreGuiaCkpt');
				...
				case 'CodiEstaObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->CodiEsta))
							throw new QCallerException('Unable to set an unsaved CodiEstaObject for this SreGuiaCkpt');
				...
				case 'CodiCkptObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->CodiCkpt))
							throw new QCallerException('Unable to set an unsaved CodiCkptObject for this SreGuiaCkpt');
				...
				case 'CodiUsuaObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->CodiUsua))
							throw new QCallerException('Unable to set an unsaved CodiUsuaObject for this SreGuiaCkpt');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[SreGuiaCkpt::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="SreGuiaCkpt"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('SreGuiaCkpt', $strComplexTypeArray)) {
				$strComplexTypeArray['SreGuiaCkpt'] = SreGuiaCkpt::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, SreGuiaCkpt::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, SreGuiaCkpt::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeSreGuiaCkpt extends QQNode {
		protected $strTableName = 'sre_guia_ckpt';
		protected $strPrimaryKey = 'nume_guia';
		protected $strClassName = 'SreGuiaCkpt';
		public function __get($strName) {
			switch ($strName) {
				case 'NumeGuia':
     ...
     * @property-read QQNodeGuia $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeSreGuiaCkpt extends QQReverseReferenceNode {
		protected $strTableName = 'sre_guia_ckpt';
		protected $strPrimaryKey = 'nume_guia';
		protected $strClassName = 'SreGuiaCkpt';
		public function __get($strName) {
