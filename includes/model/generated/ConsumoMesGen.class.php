<?php
	/**
	 * The abstract ConsumoMesGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the ConsumoMes subclass which
	 * extends this ConsumoMesGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the ConsumoMes class.
	 *
	 ...
	 */
	class ConsumoMesGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column consumo_mes.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column consumo_mes.cliente_id
		...
		/**
		 * Protected member variable that maps to the database column consumo_mes.anio
		 * @var integer intAnio
		 */
		protected $intAnio;
		...
		/**
		 * Protected member variable that maps to the database column consumo_mes.mes
		 * @var integer intMes
		 */
		protected $intMes;
		...
		/**
		 * Protected member variable that maps to the database column consumo_mes.cantidad_guias
		...
		/**
		 * Protected member variable that maps to the database column consumo_mes.created_at
		...
		/**
		 * Protected member variable that maps to the database column consumo_mes.updated_at
		 ...
		 * in the database column consumo_mes.cliente_id.
		 *
		...
		{
			$this->intId = ConsumoMes::IdDefault;
			$this->intClienteId = ConsumoMes::ClienteIdDefault;
			$this->intAnio = ConsumoMes::AnioDefault;
			$this->intMes = ConsumoMes::MesDefault;
			$this->intCantidadGuias = ConsumoMes::CantidadGuiasDefault;
			$this->dttCreatedAt = (ConsumoMes::CreatedAtDefault === null)?null:new QDateTime(ConsumoMes::CreatedAtDefault);
			$this->dttUpdatedAt = (ConsumoMes::UpdatedAtDefault === null)?null:new QDateTime(ConsumoMes::UpdatedAtDefault);
		}
		...
		/**
		 * Load a ConsumoMes from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'ConsumoMes', $intId);
			...
			$objToReturn = ConsumoMes::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::ConsumoMes()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call ConsumoMes::QueryArray to perform the LoadAll query
			try {
				return ConsumoMes::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all ConsumoMeses
		 * @return int
		 */
		public static function CountAll() {
			// Call ConsumoMes::QueryCount to perform the CountAll query
			return ConsumoMes::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			// Create/Build out the QueryBuilder object with ConsumoMes-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'consumo_mes');
			...
			if ($blnAddAllFieldsToSelect) {
				ConsumoMes::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('consumo_mes');
		...
		/**
		 * Static Qcubed Query method to query for a single ConsumoMes object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return ConsumoMes the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = ConsumoMes::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new ConsumoMes object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = ConsumoMes::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return ConsumoMes::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of ConsumoMes objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return ConsumoMes[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return ConsumoMes::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of ConsumoMes objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = ConsumoMes::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/consumomes', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = ConsumoMes::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this ConsumoMes
		...
		/**
		 * Instantiate a ConsumoMes from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this ConsumoMes::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a ConsumoMes, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (ConsumoMes::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the ConsumoMes object
			$objToReturn = new ConsumoMes();
		...
		/**
		 * Instantiate an array of ConsumoMeses from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = ConsumoMes::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = ConsumoMes::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single ConsumoMes object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return ConsumoMes next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return ConsumoMes::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single ConsumoMes object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return ConsumoMes
		...
		*/
		public static function LoadByClienteIdAnioMes($intClienteId, $intAnio, $intMes, $objOptionalClauses = null) {
			return ConsumoMes::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::ConsumoMes()->ClienteId, $intClienteId),
		...
		*/
		public static function LoadArrayByClienteId($intClienteId, $objOptionalClauses = null) {
			// Call ConsumoMes::QueryArray to perform the LoadArrayByClienteId query
			try {
		...
		*/
		public static function CountByClienteId($intClienteId) {
			// Call ConsumoMes::QueryCount to perform the CountByClienteId query
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('consumo_mes', 'id');
				} else {
		...
		/**
		 * Delete this ConsumoMes
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this ConsumoMes with an unset primary key.');
        ...
        /**
 	     * Delete this ConsumoMes ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'ConsumoMes', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all ConsumoMeses
		 * @return void
		 */
		...
		/**
		 * Reload this ConsumoMes from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved ConsumoMes object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = ConsumoMes::Load($this->intId);
				...
				case 'Cliente':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->CodiClie))
							throw new QCallerException('Unable to set an unsaved Cliente for this ConsumoMes');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[ConsumoMes::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="ConsumoMes"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('ConsumoMes', $strComplexTypeArray)) {
				$strComplexTypeArray['ConsumoMes'] = ConsumoMes::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, ConsumoMes::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, ConsumoMes::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeConsumoMes extends QQNode {
		protected $strTableName = 'consumo_mes';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'ConsumoMes';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeConsumoMes extends QQReverseReferenceNode {
		protected $strTableName = 'consumo_mes';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'ConsumoMes';
		public function __get($strName) {
