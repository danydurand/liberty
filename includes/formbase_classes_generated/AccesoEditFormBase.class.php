 ...
 * of the Acceso class.  It uses the code-generated
 * AccesoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Acceso columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both acceso_edit.php AND
 * acceso_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class AccesoEditFormBase extends QForm {
	// Local instance of the AccesoMetaControl
	/**
	 * @var AccesoMetaControlGen mctAcceso
	 */
	protected $mctAcceso;
	...
	// Controls for Acceso's Data Fields
	protected $lblId;
	protected $lstUsuario;
	protected $calFechaAcceso;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the AccesoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctAcceso = AccesoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Acceso's data fields
		$this->lblId = $this->mctAcceso->lblId_Create();
		$this->lstUsuario = $this->mctAcceso->lstUsuario_Create();
		$this->calFechaAcceso = $this->mctAcceso->calFechaAcceso_Create();
		$this->txtPrograma = $this->mctAcceso->txtPrograma_Create();
		$this->txtParametros = $this->mctAcceso->txtParametros_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctAcceso->Acceso && !isset($_SESSION['DataAcceso'])) {
            $_SESSION['DataAcceso'] = serialize(array($this->mctAcceso->Acceso));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataAcceso']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctAcceso->Acceso->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctAcceso->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Acceso'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctAcceso->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Acceso',$this->mctAcceso->Acceso->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctAcceso->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctAcceso->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/acceso_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the AccesoMetaControl
		$this->mctAcceso->SaveAcceso();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctAcceso->TablasRelacionadasAcceso();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the AccesoMetaControl
			$this->mctAcceso->DeleteAcceso();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctAcceso->Acceso->Id;
        $_SESSION['TablRefe'] = 'Acceso';
        $_SESSION['RegiReto'] = 'acceso_edit.php/'.$this->mctAcceso->Acceso->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/acceso_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/acceso_edit.php');
    }
