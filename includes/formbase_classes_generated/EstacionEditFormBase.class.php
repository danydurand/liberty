 ...
 */
abstract class EstacionEditFormBase extends QForm {
	// Local instance of the EstacionMetaControl
	/**
	 * @var EstacionMetaControlGen mctEstacion
	 */
	protected $mctEstacion;
	...
	// Controls for Estacion's Data Fields
	protected $txtCodiEsta;
	protected $lstCodiStatObject;
	protected $txtDescEsta;
	protected $txtNombCont;
	protected $txtTextObse;
	protected $txtDireMail;
	protected $txtNumeDias;
	protected $txtNumeTele;
	protected $lstRegion;
	protected $txtCuentaCod;
	protected $txtCuentaCnt;
	protected $txtCuentaCom;
	protected $lstPais;
	protected $txtPorcentajeVenta;
	protected $txtPorcentajeEntrega;
	protected $lstOperacion;
	protected $txtDireMailPrincipal;
	protected $lstZonaCodObject;
	protected $lstNotificarRecolectaObject;
	protected $lstEsUnAlmacenObject;
	protected $lstOficinaFisicaObject;
	protected $lstAreaMetropolitanaObject;
	protected $lstSucursalPrincipalObject;
	protected $lstSeFacturaEnObject;
	protected $lstExentaDeIva;
	protected $lstVisibleEnRegistro;
	protected $lstEstado;
	protected $txtZonasNc;
	protected $txtFrecuenciaDeCobertura;
	protected $txtPalabraRelacionada;

	// Other ListBoxes (if applicable) via Unique ReverseReferences and ManyToMany References
	protected $dtgSdeOperacionsAsOperacionDestino;
	...
	protected function Form_Create() {
		...
		$this->lstOficinaFisicaObject = $this->mctEstacion->lstOficinaFisicaObject_Create();
		$this->lstAreaMetropolitanaObject = $this->mctEstacion->lstAreaMetropolitanaObject_Create();
		$this->lstSucursalPrincipalObject = $this->mctEstacion->lstSucursalPrincipalObject_Create();
		$this->lstSeFacturaEnObject = $this->mctEstacion->lstSeFacturaEnObject_Create();
		...
		$this->lstEstado = $this->mctEstacion->lstEstado_Create();
		$this->txtZonasNc = $this->mctEstacion->txtZonasNc_Create();
		$this->txtFrecuenciaDeCobertura = $this->mctEstacion->txtFrecuenciaDeCobertura_Create();
		$this->txtPalabraRelacionada = $this->mctEstacion->txtPalabraRelacionada_Create();
			$this->dtgSdeOperacionsAsOperacionDestino = $this->mctEstacion->dtgSdeOperacionsAsOperacionDestino_Create();
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctEstacion->Estacion->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Estacion';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctEstacion->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Estacion'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctEstacion->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Estacion',$this->mctEstacion->Estacion->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctEstacion->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctEstacion->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objEstacion = Estacion::LoadByDescEsta($this->txtDescEsta->Text)) && ($objEstacion->CodiEsta != $this->mctEstacion->Estacion->CodiEsta )){
				$blnToReturn = false;
				$this->txtDescEsta->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/estacion_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the EstacionMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if (count($arrTablRela)) {
			...
			//$this->txtCodiEsta->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the EstacionMetaControl
    ...
    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/estacion_edit.php');
    }
