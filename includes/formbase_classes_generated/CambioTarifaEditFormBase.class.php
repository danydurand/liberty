 ...
 */
abstract class CambioTarifaEditFormBase extends QForm {
	// Local instance of the CambioTarifaMetaControl
	/**
	 * @var CambioTarifaMetaControlGen mctCambioTarifa
	 */
	protected $mctCambioTarifa;
	...
	// Controls for CambioTarifa's Data Fields
	protected $lblId;
	protected $lstTarifaOrigen;
	protected $lstTarifaDestino;
	protected $txtExcluir;
	protected $calEjecutarEl;
	protected $calRegistradoEl;
	protected $txtRegistradoPor;
	protected $calEjecutadoEl;
	protected $calHoraEjecucion;
	...
	protected function Form_Create() {
		...
		$this->lstTarifaOrigen = $this->mctCambioTarifa->lstTarifaOrigen_Create();
		$this->lstTarifaDestino = $this->mctCambioTarifa->lstTarifaDestino_Create();
		...
		$this->calEjecutadoEl = $this->mctCambioTarifa->calEjecutadoEl_Create();
		$this->calHoraEjecucion = $this->mctCambioTarifa->calHoraEjecucion_Create();
		$this->txtComentario = $this->mctCambioTarifa->txtComentario_Create();
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'CambioTarifa';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctCambioTarifa->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('CambioTarifa'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctCambioTarifa->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctCambioTarifa->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctCambioTarifa->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the CambioTarifaMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the CambioTarifaMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctCambioTarifa->CambioTarifa->Id;
        $_SESSION['TablRefe'] = 'CambioTarifa';
        $_SESSION['RegiReto'] = 'cambio_tarifa_edit.php/'.$this->mctCambioTarifa->CambioTarifa->Id;
    ...
    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/cambio_tarifa_edit.php');
    }
