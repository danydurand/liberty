 ...
 * of the GuiaActualizar class.  It uses the code-generated
 * GuiaActualizarMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaActualizar columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_actualizar_edit.php AND
 * guia_actualizar_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaActualizarEditFormBase extends QForm {
	// Local instance of the GuiaActualizarMetaControl
	/**
	 * @var GuiaActualizarMetaControlGen mctGuiaActualizar
	 */
	protected $mctGuiaActualizar;
	...
	// Controls for GuiaActualizar's Data Fields
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaActualizarMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaActualizar = GuiaActualizarMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaActualizar's data fields
		$this->txtNumeGuia = $this->mctGuiaActualizar->txtNumeGuia_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaActualizar->GuiaActualizar && !isset($_SESSION['DataGuiaActualizar'])) {
            $_SESSION['DataGuiaActualizar'] = serialize(array($this->mctGuiaActualizar->GuiaActualizar));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaActualizar']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaActualizar->GuiaActualizar->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaActualizar';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaActualizar->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaActualizar'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaActualizar->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaActualizar',$this->mctGuiaActualizar->GuiaActualizar->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaActualizar->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaActualizar->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_actualizar_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaActualizar->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaActualizarMetaControl
		$this->mctGuiaActualizar->SaveGuiaActualizar();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaActualizar->TablasRelacionadasGuiaActualizar();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaActualizarMetaControl
			$this->mctGuiaActualizar->DeleteGuiaActualizar();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaActualizar->GuiaActualizar->Id;
        $_SESSION['TablRefe'] = 'GuiaActualizar';
        $_SESSION['RegiReto'] = 'guia_actualizar_edit.php/'.$this->mctGuiaActualizar->GuiaActualizar->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_actualizar_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_actualizar_edit.php');
    }
