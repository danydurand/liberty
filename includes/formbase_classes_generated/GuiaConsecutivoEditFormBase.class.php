 ...
 * of the GuiaConsecutivo class.  It uses the code-generated
 * GuiaConsecutivoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaConsecutivo columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_consecutivo_edit.php AND
 * guia_consecutivo_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaConsecutivoEditFormBase extends QForm {
	// Local instance of the GuiaConsecutivoMetaControl
	/**
	 * @var GuiaConsecutivoMetaControlGen mctGuiaConsecutivo
	 */
	protected $mctGuiaConsecutivo;
	...
	// Controls for GuiaConsecutivo's Data Fields
	protected $lblId;
	protected $txtNada;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaConsecutivoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaConsecutivo = GuiaConsecutivoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaConsecutivo's data fields
		$this->lblId = $this->mctGuiaConsecutivo->lblId_Create();
		$this->txtNada = $this->mctGuiaConsecutivo->txtNada_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaConsecutivo->GuiaConsecutivo && !isset($_SESSION['DataGuiaConsecutivo'])) {
            $_SESSION['DataGuiaConsecutivo'] = serialize(array($this->mctGuiaConsecutivo->GuiaConsecutivo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaConsecutivo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaConsecutivo->GuiaConsecutivo->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaConsecutivo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaConsecutivo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaConsecutivo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaConsecutivo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaConsecutivo',$this->mctGuiaConsecutivo->GuiaConsecutivo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaConsecutivo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaConsecutivo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_consecutivo_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaConsecutivo->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaConsecutivoMetaControl
		$this->mctGuiaConsecutivo->SaveGuiaConsecutivo();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaConsecutivo->TablasRelacionadasGuiaConsecutivo();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaConsecutivoMetaControl
			$this->mctGuiaConsecutivo->DeleteGuiaConsecutivo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaConsecutivo->GuiaConsecutivo->Id;
        $_SESSION['TablRefe'] = 'GuiaConsecutivo';
        $_SESSION['RegiReto'] = 'guia_consecutivo_edit.php/'.$this->mctGuiaConsecutivo->GuiaConsecutivo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_consecutivo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_consecutivo_edit.php');
    }
