 ...
 * of the FacAudiCierre class.  It uses the code-generated
 * FacAudiCierreMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacAudiCierre columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both fac_audi_cierre_edit.php AND
 * fac_audi_cierre_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacAudiCierreEditFormBase extends QForm {
	// Local instance of the FacAudiCierreMetaControl
	/**
	 * @var FacAudiCierreMetaControlGen mctFacAudiCierre
	 */
	protected $mctFacAudiCierre;
	...
	// Controls for FacAudiCierre's Data Fields
	protected $txtNumeAnio;
	protected $txtNumeDmes;
	protected $txtTextCier;
	protected $txtTextAper;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacAudiCierreMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacAudiCierre = FacAudiCierreMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacAudiCierre's data fields
		$this->txtNumeAnio = $this->mctFacAudiCierre->txtNumeAnio_Create();
		$this->txtNumeDmes = $this->mctFacAudiCierre->txtNumeDmes_Create();
		$this->txtTextCier = $this->mctFacAudiCierre->txtTextCier_Create();
		$this->txtTextAper = $this->mctFacAudiCierre->txtTextAper_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacAudiCierre->FacAudiCierre && !isset($_SESSION['DataFacAudiCierre'])) {
            $_SESSION['DataFacAudiCierre'] = serialize(array($this->mctFacAudiCierre->FacAudiCierre));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacAudiCierre']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacAudiCierre->FacAudiCierre->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacAudiCierre';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacAudiCierre->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacAudiCierre'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacAudiCierre->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacAudiCierre',$this->mctFacAudiCierre->FacAudiCierre->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacAudiCierre->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacAudiCierre->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/fac_audi_cierre_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacAudiCierre->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacAudiCierreMetaControl
		$this->mctFacAudiCierre->SaveFacAudiCierre();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacAudiCierre->TablasRelacionadasFacAudiCierre();
		if (count($arrTablRela)) {
			$strTablRela = implode(',',$arrTablRela);
				
			//$this->txtNumeAnio->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
				
			//$this->txtNumeDmes->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacAudiCierreMetaControl
			$this->mctFacAudiCierre->DeleteFacAudiCierre();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacAudiCierre->FacAudiCierre->Id;
        $_SESSION['TablRefe'] = 'FacAudiCierre';
        $_SESSION['RegiReto'] = 'fac_audi_cierre_edit.php/'.$this->mctFacAudiCierre->FacAudiCierre->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/fac_audi_cierre_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/fac_audi_cierre_edit.php');
    }
