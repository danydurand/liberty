<?php
	 ...
	 */
	abstract class RutaListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Rutas
		/**
		 * @var RutaDataGrid dtgRutas
		 */
		protected $dtgRutas;
		...
		protected function Form_Create() {
			...
			$this->dtgRutas->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgRutas);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgRutas->ShowFilter = !$this->dtgRutas->ShowFilter;
        }

		public function dtgRutasRow_Click($strFormId, $strControlId, $strParameter) {
		  $intId = intval($strParameter);
		  QApplication::Redirect("ruta_edit.php/$intId");
		}
