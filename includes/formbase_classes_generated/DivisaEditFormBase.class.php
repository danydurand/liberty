 ...
 * of the Divisa class.  It uses the code-generated
 * DivisaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Divisa columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both divisa_edit.php AND
 * divisa_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class DivisaEditFormBase extends QForm {
	// Local instance of the DivisaMetaControl
	/**
	 * @var DivisaMetaControlGen mctDivisa
	 */
	protected $mctDivisa;
	...
	// Controls for Divisa's Data Fields
	protected $lblId;
	protected $txtSiglas;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the DivisaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctDivisa = DivisaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Divisa's data fields
		$this->lblId = $this->mctDivisa->lblId_Create();
		$this->txtSiglas = $this->mctDivisa->txtSiglas_Create();
		$this->txtDescripcion = $this->mctDivisa->txtDescripcion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctDivisa->Divisa && !isset($_SESSION['DataDivisa'])) {
            $_SESSION['DataDivisa'] = serialize(array($this->mctDivisa->Divisa));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataDivisa']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctDivisa->Divisa->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctDivisa->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Divisa'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctDivisa->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Divisa',$this->mctDivisa->Divisa->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctDivisa->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctDivisa->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/divisa_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the DivisaMetaControl
		$this->mctDivisa->SaveDivisa();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctDivisa->TablasRelacionadasDivisa();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the DivisaMetaControl
			$this->mctDivisa->DeleteDivisa();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctDivisa->Divisa->Id;
        $_SESSION['TablRefe'] = 'Divisa';
        $_SESSION['RegiReto'] = 'divisa_edit.php/'.$this->mctDivisa->Divisa->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/divisa_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/divisa_edit.php');
    }
