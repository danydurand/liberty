 ...
 */
abstract class MensajeYamaguchiEditFormBase extends QForm {
	// Local instance of the MensajeYamaguchiMetaControl
	/**
	 * @var MensajeYamaguchiMetaControlGen mctMensajeYamaguchi
	 */
	...
	// Controls for MensajeYamaguchi's Data Fields
	protected $lblId;
	protected $txtTipo;
	protected $txtTexto;
	protected $txtOrden;
	protected $calFechInic;
	protected $calFechFin;
	protected $txtCodigos;
	protected $chkTiempoIndefinido;
	protected $txtLogin;
	protected $txtIcono;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'MensajeYamaguchi';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctMensajeYamaguchi->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('MensajeYamaguchi'))));
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('MensajeYamaguchi',$this->mctMensajeYamaguchi->MensajeYamaguchi->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctMensajeYamaguchi->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctMensajeYamaguchi->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the MensajeYamaguchiMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the MensajeYamaguchiMetaControl
    ...
    protected function btnLogxCamb_Click() {
        ...
        $_SESSION['TablRefe'] = 'MensajeYamaguchi';
    ...
    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/mensaje_yamaguchi_list.php');
    }
