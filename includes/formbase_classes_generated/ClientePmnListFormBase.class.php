<?php
	 ...
	 */
	abstract class ClientePmnListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list ClientePmns
		/**
		 * @var ClientePmnDataGrid dtgClientePmns
		 */
		protected $dtgClientePmns;
		...
		protected function Form_Create() {
			...
			$this->dtgClientePmns->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
			...
			$this->dtgClientePmns->MetaAddColumn('CedulaRif');
			$this->dtgClientePmns->MetaAddColumn('Nombre');
			$this->dtgClientePmns->MetaAddColumn('TelefonoFijo');
			$this->dtgClientePmns->MetaAddColumn('TelefonoMovil');
			$this->dtgClientePmns->MetaAddColumn('Direccion');
			$this->dtgClientePmns->MetaAddColumn('SucursalId');
			$this->dtgClientePmns->MetaAddColumn('RegistradoEl');
			$this->dtgClientePmns->MetaAddColumn(QQN::ClientePmn()->RegistradoPorObject);
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'ClientePmns';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgClientePmns);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgClientePmns->ShowFilter = !$this->dtgClientePmns->ShowFilter;
        }
