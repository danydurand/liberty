<?php
	 ...
	 */
	abstract class DestinatarioFrecuenteListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list DestinatarioFrecuentes
		/**
		 * @var DestinatarioFrecuenteDataGrid dtgDestinatarioFrecuentes
		 */
		protected $dtgDestinatarioFrecuentes;
		...
		protected function Form_Create() {
			...
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('Id');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn(QQN::DestinatarioFrecuente()->Cliente);
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('Nombre');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('Direccion');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('Telefono');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('Email');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('CedulaRif');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('PersonaContacto');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('CodigoPostal');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn(QQN::DestinatarioFrecuente()->Destino);
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('EstadoId');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('MunicipioId');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('ParroquiaId');
			$this->dtgDestinatarioFrecuentes->MetaAddColumn('SecurbarId');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'DestinatarioFrecuentes';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgDestinatarioFrecuentes);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgDestinatarioFrecuentes->ShowFilter = !$this->dtgDestinatarioFrecuentes->ShowFilter;
        }
