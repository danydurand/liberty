 ...
 * permanent changes, it is STRONGLY RECOMMENDED to move both caja_edit.php AND
 * caja_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class CajaEditFormBase extends QForm {
	// Local instance of the CajaMetaControl
	/**
	 * @var CajaMetaControlGen mctCaja
	 */
	protected $mctCaja;
	...
	// Controls for Caja's Data Fields
	protected $lblId;
	protected $txtDescripcion;
	protected $lstCounter;
	protected $txtControlSeniat;
	protected $lstTipo;
	protected $txtImpresoraId;
	protected $txtSerie;
	protected $txtConseFactura;
	...
	protected function Form_Create() {
		...
		$this->lblId = $this->mctCaja->lblId_Create();
		$this->txtDescripcion = $this->mctCaja->txtDescripcion_Create();
		$this->lstCounter = $this->mctCaja->lstCounter_Create();
		$this->txtControlSeniat = $this->mctCaja->txtControlSeniat_Create();
		$this->lstTipo = $this->mctCaja->lstTipo_Create();
		$this->txtImpresoraId = $this->mctCaja->txtImpresoraId_Create();
		$this->txtSerie = $this->mctCaja->txtSerie_Create();
		$this->txtConseFactura = $this->mctCaja->txtConseFactura_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctCaja->Caja && !isset($_SESSION['DataCaja'])) {
            $_SESSION['DataCaja'] = serialize(array($this->mctCaja->Caja));
        }
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctCaja->EditMode;
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctCaja->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctCaja->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/caja_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the CajaMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctCaja->TablasRelacionadasCaja();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the CajaMetaControl
			$this->mctCaja->DeleteCaja();
			$this->RedirectToListPage();
		}
	}
    ...
    protected function btnLogxCamb_Click() {
        ...
        $_SESSION['RegiReto'] = 'caja_edit.php/'.$this->mctCaja->Caja->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/caja_list.php');
    }
