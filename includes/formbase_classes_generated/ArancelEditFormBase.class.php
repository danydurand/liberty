 ...
 * of the Arancel class.  It uses the code-generated
 * ArancelMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Arancel columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both arancel_edit.php AND
 * arancel_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ArancelEditFormBase extends QForm {
	// Local instance of the ArancelMetaControl
	/**
	 * @var ArancelMetaControlGen mctArancel
	 */
	protected $mctArancel;
	...
	// Controls for Arancel's Data Fields
	protected $lblId;
	protected $txtSubpartida;
	protected $txtDescripcion;
	protected $txtArancel;
	protected $txtDolar;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ArancelMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctArancel = ArancelMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Arancel's data fields
		$this->lblId = $this->mctArancel->lblId_Create();
		$this->txtSubpartida = $this->mctArancel->txtSubpartida_Create();
		$this->txtDescripcion = $this->mctArancel->txtDescripcion_Create();
		$this->txtArancel = $this->mctArancel->txtArancel_Create();
		$this->txtDolar = $this->mctArancel->txtDolar_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctArancel->Arancel && !isset($_SESSION['DataArancel'])) {
            $_SESSION['DataArancel'] = serialize(array($this->mctArancel->Arancel));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataArancel']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctArancel->Arancel->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctArancel->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Arancel'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctArancel->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Arancel',$this->mctArancel->Arancel->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctArancel->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctArancel->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objArancel = Arancel::LoadBySubpartida($this->txtSubpartida->Text)) && ($objArancel->Id != $this->mctArancel->Arancel->Id )){
				$blnToReturn = false;
				$this->txtSubpartida->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/arancel_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ArancelMetaControl
		$this->mctArancel->SaveArancel();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctArancel->TablasRelacionadasArancel();
		...
		if ($blnTodoOkey) {
			...
			$this->mctArancel->DeleteArancel();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctArancel->Arancel->Id;
        $_SESSION['TablRefe'] = 'Arancel';
        $_SESSION['RegiReto'] = 'arancel_edit.php/'.$this->mctArancel->Arancel->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/arancel_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/arancel_edit.php');
    }
