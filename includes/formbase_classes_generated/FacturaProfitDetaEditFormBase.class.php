 ...
 * of the FacturaProfitDeta class.  It uses the code-generated
 * FacturaProfitDetaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacturaProfitDeta columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both factura_profit_deta_edit.php AND
 * factura_profit_deta_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacturaProfitDetaEditFormBase extends QForm {
	// Local instance of the FacturaProfitDetaMetaControl
	/**
	 * @var FacturaProfitDetaMetaControlGen mctFacturaProfitDeta
	 */
	protected $mctFacturaProfitDeta;
	...
	// Controls for FacturaProfitDeta's Data Fields
	protected $lblId;
	protected $txtFacturaId;
	protected $txtGuiaId;
	protected $txtMontoGuiaProfit;
	protected $txtMontoGuia;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacturaProfitDetaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacturaProfitDeta = FacturaProfitDetaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacturaProfitDeta's data fields
		$this->lblId = $this->mctFacturaProfitDeta->lblId_Create();
		$this->txtFacturaId = $this->mctFacturaProfitDeta->txtFacturaId_Create();
		$this->txtGuiaId = $this->mctFacturaProfitDeta->txtGuiaId_Create();
		$this->txtMontoGuiaProfit = $this->mctFacturaProfitDeta->txtMontoGuiaProfit_Create();
		$this->txtMontoGuia = $this->mctFacturaProfitDeta->txtMontoGuia_Create();
		$this->txtStatusId = $this->mctFacturaProfitDeta->txtStatusId_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacturaProfitDeta->FacturaProfitDeta && !isset($_SESSION['DataFacturaProfitDeta'])) {
            $_SESSION['DataFacturaProfitDeta'] = serialize(array($this->mctFacturaProfitDeta->FacturaProfitDeta));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacturaProfitDeta']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacturaProfitDeta->FacturaProfitDeta->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacturaProfitDeta';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacturaProfitDeta->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacturaProfitDeta'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacturaProfitDeta->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacturaProfitDeta',$this->mctFacturaProfitDeta->FacturaProfitDeta->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacturaProfitDeta->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacturaProfitDeta->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/factura_profit_deta_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacturaProfitDeta->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacturaProfitDetaMetaControl
		$this->mctFacturaProfitDeta->SaveFacturaProfitDeta();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacturaProfitDeta->TablasRelacionadasFacturaProfitDeta();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacturaProfitDetaMetaControl
			$this->mctFacturaProfitDeta->DeleteFacturaProfitDeta();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacturaProfitDeta->FacturaProfitDeta->Id;
        $_SESSION['TablRefe'] = 'FacturaProfitDeta';
        $_SESSION['RegiReto'] = 'factura_profit_deta_edit.php/'.$this->mctFacturaProfitDeta->FacturaProfitDeta->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/factura_profit_deta_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/factura_profit_deta_edit.php');
    }
