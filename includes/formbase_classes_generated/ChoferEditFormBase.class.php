 ...
 */
abstract class ChoferEditFormBase extends QForm {
	// Local instance of the ChoferMetaControl
	/**
	 * @var ChoferMetaControlGen mctChofer
	 */
	protected $mctChofer;
	...
	// Controls for Chofer's Data Fields
	protected $lblCodiChof;
	protected $txtNombChof;
	protected $txtApelChof;
	protected $txtNumeCedu;
	protected $txtTeleChof;
	protected $txtTextObse;
	protected $lstTipoMensObject;
	protected $lstCodiEstaObject;
	protected $lstCodiDispObject;
	protected $lstCodiStatObject;
	protected $txtLogin;
	protected $txtPassword;
	protected $calAccesoMobile;
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctChofer->Chofer->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctChofer->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Chofer'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctChofer->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Chofer',$this->mctChofer->Chofer->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctChofer->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctChofer->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objChofer = Chofer::LoadByLogin($this->txtLogin->Text)) && ($objChofer->CodiChof != $this->mctChofer->Chofer->CodiChof )){
				$blnToReturn = false;
				$this->txtLogin->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/chofer_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ChoferMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if (count($arrTablRela)) {
			...
			//$this->lblCodiChof->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ChoferMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctChofer->Chofer->Id;
        $_SESSION['TablRefe'] = 'Chofer';
        $_SESSION['RegiReto'] = 'chofer_edit.php/'.$this->mctChofer->Chofer->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/chofer_list.php');
    }
