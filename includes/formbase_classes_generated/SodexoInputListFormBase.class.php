<?php
	 ...
	 */
	abstract class SodexoInputListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list SodexoInputs
		/**
		 * @var SodexoInputDataGrid dtgSodexoInputs
		 */
		protected $dtgSodexoInputs;
		...
		protected function Form_Create() {
			...
			$this->dtgSodexoInputs->MetaAddColumn('Id');
			$this->dtgSodexoInputs->MetaAddColumn('CodigoTurpial');
			$this->dtgSodexoInputs->MetaAddColumn('RazonSocial');
			$this->dtgSodexoInputs->MetaAddColumn('GuiaSodexo');
			$this->dtgSodexoInputs->MetaAddColumn('CantidadEnvases');
			$this->dtgSodexoInputs->MetaAddColumn('FechaDespacho');
			$this->dtgSodexoInputs->MetaAddColumn('DireccionEntrega');
			$this->dtgSodexoInputs->MetaAddColumn('Ciudad');
			$this->dtgSodexoInputs->MetaAddColumn('Estado');
			$this->dtgSodexoInputs->MetaAddColumn('ZonaFiscal');
			$this->dtgSodexoInputs->MetaAddColumn('TipoCliente');
			$this->dtgSodexoInputs->MetaAddColumn('RegistradoPor');
			$this->dtgSodexoInputs->MetaAddColumn('FechaRegistro');
			$this->dtgSodexoInputs->MetaAddColumn('HoraRegistro');
			$this->dtgSodexoInputs->MetaAddColumn('ArchivoInput');
			$this->dtgSodexoInputs->MetaAddColumn('GuiaId');
			$this->dtgSodexoInputs->MetaAddColumn('ProcesadoPor');
			$this->dtgSodexoInputs->MetaAddColumn('FechaProceso');
			$this->dtgSodexoInputs->MetaAddColumn('HoraProceso');
			$this->dtgSodexoInputs->MetaAddColumn('CodiEsta');
			$this->dtgSodexoInputs->MetaAddColumn('CodiCkpt');
			$this->dtgSodexoInputs->MetaAddColumn('FechCkpt');
			$this->dtgSodexoInputs->MetaAddColumn('HoraCkpt');
			$this->dtgSodexoInputs->MetaAddTypeColumn('CierreCiclo', 'SinoType');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'SodexoInputs';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgSodexoInputs);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgSodexoInputs->ShowFilter = !$this->dtgSodexoInputs->ShowFilter;
        }
