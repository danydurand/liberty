 ...
 */
abstract class DestinatarioFrecuenteEditFormBase extends QForm {
	// Local instance of the DestinatarioFrecuenteMetaControl
	/**
	 * @var DestinatarioFrecuenteMetaControlGen mctDestinatarioFrecuente
	 */
	protected $mctDestinatarioFrecuente;
	...
	// Controls for DestinatarioFrecuente's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
		...
		$this->lblId = $this->mctDestinatarioFrecuente->lblId_Create();
		$this->lstCliente = $this->mctDestinatarioFrecuente->lstCliente_Create();
		...
		$this->lstDestino = $this->mctDestinatarioFrecuente->lstDestino_Create();
		$this->txtEstadoId = $this->mctDestinatarioFrecuente->txtEstadoId_Create();
		$this->txtMunicipioId = $this->mctDestinatarioFrecuente->txtMunicipioId_Create();
		$this->txtParroquiaId = $this->mctDestinatarioFrecuente->txtParroquiaId_Create();
		$this->txtSecurbarId = $this->mctDestinatarioFrecuente->txtSecurbarId_Create();
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'DestinatarioFrecuente';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctDestinatarioFrecuente->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('DestinatarioFrecuente'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctDestinatarioFrecuente->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctDestinatarioFrecuente->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctDestinatarioFrecuente->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the DestinatarioFrecuenteMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the DestinatarioFrecuenteMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctDestinatarioFrecuente->DestinatarioFrecuente->Id;
        $_SESSION['TablRefe'] = 'DestinatarioFrecuente';
        $_SESSION['RegiReto'] = 'destinatario_frecuente_edit.php/'.$this->mctDestinatarioFrecuente->DestinatarioFrecuente->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/destinatario_frecuente_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/destinatario_frecuente_edit.php');
    }
