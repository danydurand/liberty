 ...
 * of the ClienteIConsecutivo class.  It uses the code-generated
 * ClienteIConsecutivoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ClienteIConsecutivo columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both cliente_i_consecutivo_edit.php AND
 * cliente_i_consecutivo_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ClienteIConsecutivoEditFormBase extends QForm {
	// Local instance of the ClienteIConsecutivoMetaControl
	/**
	 * @var ClienteIConsecutivoMetaControlGen mctClienteIConsecutivo
	 */
	protected $mctClienteIConsecutivo;
	...
	// Controls for ClienteIConsecutivo's Data Fields
	protected $lblId;
	protected $txtNada;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ClienteIConsecutivoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctClienteIConsecutivo = ClienteIConsecutivoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ClienteIConsecutivo's data fields
		$this->lblId = $this->mctClienteIConsecutivo->lblId_Create();
		$this->txtNada = $this->mctClienteIConsecutivo->txtNada_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctClienteIConsecutivo->ClienteIConsecutivo && !isset($_SESSION['DataClienteIConsecutivo'])) {
            $_SESSION['DataClienteIConsecutivo'] = serialize(array($this->mctClienteIConsecutivo->ClienteIConsecutivo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataClienteIConsecutivo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctClienteIConsecutivo->ClienteIConsecutivo->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ClienteIConsecutivo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctClienteIConsecutivo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ClienteIConsecutivo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctClienteIConsecutivo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ClienteIConsecutivo',$this->mctClienteIConsecutivo->ClienteIConsecutivo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctClienteIConsecutivo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctClienteIConsecutivo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/cliente_i_consecutivo_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctClienteIConsecutivo->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ClienteIConsecutivoMetaControl
		$this->mctClienteIConsecutivo->SaveClienteIConsecutivo();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctClienteIConsecutivo->TablasRelacionadasClienteIConsecutivo();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ClienteIConsecutivoMetaControl
			$this->mctClienteIConsecutivo->DeleteClienteIConsecutivo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctClienteIConsecutivo->ClienteIConsecutivo->Id;
        $_SESSION['TablRefe'] = 'ClienteIConsecutivo';
        $_SESSION['RegiReto'] = 'cliente_i_consecutivo_edit.php/'.$this->mctClienteIConsecutivo->ClienteIConsecutivo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/cliente_i_consecutivo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/cliente_i_consecutivo_edit.php');
    }
