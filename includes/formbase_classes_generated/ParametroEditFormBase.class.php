 ...
 */
abstract class ParametroEditFormBase extends QForm {
	// Local instance of the ParametroMetaControl
	/**
	 * @var ParametroMetaControlGen mctParametro
	 */
	protected $mctParametro;
	...
	// Controls for Parametro's Data Fields
	protected $txtIndiPara;
	protected $txtCodiPara;
	protected $txtDescPara;
	protected $txtParaTxt1;
	protected $txtParaTxt2;
	protected $txtParaTxt3;
	protected $txtParaTxt4;
	protected $txtParaTxt5;
	protected $txtParaVal1;
	protected $txtParaVal2;
	protected $txtParaVal3;
	protected $txtParaVal4;
	protected $txtParaVal5;
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctParametro->Parametro->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Parametro';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctParametro->EditMode;
    }
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Parametro',$this->mctParametro->Parametro->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctParametro->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctParametro->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/parametro_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ParametroMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if (count($arrTablRela)) {
			...
			//$this->txtIndiPara->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
				
			//$this->txtCodiPara->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctParametro->Parametro->Id;
        $_SESSION['TablRefe'] = 'Parametro';
        $_SESSION['RegiReto'] = 'parametro_edit.php/'.$this->mctParametro->Parametro->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/parametro_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/parametro_edit.php');
    }
