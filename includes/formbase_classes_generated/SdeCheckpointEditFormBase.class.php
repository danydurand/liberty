 ...
 */
abstract class SdeCheckpointEditFormBase extends QForm {
	// Local instance of the SdeCheckpointMetaControl
	/**
	 * @var SdeCheckpointMetaControlGen mctSdeCheckpoint
	 */
	protected $mctSdeCheckpoint;
	...
	// Controls for SdeCheckpoint's Data Fields
	protected $txtCodiCkpt;
	protected $txtDescCkpt;
	protected $lstTipoTermObject;
	protected $lstTipoCkptObject;
	protected $txtTextObse;
	protected $lstCodiStatObject;
	protected $lstCodiCcatObject;
	protected $lstCodiInadObject;
	protected $txtDescDevo;
	protected $lstNotificarObject;
	protected $lstPais;
	protected $txtComentarioIvr;
	protected $txtCodigoSodexo;
	protected $txtDescripcionSodexo;
	protected $chkNotificacionSms;
	protected $txtImagen;
	protected $txtColor;
	protected $calDeleteAt;
	...
	protected function Form_Create() {
		...
		$this->lstPais = $this->mctSdeCheckpoint->lstPais_Create();
		...
		$this->calDeleteAt = $this->mctSdeCheckpoint->calDeleteAt_Create();
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctSdeCheckpoint->SdeCheckpoint->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'SdeCheckpoint';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctSdeCheckpoint->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('SdeCheckpoint'))));
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('SdeCheckpoint',$this->mctSdeCheckpoint->SdeCheckpoint->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctSdeCheckpoint->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctSdeCheckpoint->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/sde_checkpoint_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the SdeCheckpointMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if (count($arrTablRela)) {
			...
			//$this->txtCodiCkpt->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the SdeCheckpointMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctSdeCheckpoint->SdeCheckpoint->Id;
        $_SESSION['TablRefe'] = 'SdeCheckpoint';
        $_SESSION['RegiReto'] = 'sde_checkpoint_edit.php/'.$this->mctSdeCheckpoint->SdeCheckpoint->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/sde_checkpoint_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/sde_checkpoint_edit.php');
    }
