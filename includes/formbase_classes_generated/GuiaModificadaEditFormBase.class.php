 ...
 * of the GuiaModificada class.  It uses the code-generated
 * GuiaModificadaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaModificada columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_modificada_edit.php AND
 * guia_modificada_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaModificadaEditFormBase extends QForm {
	// Local instance of the GuiaModificadaMetaControl
	/**
	 * @var GuiaModificadaMetaControlGen mctGuiaModificada
	 */
	protected $mctGuiaModificada;
	...
	// Controls for GuiaModificada's Data Fields
	protected $lstGuia;
	protected $calFecha;
	protected $txtPesoOriginal;
	protected $txtPesoNuevo;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaModificadaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaModificada = GuiaModificadaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaModificada's data fields
		$this->lstGuia = $this->mctGuiaModificada->lstGuia_Create();
		$this->calFecha = $this->mctGuiaModificada->calFecha_Create();
		$this->txtPesoOriginal = $this->mctGuiaModificada->txtPesoOriginal_Create();
		$this->txtPesoNuevo = $this->mctGuiaModificada->txtPesoNuevo_Create();
		$this->txtUsuarioId = $this->mctGuiaModificada->txtUsuarioId_Create();
		$this->txtCodiEsta = $this->mctGuiaModificada->txtCodiEsta_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaModificada->GuiaModificada && !isset($_SESSION['DataGuiaModificada'])) {
            $_SESSION['DataGuiaModificada'] = serialize(array($this->mctGuiaModificada->GuiaModificada));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaModificada']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaModificada->GuiaModificada->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaModificada';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaModificada->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaModificada'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaModificada->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaModificada',$this->mctGuiaModificada->GuiaModificada->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaModificada->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaModificada->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_modificada_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaModificada->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaModificadaMetaControl
		$this->mctGuiaModificada->SaveGuiaModificada();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaModificada->TablasRelacionadasGuiaModificada();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaModificadaMetaControl
			$this->mctGuiaModificada->DeleteGuiaModificada();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaModificada->GuiaModificada->Id;
        $_SESSION['TablRefe'] = 'GuiaModificada';
        $_SESSION['RegiReto'] = 'guia_modificada_edit.php/'.$this->mctGuiaModificada->GuiaModificada->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_modificada_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_modificada_edit.php');
    }
