 ...
 * of the ProductoReembolso class.  It uses the code-generated
 * ProductoReembolsoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ProductoReembolso columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both producto_reembolso_edit.php AND
 * producto_reembolso_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ProductoReembolsoEditFormBase extends QForm {
	// Local instance of the ProductoReembolsoMetaControl
	/**
	 * @var ProductoReembolsoMetaControlGen mctProductoReembolso
	 */
	protected $mctProductoReembolso;
	...
	// Controls for ProductoReembolso's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $txtPrecioUsd;
	protected $txtPrecioVeb;
	protected $txtExistencia;
	protected $txtImagen;
	protected $txtActivo;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ProductoReembolsoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctProductoReembolso = ProductoReembolsoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ProductoReembolso's data fields
		$this->lblId = $this->mctProductoReembolso->lblId_Create();
		$this->txtNombre = $this->mctProductoReembolso->txtNombre_Create();
		$this->txtPrecioUsd = $this->mctProductoReembolso->txtPrecioUsd_Create();
		$this->txtPrecioVeb = $this->mctProductoReembolso->txtPrecioVeb_Create();
		$this->txtExistencia = $this->mctProductoReembolso->txtExistencia_Create();
		$this->txtImagen = $this->mctProductoReembolso->txtImagen_Create();
		$this->txtActivo = $this->mctProductoReembolso->txtActivo_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctProductoReembolso->ProductoReembolso && !isset($_SESSION['DataProductoReembolso'])) {
            $_SESSION['DataProductoReembolso'] = serialize(array($this->mctProductoReembolso->ProductoReembolso));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataProductoReembolso']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctProductoReembolso->ProductoReembolso->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ProductoReembolso';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctProductoReembolso->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ProductoReembolso'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctProductoReembolso->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ProductoReembolso',$this->mctProductoReembolso->ProductoReembolso->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctProductoReembolso->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctProductoReembolso->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/producto_reembolso_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctProductoReembolso->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ProductoReembolsoMetaControl
		$this->mctProductoReembolso->SaveProductoReembolso();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctProductoReembolso->TablasRelacionadasProductoReembolso();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ProductoReembolsoMetaControl
			$this->mctProductoReembolso->DeleteProductoReembolso();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctProductoReembolso->ProductoReembolso->Id;
        $_SESSION['TablRefe'] = 'ProductoReembolso';
        $_SESSION['RegiReto'] = 'producto_reembolso_edit.php/'.$this->mctProductoReembolso->ProductoReembolso->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/producto_reembolso_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/producto_reembolso_edit.php');
    }
