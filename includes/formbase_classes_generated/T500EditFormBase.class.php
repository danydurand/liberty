 ...
 * of the T500 class.  It uses the code-generated
 * T500MetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a T500 columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both t_5_0_0_edit.php AND
 * t_5_0_0_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class T500EditFormBase extends QForm {
	// Local instance of the T500MetaControl
	/**
	 * @var T500MetaControlGen mctT500
	 */
	protected $mctT500;
	...
	// Controls for T500's Data Fields
	protected $txtId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the T500MetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctT500 = T500MetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on T500's data fields
		$this->txtId = $this->mctT500->txtId_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctT500->T500 && !isset($_SESSION['DataT500'])) {
            $_SESSION['DataT500'] = serialize(array($this->mctT500->T500));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataT500']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctT500->T500->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctT500->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('T500'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctT500->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('T500',$this->mctT500->T500->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctT500->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctT500->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/t_5_0_0_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the T500MetaControl
		$this->mctT500->SaveT500();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctT500->TablasRelacionadasT500();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the T500MetaControl
			$this->mctT500->DeleteT500();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctT500->T500->Id;
        $_SESSION['TablRefe'] = 'T500';
        $_SESSION['RegiReto'] = 't_5_0_0_edit.php/'.$this->mctT500->T500->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/t500_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/t500_edit.php');
    }
