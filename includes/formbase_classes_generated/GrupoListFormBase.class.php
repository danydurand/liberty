<?php
	 ...
	 */
	abstract class GrupoListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Grupos
		/**
		 * @var GrupoDataGrid dtgGrupos
		 */
		protected $dtgGrupos;
		...
		protected function Form_Create() {
			...
			$this->dtgGrupos->ShowFilter = false;
			...
			$this->dtgGrupos->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgGrupos);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgGrupos->ShowFilter = !$this->dtgGrupos->ShowFilter;
        }
