 ...
 * of the OpciGrup class.  It uses the code-generated
 * OpciGrupMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a OpciGrup columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both opci_grup_edit.php AND
 * opci_grup_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class OpciGrupEditFormBase extends QForm {
	// Local instance of the OpciGrupMetaControl
	/**
	 * @var OpciGrupMetaControlGen mctOpciGrup
	 */
	protected $mctOpciGrup;
	...
	// Controls for OpciGrup's Data Fields
	protected $lblCodiRegi;
	protected $lstCodiGrupObject;
	protected $lstCodiOpciObject;
	protected $lstNiveAcceObject;
	protected $calFechCamb;
	protected $txtUsuaCamb;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the OpciGrupMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctOpciGrup = OpciGrupMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on OpciGrup's data fields
		$this->lblCodiRegi = $this->mctOpciGrup->lblCodiRegi_Create();
		$this->lstCodiGrupObject = $this->mctOpciGrup->lstCodiGrupObject_Create();
		$this->lstCodiOpciObject = $this->mctOpciGrup->lstCodiOpciObject_Create();
		$this->lstNiveAcceObject = $this->mctOpciGrup->lstNiveAcceObject_Create();
		$this->calFechCamb = $this->mctOpciGrup->calFechCamb_Create();
		$this->txtUsuaCamb = $this->mctOpciGrup->txtUsuaCamb_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctOpciGrup->OpciGrup && !isset($_SESSION['DataOpciGrup'])) {
            $_SESSION['DataOpciGrup'] = serialize(array($this->mctOpciGrup->OpciGrup));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataOpciGrup']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctOpciGrup->OpciGrup->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'OpciGrup';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctOpciGrup->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('OpciGrup'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctOpciGrup->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('OpciGrup',$this->mctOpciGrup->OpciGrup->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctOpciGrup->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctOpciGrup->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objOpciGrup = OpciGrup::LoadByCodiGrupCodiOpci($this->lstCodiGrupObject->SelectedValue,$this->lstCodiOpciObject->SelectedValue)) && ($objOpciGrup->CodiRegi != $this->mctOpciGrup->OpciGrup->CodiRegi )){
				$blnToReturn = false;
				$this->lstCodiGrupObject->Warning = QApplication::Translate("Already in Use");
				$this->lstCodiOpciObject->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/opci_grup_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the OpciGrupMetaControl
		$this->mctOpciGrup->SaveOpciGrup();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctOpciGrup->TablasRelacionadasOpciGrup();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the OpciGrupMetaControl
			$this->mctOpciGrup->DeleteOpciGrup();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctOpciGrup->OpciGrup->Id;
        $_SESSION['TablRefe'] = 'OpciGrup';
        $_SESSION['RegiReto'] = 'opci_grup_edit.php/'.$this->mctOpciGrup->OpciGrup->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/opci_grup_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/opci_grup_edit.php');
    }
