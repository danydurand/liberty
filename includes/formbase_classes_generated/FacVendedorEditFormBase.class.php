 ...
 */
abstract class FacVendedorEditFormBase extends QForm {
	// Local instance of the FacVendedorMetaControl
	/**
	 * @var FacVendedorMetaControlGen mctFacVendedor
	 */
	protected $mctFacVendedor;
	...
	// Controls for FacVendedor's Data Fields
	protected $txtId;
	protected $txtNombre;
	protected $txtCedula;
	protected $txtDireccionEmail;
	protected $txtPorcentajeComision;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacVendedor';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacVendedor->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacVendedor'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacVendedor->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacVendedor->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacVendedor->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacVendedorMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacVendedorMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacVendedor->FacVendedor->Id;
        $_SESSION['TablRefe'] = 'FacVendedor';
        $_SESSION['RegiReto'] = 'fac_vendedor_edit.php/'.$this->mctFacVendedor->FacVendedor->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/fac_vendedor_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/fac_vendedor_edit.php');
    }
