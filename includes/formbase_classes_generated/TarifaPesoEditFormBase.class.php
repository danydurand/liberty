 ...
 */
abstract class TarifaPesoEditFormBase extends QForm {
	// Local instance of the TarifaPesoMetaControl
	/**
	 * @var TarifaPesoMetaControlGen mctTarifaPeso
	 */
	protected $mctTarifaPeso;
	...
	// Controls for TarifaPeso's Data Fields
	protected $lblId;
	protected $lstTarifa;
	protected $lstTipo;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'TarifaPeso';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTarifaPeso->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('TarifaPeso'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTarifaPeso->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTarifaPeso->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTarifaPeso->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objTarifaPeso = TarifaPeso::LoadByTarifaIdTipoIdPesoInicialPesoFinal($this->lstTarifa->SelectedValue,$this->lstTipo->SelectedValue,$this->txtPesoInicial->Text,$this->txtPesoFinal->Text)) && ($objTarifaPeso->Id != $this->mctTarifaPeso->TarifaPeso->Id )){
				$blnToReturn = false;
				$this->lstTarifa->Warning = QApplication::Translate("Already in Use");
				$this->lstTipo->Warning = QApplication::Translate("Already in Use");
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TarifaPesoMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TarifaPesoMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTarifaPeso->TarifaPeso->Id;
        $_SESSION['TablRefe'] = 'TarifaPeso';
        $_SESSION['RegiReto'] = 'tarifa_peso_edit.php/'.$this->mctTarifaPeso->TarifaPeso->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tarifa_peso_list.php');
    }
