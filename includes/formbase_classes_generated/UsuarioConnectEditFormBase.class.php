 ...
 */
abstract class UsuarioConnectEditFormBase extends QForm {
	// Local instance of the UsuarioConnectMetaControl
	/**
	 * @var UsuarioConnectMetaControlGen mctUsuarioConnect
	 */
	protected $mctUsuarioConnect;
	...
	// Controls for UsuarioConnect's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
		...
		$this->calDeletedAt = $this->mctUsuarioConnect->calDeletedAt_Create();
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'UsuarioConnect';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctUsuarioConnect->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('UsuarioConnect'))));
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctUsuarioConnect->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objUsuarioConnect = UsuarioConnect::LoadByLogiUsua($this->txtLogiUsua->Text)) && ($objUsuarioConnect->Id != $this->mctUsuarioConnect->UsuarioConnect->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the UsuarioConnectMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the UsuarioConnectMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctUsuarioConnect->UsuarioConnect->Id;
        $_SESSION['TablRefe'] = 'UsuarioConnect';
        $_SESSION['RegiReto'] = 'usuario_connect_edit.php/'.$this->mctUsuarioConnect->UsuarioConnect->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/usuario_connect_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/usuario_connect_edit.php');
    }
