 ...
 */
abstract class MotivoIncidenciaEditFormBase extends QForm {
	// Local instance of the MotivoIncidenciaMetaControl
	/**
	 * @var MotivoIncidenciaMetaControlGen mctMotivoIncidencia
	 */
	protected $mctMotivoIncidencia;
	...
	// Controls for MotivoIncidencia's Data Fields
	protected $lblId;
	protected $txtCodigo;
	protected $txtNombre;
	protected $chkActivo;
    ...
    protected function determinarPosicion() {
        if ($this->mctMotivoIncidencia->MotivoIncidencia && !isset($_SESSION['DataMotivoIncidencia'])) {
            $_SESSION['DataMotivoIncidencia'] = serialize(array($this->mctMotivoIncidencia->MotivoIncidencia));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataMotivoIncidencia']);
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'MotivoIncidencia';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctMotivoIncidencia->EditMode;
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctMotivoIncidencia->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctMotivoIncidencia->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/motivo_incidencia_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the MotivoIncidenciaMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctMotivoIncidencia->TablasRelacionadasMotivoIncidencia();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the MotivoIncidenciaMetaControl
			$this->mctMotivoIncidencia->DeleteMotivoIncidencia();
			$this->RedirectToListPage();
		}
	}
    ...
    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/motivo_incidencia_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/motivo_incidencia_edit.php');
    }
