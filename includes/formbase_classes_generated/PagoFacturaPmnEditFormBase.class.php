 ...
 * of the PagoFacturaPmn class.  It uses the code-generated
 * PagoFacturaPmnMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a PagoFacturaPmn columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both pago_factura_pmn_edit.php AND
 * pago_factura_pmn_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PagoFacturaPmnEditFormBase extends QForm {
	// Local instance of the PagoFacturaPmnMetaControl
	/**
	 * @var PagoFacturaPmnMetaControlGen mctPagoFacturaPmn
	 */
	protected $mctPagoFacturaPmn;
	...
	// Controls for PagoFacturaPmn's Data Fields
	protected $lblId;
	protected $lstFactura;
	protected $lstFormaPago;
	protected $txtNumeroDocumento;
	protected $txtMontoPago;
	protected $calCreadoEl;
	protected $lstCreadoPorObject;
	protected $lstBanco;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PagoFacturaPmnMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPagoFacturaPmn = PagoFacturaPmnMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on PagoFacturaPmn's data fields
		$this->lblId = $this->mctPagoFacturaPmn->lblId_Create();
		$this->lstFactura = $this->mctPagoFacturaPmn->lstFactura_Create();
		$this->lstFormaPago = $this->mctPagoFacturaPmn->lstFormaPago_Create();
		$this->txtNumeroDocumento = $this->mctPagoFacturaPmn->txtNumeroDocumento_Create();
		$this->txtMontoPago = $this->mctPagoFacturaPmn->txtMontoPago_Create();
		$this->calCreadoEl = $this->mctPagoFacturaPmn->calCreadoEl_Create();
		$this->lstCreadoPorObject = $this->mctPagoFacturaPmn->lstCreadoPorObject_Create();
		$this->lstBanco = $this->mctPagoFacturaPmn->lstBanco_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPagoFacturaPmn->PagoFacturaPmn && !isset($_SESSION['DataPagoFacturaPmn'])) {
            $_SESSION['DataPagoFacturaPmn'] = serialize(array($this->mctPagoFacturaPmn->PagoFacturaPmn));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPagoFacturaPmn']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPagoFacturaPmn->PagoFacturaPmn->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PagoFacturaPmn';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPagoFacturaPmn->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PagoFacturaPmn'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPagoFacturaPmn->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('PagoFacturaPmn',$this->mctPagoFacturaPmn->PagoFacturaPmn->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPagoFacturaPmn->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPagoFacturaPmn->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/pago_factura_pmn_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctPagoFacturaPmn->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PagoFacturaPmnMetaControl
		$this->mctPagoFacturaPmn->SavePagoFacturaPmn();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPagoFacturaPmn->TablasRelacionadasPagoFacturaPmn();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PagoFacturaPmnMetaControl
			$this->mctPagoFacturaPmn->DeletePagoFacturaPmn();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPagoFacturaPmn->PagoFacturaPmn->Id;
        $_SESSION['TablRefe'] = 'PagoFacturaPmn';
        $_SESSION['RegiReto'] = 'pago_factura_pmn_edit.php/'.$this->mctPagoFacturaPmn->PagoFacturaPmn->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/pago_factura_pmn_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/pago_factura_pmn_edit.php');
    }
