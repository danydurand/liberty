 ...
 * of the Notificacion class.  It uses the code-generated
 * NotificacionMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Notificacion columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both notificacion_edit.php AND
 * notificacion_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class NotificacionEditFormBase extends QForm {
	// Local instance of the NotificacionMetaControl
	/**
	 * @var NotificacionMetaControlGen mctNotificacion
	 */
	protected $mctNotificacion;
	...
	// Controls for Notificacion's Data Fields
	protected $txtId;
	protected $lstGuia;
	protected $lstCheckpoint;
	protected $lstNotificadoObject;
	protected $calFecha;
	protected $txtHora;
	protected $chkNotificadoSms;
	protected $txtTipoSms;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the NotificacionMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctNotificacion = NotificacionMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Notificacion's data fields
		$this->txtId = $this->mctNotificacion->txtId_Create();
		$this->lstGuia = $this->mctNotificacion->lstGuia_Create();
		$this->lstCheckpoint = $this->mctNotificacion->lstCheckpoint_Create();
		$this->lstNotificadoObject = $this->mctNotificacion->lstNotificadoObject_Create();
		$this->calFecha = $this->mctNotificacion->calFecha_Create();
		$this->txtHora = $this->mctNotificacion->txtHora_Create();
		$this->chkNotificadoSms = $this->mctNotificacion->chkNotificadoSms_Create();
		$this->txtTipoSms = $this->mctNotificacion->txtTipoSms_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctNotificacion->Notificacion && !isset($_SESSION['DataNotificacion'])) {
            $_SESSION['DataNotificacion'] = serialize(array($this->mctNotificacion->Notificacion));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataNotificacion']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctNotificacion->Notificacion->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Notificacion';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctNotificacion->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Notificacion'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctNotificacion->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Notificacion',$this->mctNotificacion->Notificacion->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctNotificacion->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctNotificacion->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/notificacion_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctNotificacion->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the NotificacionMetaControl
		$this->mctNotificacion->SaveNotificacion();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctNotificacion->TablasRelacionadasNotificacion();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the NotificacionMetaControl
			$this->mctNotificacion->DeleteNotificacion();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctNotificacion->Notificacion->Id;
        $_SESSION['TablRefe'] = 'Notificacion';
        $_SESSION['RegiReto'] = 'notificacion_edit.php/'.$this->mctNotificacion->Notificacion->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/notificacion_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/notificacion_edit.php');
    }
