 ...
 * of the Estado class.  It uses the code-generated
 * EstadoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Estado columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both estado_edit.php AND
 * estado_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class EstadoEditFormBase extends QForm {
	// Local instance of the EstadoMetaControl
	/**
	 * @var EstadoMetaControlGen mctEstado
	 */
	protected $mctEstado;
	...
	// Controls for Estado's Data Fields
	protected $lblId;
	protected $txtNombre;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the EstadoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctEstado = EstadoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Estado's data fields
		$this->lblId = $this->mctEstado->lblId_Create();
		$this->txtNombre = $this->mctEstado->txtNombre_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctEstado->Estado && !isset($_SESSION['DataEstado'])) {
            $_SESSION['DataEstado'] = serialize(array($this->mctEstado->Estado));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataEstado']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctEstado->Estado->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctEstado->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Estado'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctEstado->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Estado',$this->mctEstado->Estado->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctEstado->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctEstado->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/estado_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the EstadoMetaControl
		$this->mctEstado->SaveEstado();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctEstado->TablasRelacionadasEstado();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the EstadoMetaControl
			$this->mctEstado->DeleteEstado();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctEstado->Estado->Id;
        $_SESSION['TablRefe'] = 'Estado';
        $_SESSION['RegiReto'] = 'estado_edit.php/'.$this->mctEstado->Estado->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/estado_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/estado_edit.php');
    }
