...
abstract class CounterEditFormBase extends QForm {
	...
	protected $txtSiglas;
	protected $txtLimiteDePaquetes;
	protected $txtCantidadDePaquetes;
	protected $txtCkptRecepcion;
	protected $txtCkptConfirmacion;
	protected $txtCkptAlmacen;
	protected $txtPaisId;
	protected $txtStatusId;
	protected $txtDireccion;
	protected $lstElegirServicioObject;
	protected $lstEsRutaObject;
	protected $lstSeFacturaObject;
	protected $lstPermitePagoObject;
