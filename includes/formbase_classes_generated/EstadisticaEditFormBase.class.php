 ...
 * of the Estadistica class.  It uses the code-generated
 * EstadisticaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Estadistica columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both estadistica_edit.php AND
 * estadistica_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class EstadisticaEditFormBase extends QForm {
	// Local instance of the EstadisticaMetaControl
	/**
	 * @var EstadisticaMetaControlGen mctEstadistica
	 */
	protected $mctEstadistica;
	...
	// Controls for Estadistica's Data Fields
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the EstadisticaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctEstadistica = EstadisticaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Estadistica's data fields
		$this->lstSucursal = $this->mctEstadistica->lstSucursal_Create();
		$this->calFecha = $this->mctEstadistica->calFecha_Create();
		$this->txtMedicion = $this->mctEstadistica->txtMedicion_Create();
		$this->txtCifra = $this->mctEstadistica->txtCifra_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctEstadistica->Estadistica && !isset($_SESSION['DataEstadistica'])) {
            $_SESSION['DataEstadistica'] = serialize(array($this->mctEstadistica->Estadistica));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataEstadistica']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctEstadistica->Estadistica->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Estadistica';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctEstadistica->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Estadistica'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctEstadistica->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Estadistica',$this->mctEstadistica->Estadistica->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctEstadistica->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctEstadistica->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/estadistica_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctEstadistica->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the EstadisticaMetaControl
		$this->mctEstadistica->SaveEstadistica();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctEstadistica->TablasRelacionadasEstadistica();
		if (count($arrTablRela)) {
			$strTablRela = implode(',',$arrTablRela);
				
			//$this->lstSucursal->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
				
			//$this->calFecha->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
				
			//$this->txtMedicion->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the EstadisticaMetaControl
			$this->mctEstadistica->DeleteEstadistica();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctEstadistica->Estadistica->Id;
        $_SESSION['TablRefe'] = 'Estadistica';
        $_SESSION['RegiReto'] = 'estadistica_edit.php/'.$this->mctEstadistica->Estadistica->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/estadistica_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/estadistica_edit.php');
    }
