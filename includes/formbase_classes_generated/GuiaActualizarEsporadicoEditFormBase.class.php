 ...
 * of the GuiaActualizarEsporadico class.  It uses the code-generated
 * GuiaActualizarEsporadicoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaActualizarEsporadico columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_actualizar_esporadico_edit.php AND
 * guia_actualizar_esporadico_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaActualizarEsporadicoEditFormBase extends QForm {
	// Local instance of the GuiaActualizarEsporadicoMetaControl
	/**
	 * @var GuiaActualizarEsporadicoMetaControlGen mctGuiaActualizarEsporadico
	 */
	protected $mctGuiaActualizarEsporadico;
	...
	// Controls for GuiaActualizarEsporadico's Data Fields
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaActualizarEsporadicoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaActualizarEsporadico = GuiaActualizarEsporadicoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaActualizarEsporadico's data fields
		$this->txtNumeGuia = $this->mctGuiaActualizarEsporadico->txtNumeGuia_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaActualizarEsporadico->GuiaActualizarEsporadico && !isset($_SESSION['DataGuiaActualizarEsporadico'])) {
            $_SESSION['DataGuiaActualizarEsporadico'] = serialize(array($this->mctGuiaActualizarEsporadico->GuiaActualizarEsporadico));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaActualizarEsporadico']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaActualizarEsporadico->GuiaActualizarEsporadico->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaActualizarEsporadico';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaActualizarEsporadico->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaActualizarEsporadico'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaActualizarEsporadico->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaActualizarEsporadico',$this->mctGuiaActualizarEsporadico->GuiaActualizarEsporadico->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaActualizarEsporadico->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaActualizarEsporadico->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_actualizar_esporadico_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaActualizarEsporadico->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaActualizarEsporadicoMetaControl
		$this->mctGuiaActualizarEsporadico->SaveGuiaActualizarEsporadico();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaActualizarEsporadico->TablasRelacionadasGuiaActualizarEsporadico();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaActualizarEsporadicoMetaControl
			$this->mctGuiaActualizarEsporadico->DeleteGuiaActualizarEsporadico();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaActualizarEsporadico->GuiaActualizarEsporadico->Id;
        $_SESSION['TablRefe'] = 'GuiaActualizarEsporadico';
        $_SESSION['RegiReto'] = 'guia_actualizar_esporadico_edit.php/'.$this->mctGuiaActualizarEsporadico->GuiaActualizarEsporadico->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_actualizar_esporadico_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_actualizar_esporadico_edit.php');
    }
