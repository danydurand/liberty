 ...
 * of the Modo class.  It uses the code-generated
 * ModoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Modo columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both modo_edit.php AND
 * modo_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ModoEditFormBase extends QForm {
	// Local instance of the ModoMetaControl
	/**
	 * @var ModoMetaControlGen mctModo
	 */
	protected $mctModo;
	...
	// Controls for Modo's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ModoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctModo = ModoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Modo's data fields
		$this->lblId = $this->mctModo->lblId_Create();
		$this->txtDescripcion = $this->mctModo->txtDescripcion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctModo->Modo && !isset($_SESSION['DataModo'])) {
            $_SESSION['DataModo'] = serialize(array($this->mctModo->Modo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataModo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctModo->Modo->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctModo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Modo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctModo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Modo',$this->mctModo->Modo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctModo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctModo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/modo_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ModoMetaControl
		$this->mctModo->SaveModo();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctModo->TablasRelacionadasModo();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ModoMetaControl
			$this->mctModo->DeleteModo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctModo->Modo->Id;
        $_SESSION['TablRefe'] = 'Modo';
        $_SESSION['RegiReto'] = 'modo_edit.php/'.$this->mctModo->Modo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/modo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/modo_edit.php');
    }
