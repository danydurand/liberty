 ...
 * of the TrackingConsecutivo class.  It uses the code-generated
 * TrackingConsecutivoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a TrackingConsecutivo columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both tracking_consecutivo_edit.php AND
 * tracking_consecutivo_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class TrackingConsecutivoEditFormBase extends QForm {
	// Local instance of the TrackingConsecutivoMetaControl
	/**
	 * @var TrackingConsecutivoMetaControlGen mctTrackingConsecutivo
	 */
	protected $mctTrackingConsecutivo;
	...
	// Controls for TrackingConsecutivo's Data Fields
	protected $lblId;
	protected $txtNada;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the TrackingConsecutivoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctTrackingConsecutivo = TrackingConsecutivoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on TrackingConsecutivo's data fields
		$this->lblId = $this->mctTrackingConsecutivo->lblId_Create();
		$this->txtNada = $this->mctTrackingConsecutivo->txtNada_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctTrackingConsecutivo->TrackingConsecutivo && !isset($_SESSION['DataTrackingConsecutivo'])) {
            $_SESSION['DataTrackingConsecutivo'] = serialize(array($this->mctTrackingConsecutivo->TrackingConsecutivo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataTrackingConsecutivo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctTrackingConsecutivo->TrackingConsecutivo->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'TrackingConsecutivo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTrackingConsecutivo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('TrackingConsecutivo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTrackingConsecutivo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('TrackingConsecutivo',$this->mctTrackingConsecutivo->TrackingConsecutivo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTrackingConsecutivo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTrackingConsecutivo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/tracking_consecutivo_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctTrackingConsecutivo->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TrackingConsecutivoMetaControl
		$this->mctTrackingConsecutivo->SaveTrackingConsecutivo();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctTrackingConsecutivo->TablasRelacionadasTrackingConsecutivo();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TrackingConsecutivoMetaControl
			$this->mctTrackingConsecutivo->DeleteTrackingConsecutivo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTrackingConsecutivo->TrackingConsecutivo->Id;
        $_SESSION['TablRefe'] = 'TrackingConsecutivo';
        $_SESSION['RegiReto'] = 'tracking_consecutivo_edit.php/'.$this->mctTrackingConsecutivo->TrackingConsecutivo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tracking_consecutivo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/tracking_consecutivo_edit.php');
    }
