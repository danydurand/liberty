<?php
	 ...
	 */
	abstract class LugarIncidenciaListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list LugarIncidencias
		/**
		 * @var LugarIncidenciaDataGrid dtgLugarIncidencias
		 */
		protected $dtgLugarIncidencias;
		...
		protected function Form_Create() {
			...
			$this->dtgLugarIncidencias->ShowFilter = false;

			// Add Pagination (if desired)
			$this->dtgLugarIncidencias->Paginator = new QPaginator($this->dtgLugarIncidencias);
			$this->dtgLugarIncidencias->ItemsPerPage = __FORM_DRAFTS_FORM_LIST_ITEMS_PER_PAGE__;
			...
			$this->dtgLugarIncidencias->MetaAddColumn('Id');
			$this->dtgLugarIncidencias->MetaAddColumn('Codigo');
			$this->dtgLugarIncidencias->MetaAddColumn('Nombre');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'LugarIncidencias';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgLugarIncidencias);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgLugarIncidencias->ShowFilter = !$this->dtgLugarIncidencias->ShowFilter;
        }
