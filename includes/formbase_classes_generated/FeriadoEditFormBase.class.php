 ...
 */
abstract class FeriadoEditFormBase extends QForm {
	// Local instance of the FeriadoMetaControl
	/**
	 * @var FeriadoMetaControlGen mctFeriado
	 */
	protected $mctFeriado;
	...
	// Controls for Feriado's Data Fields
	protected $lblId;
	protected $calFecha;
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFeriado->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Feriado'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFeriado->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFeriado->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFeriado->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objFeriado = Feriado::LoadByFecha($this->calFecha->DateTime)) && ($objFeriado->Id != $this->mctFeriado->Feriado->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FeriadoMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FeriadoMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFeriado->Feriado->Id;
        $_SESSION['TablRefe'] = 'Feriado';
        $_SESSION['RegiReto'] = 'feriado_edit.php/'.$this->mctFeriado->Feriado->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/feriado_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/feriado_edit.php');
    }
