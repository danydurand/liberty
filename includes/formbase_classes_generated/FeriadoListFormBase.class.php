<?php
	 ...
	 */
	abstract class FeriadoListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Feriados
		/**
		 * @var FeriadoDataGrid dtgFeriados
		 */
		protected $dtgFeriados;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'Feriados';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgFeriados);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgFeriados->ShowFilter = !$this->dtgFeriados->ShowFilter;
        }
