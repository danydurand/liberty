 ...
 */
abstract class OpcionEditFormBase extends QForm {
	// Local instance of the OpcionMetaControl
	/**
	 * @var OpcionMetaControlGen mctOpcion
	 */
	protected $mctOpcion;
	...
	// Controls for Opcion's Data Fields
	protected $lblCodiOpci;
	protected $lstCodiSistObject;
	protected $txtDescOpci;
	protected $lstCodiTipoObject;
	protected $txtNombProg;
	protected $txtNumeDepe;
	protected $txtImagOpci;
	protected $txtAnchImag;
	protected $txtAltoImag;
	protected $lstCodiStatObject;
	protected $txtTextObse;
	protected $txtPosiOpci;
	protected $txtPathOpci;
	protected $txtNombreClase;
	protected $txtNivel;
	...
	protected function Form_Create() {
		...
		$this->txtAnchImag = $this->mctOpcion->txtAnchImag_Create();
		$this->txtAltoImag = $this->mctOpcion->txtAltoImag_Create();
		$this->lstCodiStatObject = $this->mctOpcion->lstCodiStatObject_Create();
		$this->txtTextObse = $this->mctOpcion->txtTextObse_Create();
		$this->txtPosiOpci = $this->mctOpcion->txtPosiOpci_Create();
		$this->txtPathOpci = $this->mctOpcion->txtPathOpci_Create();
		$this->txtNombreClase = $this->mctOpcion->txtNombreClase_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctOpcion->Opcion && !isset($_SESSION['DataOpcion'])) {
            $_SESSION['DataOpcion'] = serialize(array($this->mctOpcion->Opcion));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataOpcion']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctOpcion->Opcion->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctOpcion->EditMode;
    }
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Opcion',$this->mctOpcion->Opcion->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctOpcion->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctOpcion->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/opcion_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the OpcionMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if (count($arrTablRela)) {
			...
			//$this->lblCodiOpci->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctOpcion->Opcion->Id;
        $_SESSION['TablRefe'] = 'Opcion';
        $_SESSION['RegiReto'] = 'opcion_edit.php/'.$this->mctOpcion->Opcion->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/opcion_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/opcion_edit.php');
    }
