 ...
 * of the Conectados class.  It uses the code-generated
 * ConectadosMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Conectados columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both conectados_edit.php AND
 * conectados_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ConectadosEditFormBase extends QForm {
	// Local instance of the ConectadosMetaControl
	/**
	 * @var ConectadosMetaControlGen mctConectados
	 */
	protected $mctConectados;
	...
	// Controls for Conectados's Data Fields
	protected $lblId;
	protected $calFecha;
	protected $calHora;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ConectadosMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctConectados = ConectadosMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Conectados's data fields
		$this->lblId = $this->mctConectados->lblId_Create();
		$this->calFecha = $this->mctConectados->calFecha_Create();
		$this->calHora = $this->mctConectados->calHora_Create();
		$this->txtCantidad = $this->mctConectados->txtCantidad_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctConectados->Conectados && !isset($_SESSION['DataConectados'])) {
            $_SESSION['DataConectados'] = serialize(array($this->mctConectados->Conectados));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataConectados']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctConectados->Conectados->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Conectados';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctConectados->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Conectados'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctConectados->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Conectados',$this->mctConectados->Conectados->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctConectados->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctConectados->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/conectados_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctConectados->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ConectadosMetaControl
		$this->mctConectados->SaveConectados();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctConectados->TablasRelacionadasConectados();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ConectadosMetaControl
			$this->mctConectados->DeleteConectados();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctConectados->Conectados->Id;
        $_SESSION['TablRefe'] = 'Conectados';
        $_SESSION['RegiReto'] = 'conectados_edit.php/'.$this->mctConectados->Conectados->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/conectados_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/conectados_edit.php');
    }
