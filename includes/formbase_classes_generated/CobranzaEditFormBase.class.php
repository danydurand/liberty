 ...
 * CobranzaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Cobranza columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both cobranza_edit.php AND
 * cobranza_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class CobranzaEditFormBase extends QForm {
	// Local instance of the CobranzaMetaControl
	/**
	 * @var CobranzaMetaControlGen mctCobranza
	 */
	protected $mctCobranza;
	...
	// Controls for Cobranza's Data Fields
	protected $lblId;
	protected $lstFactura;
	protected $calFecha;
	protected $lstFormaPago;
	protected $txtDocumento;
	protected $lstBanco;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the CobranzaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctCobranza = CobranzaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Cobranza's data fields
		$this->lblId = $this->mctCobranza->lblId_Create();
		$this->lstFactura = $this->mctCobranza->lstFactura_Create();
		$this->calFecha = $this->mctCobranza->calFecha_Create();
		$this->lstFormaPago = $this->mctCobranza->lstFormaPago_Create();
		$this->txtDocumento = $this->mctCobranza->txtDocumento_Create();
		$this->lstBanco = $this->mctCobranza->lstBanco_Create();
		$this->txtMontoCancelado = $this->mctCobranza->txtMontoCancelado_Create();
		$this->lstTurno = $this->mctCobranza->lstTurno_Create();
		$this->lstCajero = $this->mctCobranza->lstCajero_Create();
		$this->lstCaja = $this->mctCobranza->lstCaja_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctCobranza->Cobranza && !isset($_SESSION['DataCobranza'])) {
            $_SESSION['DataCobranza'] = serialize(array($this->mctCobranza->Cobranza));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataCobranza']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctCobranza->Cobranza->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Cobranza';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctCobranza->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Cobranza'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctCobranza->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Cobranza',$this->mctCobranza->Cobranza->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctCobranza->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctCobranza->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/cobranza_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the CobranzaMetaControl
		$this->mctCobranza->SaveCobranza();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctCobranza->TablasRelacionadasCobranza();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the CobranzaMetaControl
			$this->mctCobranza->DeleteCobranza();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctCobranza->Cobranza->Id;
        $_SESSION['TablRefe'] = 'Cobranza';
        $_SESSION['RegiReto'] = 'cobranza_edit.php/'.$this->mctCobranza->Cobranza->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/cobranza_list.php');
    }
