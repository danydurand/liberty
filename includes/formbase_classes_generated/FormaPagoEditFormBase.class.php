 ...
 */
abstract class FormaPagoEditFormBase extends QForm {
	// Local instance of the FormaPagoMetaControl
	/**
	 * @var FormaPagoMetaControlGen mctFormaPago
	 */
	protected $mctFormaPago;
	...
	// Controls for FormaPago's Data Fields
	protected $lblId;
	protected $txtDescripcion;
	protected $lstStatus;
	protected $lstRequiereDocumentoObject;
	protected $txtTextoDocumento;
	protected $lstRequiereCuentaObject;
	protected $txtAbreviado;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FormaPago';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFormaPago->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FormaPago'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFormaPago->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFormaPago->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFormaPago->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FormaPagoMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FormaPagoMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFormaPago->FormaPago->Id;
        $_SESSION['TablRefe'] = 'FormaPago';
        $_SESSION['RegiReto'] = 'forma_pago_edit.php/'.$this->mctFormaPago->FormaPago->Id;
