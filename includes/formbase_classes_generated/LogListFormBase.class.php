<?php
	 ...
	 */
	abstract class LogListFormBase extends QForm {
		...
		protected function Form_Create() {
			...
			$this->dtgLogs->MetaAddColumn('Fecha');
			$this->dtgLogs->MetaAddColumn('Hora');
			$this->dtgLogs->MetaAddColumn('Usuario');
			$this->dtgLogs->MetaAddColumn('Tabla');
			$this->dtgLogs->MetaAddColumn('Ref');
			$this->dtgLogs->MetaAddColumn('Nombre');
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgLogs);
