<?php
	 ...
	 */
	abstract class SdeCheckpointListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list SdeCheckpoints
		/**
		 * @var SdeCheckpointDataGrid dtgSdeCheckpoints
		 */
		protected $dtgSdeCheckpoints;
		...
		protected function Form_Create() {
			...
			$this->dtgSdeCheckpoints->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
			...
			$this->dtgSdeCheckpoints->MetaAddColumn('CodiCkpt');
			$this->dtgSdeCheckpoints->MetaAddColumn('DescCkpt');
			$this->dtgSdeCheckpoints->MetaAddTypeColumn('TipoTerm', 'SdeTerminalCkptType');
			$this->dtgSdeCheckpoints->MetaAddTypeColumn('TipoCkpt', 'SdeTipoCkptType');
			$this->dtgSdeCheckpoints->MetaAddColumn('TextObse');
			$this->dtgSdeCheckpoints->MetaAddTypeColumn('CodiStat', 'StatusType');
			$this->dtgSdeCheckpoints->MetaAddTypeColumn('CodiCcat', 'MasCateCkptType');
			$this->dtgSdeCheckpoints->MetaAddTypeColumn('CodiInad', 'MasInciCkptType');
			$this->dtgSdeCheckpoints->MetaAddColumn('DescDevo');
			$this->dtgSdeCheckpoints->MetaAddTypeColumn('Notificar', 'SinoType');
			$this->dtgSdeCheckpoints->MetaAddColumn(QQN::SdeCheckpoint()->Pais);
			$this->dtgSdeCheckpoints->MetaAddColumn('ComentarioIvr');
			$this->dtgSdeCheckpoints->MetaAddColumn('CodigoSodexo');
			$this->dtgSdeCheckpoints->MetaAddColumn('DescripcionSodexo');
			$this->dtgSdeCheckpoints->MetaAddColumn('NotificacionSms');
			$this->dtgSdeCheckpoints->MetaAddColumn('Imagen');
			$this->dtgSdeCheckpoints->MetaAddColumn('Color');
			$this->dtgSdeCheckpoints->MetaAddColumn('DeleteAt');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'SdeCheckpoints';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgSdeCheckpoints);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgSdeCheckpoints->ShowFilter = !$this->dtgSdeCheckpoints->ShowFilter;
        }

		public function dtgSdeCheckpointsRow_Click($strFormId, $strControlId, $strParameter) {
		  $intId = intval($strParameter);
		  QApplication::Redirect("sde_checkpoint_edit.php/$intId");
		}
