 ...
 * PrealertaMailMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a PrealertaMail columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both prealerta_mail_edit.php AND
 * prealerta_mail_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PrealertaMailEditFormBase extends QForm {
	// Local instance of the PrealertaMailMetaControl
	/**
	 * @var PrealertaMailMetaControlGen mctPrealertaMail
	 */
	protected $mctPrealertaMail;
	...
	// Controls for PrealertaMail's Data Fields
	protected $lblId;
	...
	protected $txtPrecio;
	protected $txtFechaEmail;
	protected $calFechaRegistro;
	protected $txtHoraRegistro;
	protected $txtEmail;
	protected $txtProcesado;
	protected $calFechaProcesado;
	protected $txtHoraProcesado;
	protected $txtStatus;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PrealertaMailMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPrealertaMail = PrealertaMailMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on PrealertaMail's data fields
		$this->lblId = $this->mctPrealertaMail->lblId_Create();
		$this->txtClienteId = $this->mctPrealertaMail->txtClienteId_Create();
		$this->txtCedula = $this->mctPrealertaMail->txtCedula_Create();
		$this->txtCourier = $this->mctPrealertaMail->txtCourier_Create();
		$this->txtTracking = $this->mctPrealertaMail->txtTracking_Create();
		$this->txtDescripcion = $this->mctPrealertaMail->txtDescripcion_Create();
		$this->txtPrecio = $this->mctPrealertaMail->txtPrecio_Create();
		$this->txtFechaEmail = $this->mctPrealertaMail->txtFechaEmail_Create();
		$this->calFechaRegistro = $this->mctPrealertaMail->calFechaRegistro_Create();
		$this->txtHoraRegistro = $this->mctPrealertaMail->txtHoraRegistro_Create();
		$this->txtEmail = $this->mctPrealertaMail->txtEmail_Create();
		$this->txtProcesado = $this->mctPrealertaMail->txtProcesado_Create();
		$this->calFechaProcesado = $this->mctPrealertaMail->calFechaProcesado_Create();
		$this->txtHoraProcesado = $this->mctPrealertaMail->txtHoraProcesado_Create();
		$this->txtStatus = $this->mctPrealertaMail->txtStatus_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPrealertaMail->PrealertaMail && !isset($_SESSION['DataPrealertaMail'])) {
            $_SESSION['DataPrealertaMail'] = serialize(array($this->mctPrealertaMail->PrealertaMail));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPrealertaMail']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPrealertaMail->PrealertaMail->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PrealertaMail';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPrealertaMail->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PrealertaMail'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPrealertaMail->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('PrealertaMail',$this->mctPrealertaMail->PrealertaMail->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPrealertaMail->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPrealertaMail->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/prealerta_mail_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctPrealertaMail->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PrealertaMailMetaControl
		$this->mctPrealertaMail->SavePrealertaMail();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPrealertaMail->TablasRelacionadasPrealertaMail();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PrealertaMailMetaControl
			$this->mctPrealertaMail->DeletePrealertaMail();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPrealertaMail->PrealertaMail->Id;
        $_SESSION['TablRefe'] = 'PrealertaMail';
        $_SESSION['RegiReto'] = 'prealerta_mail_edit.php/'.$this->mctPrealertaMail->PrealertaMail->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/prealerta_mail_list.php');
    }
