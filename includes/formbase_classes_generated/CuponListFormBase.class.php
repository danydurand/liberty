<?php
	 ...
	 */
	abstract class CuponListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Cupons
		/**
		 * @var CuponDataGrid dtgCupons
		 */
		protected $dtgCupons;
		...
		protected function Form_Create() {
			...
			$this->dtgCupons->ItemsPerPage = __FORM_DRAFTS_FORM_LIST_ITEMS_PER_PAGE__;
			...
			$this->dtgCupons->MetaAddColumn('Id');
			$this->dtgCupons->MetaAddColumn('Numero');
			$this->dtgCupons->MetaAddColumn('PorcentajeDescuento');
			$this->dtgCupons->MetaAddColumn('CargadoPor');
			$this->dtgCupons->MetaAddColumn('CargadoEl');
			$this->dtgCupons->MetaAddColumn('UsadoPor');
			$this->dtgCupons->MetaAddColumn('UsadoEl');
			$this->dtgCupons->MetaAddColumn('GuiaId');
			$this->dtgCupons->MetaAddColumn('MontoDescuento');
			$this->dtgCupons->MetaAddColumn('Receptoria');
			$this->dtgCupons->MetaAddColumn('Tipo');
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgCupons);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgCupons->ShowFilter = !$this->dtgCupons->ShowFilter;
        }

		public function dtgCuponsRow_Click($strFormId, $strControlId, $strParameter) {
		  $intId = intval($strParameter);
		  QApplication::Redirect("cupon_edit.php/$intId");
		}
