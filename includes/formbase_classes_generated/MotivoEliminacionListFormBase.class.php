<?php
	 ...
	 */
	abstract class MotivoEliminacionListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list MotivoEliminacions
		/**
		 * @var MotivoEliminacionDataGrid dtgMotivoEliminacions
		 */
		protected $dtgMotivoEliminacions;
		...
		protected function Form_Create() {
			...
			$this->dtgMotivoEliminacions->MetaAddColumn('Description');
			$this->dtgMotivoEliminacions->MetaAddColumn('CreatedAt');
			$this->dtgMotivoEliminacions->MetaAddColumn(QQN::MotivoEliminacion()->User);
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'MotivoEliminacions';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgMotivoEliminacions);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgMotivoEliminacions->ShowFilter = !$this->dtgMotivoEliminacions->ShowFilter;
        }
