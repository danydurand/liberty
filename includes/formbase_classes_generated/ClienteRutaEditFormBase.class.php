 ...
 * of the ClienteRuta class.  It uses the code-generated
 * ClienteRutaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ClienteRuta columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both cliente_ruta_edit.php AND
 * cliente_ruta_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ClienteRutaEditFormBase extends QForm {
	// Local instance of the ClienteRutaMetaControl
	/**
	 * @var ClienteRutaMetaControlGen mctClienteRuta
	 */
	protected $mctClienteRuta;
	...
	// Controls for ClienteRuta's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ClienteRutaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctClienteRuta = ClienteRutaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ClienteRuta's data fields
		$this->lblId = $this->mctClienteRuta->lblId_Create();
		$this->txtClienteId = $this->mctClienteRuta->txtClienteId_Create();
		$this->txtCodiRuta = $this->mctClienteRuta->txtCodiRuta_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctClienteRuta->ClienteRuta && !isset($_SESSION['DataClienteRuta'])) {
            $_SESSION['DataClienteRuta'] = serialize(array($this->mctClienteRuta->ClienteRuta));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataClienteRuta']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctClienteRuta->ClienteRuta->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ClienteRuta';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctClienteRuta->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ClienteRuta'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctClienteRuta->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ClienteRuta',$this->mctClienteRuta->ClienteRuta->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctClienteRuta->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctClienteRuta->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objClienteRuta = ClienteRuta::LoadByClienteId($this->txtClienteId->Text)) && ($objClienteRuta->Id != $this->mctClienteRuta->ClienteRuta->Id )){
				$blnToReturn = false;
				$this->txtClienteId->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/cliente_ruta_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctClienteRuta->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ClienteRutaMetaControl
		$this->mctClienteRuta->SaveClienteRuta();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctClienteRuta->TablasRelacionadasClienteRuta();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ClienteRutaMetaControl
			$this->mctClienteRuta->DeleteClienteRuta();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctClienteRuta->ClienteRuta->Id;
        $_SESSION['TablRefe'] = 'ClienteRuta';
        $_SESSION['RegiReto'] = 'cliente_ruta_edit.php/'.$this->mctClienteRuta->ClienteRuta->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/cliente_ruta_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/cliente_ruta_edit.php');
    }
