 ...
 */
abstract class ProcesoEditFormBase extends QForm {
	// Local instance of the ProcesoMetaControl
	/**
	 * @var ProcesoMetaControlGen mctProceso
	 */
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ProcesoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctProceso = ProcesoMetaControl::CreateFromPathInfo($this);
		...
		$this->lblId = $this->mctProceso->lblId_Create();
		$this->txtUsuario = $this->mctProceso->txtUsuario_Create();
		$this->txtPrograma = $this->mctProceso->txtPrograma_Create();
		$this->calFecha = $this->mctProceso->calFecha_Create();
		$this->txtHora = $this->mctProceso->txtHora_Create();
		$this->txtAccion = $this->mctProceso->txtAccion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctProceso->Proceso && !isset($_SESSION['DataProceso'])) {
            $_SESSION['DataProceso'] = serialize(array($this->mctProceso->Proceso));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataProceso']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctProceso->Proceso->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctProceso->EditMode;
    }
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Proceso',$this->mctProceso->Proceso->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctProceso->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctProceso->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/proceso_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctProceso->TablasRelacionadasProceso();
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctProceso->Proceso->Id;
        $_SESSION['TablRefe'] = 'Proceso';
        $_SESSION['RegiReto'] = 'proceso_edit.php/'.$this->mctProceso->Proceso->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/proceso_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/proceso_edit.php');
    }
