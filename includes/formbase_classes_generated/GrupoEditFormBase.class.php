 ...
 */
abstract class GrupoEditFormBase extends QForm {
	// Local instance of the GrupoMetaControl
	/**
	 * @var GrupoMetaControlGen mctGrupo
	 */
	protected $mctGrupo;
	...
	// Controls for Grupo's Data Fields
	protected $txtCodiGrup;
	protected $txtDescGrup;
    ...
    protected function determinarPosicion() {
        if ($this->mctGrupo->Grupo && !isset($_SESSION['DataGrupo'])) {
            $_SESSION['DataGrupo'] = serialize(array($this->mctGrupo->Grupo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGrupo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGrupo->Grupo->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGrupo->EditMode;
    }
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Grupo',$this->mctGrupo->Grupo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGrupo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGrupo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/grupo_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GrupoMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGrupo->TablasRelacionadasGrupo();
		if (count($arrTablRela)) {
			$strTablRela = implode(',',$arrTablRela);
				
			//$this->txtCodiGrup->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GrupoMetaControl
			$this->mctGrupo->DeleteGrupo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGrupo->Grupo->Id;
        $_SESSION['TablRefe'] = 'Grupo';
        $_SESSION['RegiReto'] = 'grupo_edit.php/'.$this->mctGrupo->Grupo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/grupo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/grupo_edit.php');
    }
