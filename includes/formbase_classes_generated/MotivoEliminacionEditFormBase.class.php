 ...
 */
abstract class MotivoEliminacionEditFormBase extends QForm {
	// Local instance of the MotivoEliminacionMetaControl
	/**
	 * @var MotivoEliminacionMetaControlGen mctMotivoEliminacion
	 */
	protected $mctMotivoEliminacion;
	...
	// Controls for MotivoEliminacion's Data Fields
	protected $lblId;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'MotivoEliminacion';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctMotivoEliminacion->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('MotivoEliminacion'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctMotivoEliminacion->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctMotivoEliminacion->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctMotivoEliminacion->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the MotivoEliminacionMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the MotivoEliminacionMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctMotivoEliminacion->MotivoEliminacion->Id;
        $_SESSION['TablRefe'] = 'MotivoEliminacion';
        $_SESSION['RegiReto'] = 'motivo_eliminacion_edit.php/'.$this->mctMotivoEliminacion->MotivoEliminacion->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/motivo_eliminacion_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/motivo_eliminacion_edit.php');
    }
