 ...
 * GuiaConnectPendienteMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaConnectPendiente columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_connect_pendiente_edit.php AND
 * guia_connect_pendiente_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaConnectPendienteEditFormBase extends QForm {
	// Local instance of the GuiaConnectPendienteMetaControl
	/**
	 * @var GuiaConnectPendienteMetaControlGen mctGuiaConnectPendiente
	 */
	protected $mctGuiaConnectPendiente;
	...
	// Controls for GuiaConnectPendiente's Data Fields
	protected $lblId;
	protected $txtGuiaId;
	protected $txtDestinatarioFrecuente;
	protected $txtRetorno;
	protected $txtRecolecta;
	protected $calProcesadoEl;
	protected $txtProcesado;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaConnectPendienteMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaConnectPendiente = GuiaConnectPendienteMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaConnectPendiente's data fields
		$this->lblId = $this->mctGuiaConnectPendiente->lblId_Create();
		$this->txtGuiaId = $this->mctGuiaConnectPendiente->txtGuiaId_Create();
		$this->txtDestinatarioFrecuente = $this->mctGuiaConnectPendiente->txtDestinatarioFrecuente_Create();
		$this->txtRetorno = $this->mctGuiaConnectPendiente->txtRetorno_Create();
		$this->txtRecolecta = $this->mctGuiaConnectPendiente->txtRecolecta_Create();
		$this->calProcesadoEl = $this->mctGuiaConnectPendiente->calProcesadoEl_Create();
		$this->txtProcesado = $this->mctGuiaConnectPendiente->txtProcesado_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaConnectPendiente->GuiaConnectPendiente && !isset($_SESSION['DataGuiaConnectPendiente'])) {
            $_SESSION['DataGuiaConnectPendiente'] = serialize(array($this->mctGuiaConnectPendiente->GuiaConnectPendiente));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaConnectPendiente']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaConnectPendiente->GuiaConnectPendiente->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaConnectPendiente';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaConnectPendiente->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaConnectPendiente'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaConnectPendiente->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaConnectPendiente',$this->mctGuiaConnectPendiente->GuiaConnectPendiente->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaConnectPendiente->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaConnectPendiente->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaConnectPendiente = GuiaConnectPendiente::LoadByGuiaId($this->txtGuiaId->Text)) && ($objGuiaConnectPendiente->Id != $this->mctGuiaConnectPendiente->GuiaConnectPendiente->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_connect_pendiente_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaConnectPendiente->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaConnectPendienteMetaControl
		$this->mctGuiaConnectPendiente->SaveGuiaConnectPendiente();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaConnectPendiente->TablasRelacionadasGuiaConnectPendiente();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaConnectPendienteMetaControl
			$this->mctGuiaConnectPendiente->DeleteGuiaConnectPendiente();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaConnectPendiente->GuiaConnectPendiente->Id;
        $_SESSION['TablRefe'] = 'GuiaConnectPendiente';
        $_SESSION['RegiReto'] = 'guia_connect_pendiente_edit.php/'.$this->mctGuiaConnectPendiente->GuiaConnectPendiente->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_connect_pendiente_list.php');
    }
