 ...
 * of the TipoTransaccion class.  It uses the code-generated
 * TipoTransaccionMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a TipoTransaccion columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both tipo_transaccion_edit.php AND
 * tipo_transaccion_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class TipoTransaccionEditFormBase extends QForm {
	// Local instance of the TipoTransaccionMetaControl
	/**
	 * @var TipoTransaccionMetaControlGen mctTipoTransaccion
	 */
	protected $mctTipoTransaccion;
	...
	// Controls for TipoTransaccion's Data Fields
	protected $lblId;
	protected $txtDescripcion;
	protected $txtNroMinDigitos;
	protected $txtNroMaxDigitos;
	protected $txtHipervinculo;
	protected $txtEtiqueta;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the TipoTransaccionMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctTipoTransaccion = TipoTransaccionMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on TipoTransaccion's data fields
		$this->lblId = $this->mctTipoTransaccion->lblId_Create();
		$this->txtDescripcion = $this->mctTipoTransaccion->txtDescripcion_Create();
		$this->txtNroMinDigitos = $this->mctTipoTransaccion->txtNroMinDigitos_Create();
		$this->txtNroMaxDigitos = $this->mctTipoTransaccion->txtNroMaxDigitos_Create();
		$this->txtHipervinculo = $this->mctTipoTransaccion->txtHipervinculo_Create();
		$this->txtEtiqueta = $this->mctTipoTransaccion->txtEtiqueta_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctTipoTransaccion->TipoTransaccion && !isset($_SESSION['DataTipoTransaccion'])) {
            $_SESSION['DataTipoTransaccion'] = serialize(array($this->mctTipoTransaccion->TipoTransaccion));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataTipoTransaccion']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctTipoTransaccion->TipoTransaccion->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'TipoTransaccion';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTipoTransaccion->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('TipoTransaccion'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTipoTransaccion->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('TipoTransaccion',$this->mctTipoTransaccion->TipoTransaccion->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTipoTransaccion->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTipoTransaccion->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/tipo_transaccion_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctTipoTransaccion->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TipoTransaccionMetaControl
		$this->mctTipoTransaccion->SaveTipoTransaccion();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctTipoTransaccion->TablasRelacionadasTipoTransaccion();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TipoTransaccionMetaControl
			$this->mctTipoTransaccion->DeleteTipoTransaccion();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTipoTransaccion->TipoTransaccion->Id;
        $_SESSION['TablRefe'] = 'TipoTransaccion';
        $_SESSION['RegiReto'] = 'tipo_transaccion_edit.php/'.$this->mctTipoTransaccion->TipoTransaccion->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tipo_transaccion_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/tipo_transaccion_edit.php');
    }
