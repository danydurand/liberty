 ...
 * LugarIncidenciaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a LugarIncidencia columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both lugar_incidencia_edit.php AND
 * lugar_incidencia_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class LugarIncidenciaEditFormBase extends QForm {
	// Local instance of the LugarIncidenciaMetaControl
	/**
	 * @var LugarIncidenciaMetaControlGen mctLugarIncidencia
	 */
	protected $mctLugarIncidencia;
	...
	// Controls for LugarIncidencia's Data Fields
	protected $lblId;
	protected $txtCodigo;
	protected $txtNombre;
	protected $chkActivo;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the LugarIncidenciaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctLugarIncidencia = LugarIncidenciaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on LugarIncidencia's data fields
		$this->lblId = $this->mctLugarIncidencia->lblId_Create();
		$this->txtCodigo = $this->mctLugarIncidencia->txtCodigo_Create();
		$this->txtNombre = $this->mctLugarIncidencia->txtNombre_Create();
		$this->chkActivo = $this->mctLugarIncidencia->chkActivo_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctLugarIncidencia->LugarIncidencia && !isset($_SESSION['DataLugarIncidencia'])) {
            $_SESSION['DataLugarIncidencia'] = serialize(array($this->mctLugarIncidencia->LugarIncidencia));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataLugarIncidencia']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctLugarIncidencia->LugarIncidencia->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'LugarIncidencia';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctLugarIncidencia->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('LugarIncidencia'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctLugarIncidencia->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('LugarIncidencia',$this->mctLugarIncidencia->LugarIncidencia->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctLugarIncidencia->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctLugarIncidencia->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/lugar_incidencia_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctLugarIncidencia->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the LugarIncidenciaMetaControl
		$this->mctLugarIncidencia->SaveLugarIncidencia();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctLugarIncidencia->TablasRelacionadasLugarIncidencia();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the LugarIncidenciaMetaControl
			$this->mctLugarIncidencia->DeleteLugarIncidencia();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctLugarIncidencia->LugarIncidencia->Id;
        $_SESSION['TablRefe'] = 'LugarIncidencia';
        $_SESSION['RegiReto'] = 'lugar_incidencia_edit.php/'.$this->mctLugarIncidencia->LugarIncidencia->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/lugar_incidencia_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/lugar_incidencia_edit.php');
    }
