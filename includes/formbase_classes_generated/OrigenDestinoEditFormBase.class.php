 ...
 */
abstract class OrigenDestinoEditFormBase extends QForm {
	// Local instance of the OrigenDestinoMetaControl
	/**
	 * @var OrigenDestinoMetaControlGen mctOrigenDestino
	 */
	protected $mctOrigenDestino;
	...
	// Controls for OrigenDestino's Data Fields
	protected $lblId;
	protected $lstOrigenObject;
	protected $lstDestinoObject;
	protected $txtCantidadDias;
	protected $lstStatusObject;
	protected $txtDistanciaKm;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'OrigenDestino';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctOrigenDestino->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('OrigenDestino'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctOrigenDestino->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctOrigenDestino->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctOrigenDestino->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objOrigenDestino = OrigenDestino::LoadByOrigenDestino($this->lstOrigenObject->SelectedValue,$this->lstDestinoObject->SelectedValue)) && ($objOrigenDestino->Id != $this->mctOrigenDestino->OrigenDestino->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the OrigenDestinoMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the OrigenDestinoMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctOrigenDestino->OrigenDestino->Id;
        $_SESSION['TablRefe'] = 'OrigenDestino';
        $_SESSION['RegiReto'] = 'origen_destino_edit.php/'.$this->mctOrigenDestino->OrigenDestino->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/origen_destino_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/origen_destino_edit.php');
    }
