 ...
 */
abstract class AliadoComercialEditFormBase extends QForm {
	// Local instance of the AliadoComercialMetaControl
	/**
	 * @var AliadoComercialMetaControlGen mctAliadoComercial
	 */
	protected $mctAliadoComercial;
	...
	// Controls for AliadoComercial's Data Fields
	protected $lblId;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'AliadoComercial';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctAliadoComercial->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('AliadoComercial'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctAliadoComercial->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctAliadoComercial->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctAliadoComercial->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the AliadoComercialMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the AliadoComercialMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctAliadoComercial->AliadoComercial->Id;
        $_SESSION['TablRefe'] = 'AliadoComercial';
        $_SESSION['RegiReto'] = 'aliado_comercial_edit.php/'.$this->mctAliadoComercial->AliadoComercial->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/aliado_comercial_list.php');
    }
