 ...
 * of the RegiTrabConsecutivo class.  It uses the code-generated
 * RegiTrabConsecutivoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a RegiTrabConsecutivo columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both regi_trab_consecutivo_edit.php AND
 * regi_trab_consecutivo_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class RegiTrabConsecutivoEditFormBase extends QForm {
	// Local instance of the RegiTrabConsecutivoMetaControl
	/**
	 * @var RegiTrabConsecutivoMetaControlGen mctRegiTrabConsecutivo
	 */
	protected $mctRegiTrabConsecutivo;
	...
	// Controls for RegiTrabConsecutivo's Data Fields
	protected $lblId;
	protected $txtNada;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the RegiTrabConsecutivoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctRegiTrabConsecutivo = RegiTrabConsecutivoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on RegiTrabConsecutivo's data fields
		$this->lblId = $this->mctRegiTrabConsecutivo->lblId_Create();
		$this->txtNada = $this->mctRegiTrabConsecutivo->txtNada_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctRegiTrabConsecutivo->RegiTrabConsecutivo && !isset($_SESSION['DataRegiTrabConsecutivo'])) {
            $_SESSION['DataRegiTrabConsecutivo'] = serialize(array($this->mctRegiTrabConsecutivo->RegiTrabConsecutivo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataRegiTrabConsecutivo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctRegiTrabConsecutivo->RegiTrabConsecutivo->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'RegiTrabConsecutivo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctRegiTrabConsecutivo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('RegiTrabConsecutivo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctRegiTrabConsecutivo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('RegiTrabConsecutivo',$this->mctRegiTrabConsecutivo->RegiTrabConsecutivo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctRegiTrabConsecutivo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctRegiTrabConsecutivo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/regi_trab_consecutivo_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctRegiTrabConsecutivo->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the RegiTrabConsecutivoMetaControl
		$this->mctRegiTrabConsecutivo->SaveRegiTrabConsecutivo();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctRegiTrabConsecutivo->TablasRelacionadasRegiTrabConsecutivo();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the RegiTrabConsecutivoMetaControl
			$this->mctRegiTrabConsecutivo->DeleteRegiTrabConsecutivo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctRegiTrabConsecutivo->RegiTrabConsecutivo->Id;
        $_SESSION['TablRefe'] = 'RegiTrabConsecutivo';
        $_SESSION['RegiReto'] = 'regi_trab_consecutivo_edit.php/'.$this->mctRegiTrabConsecutivo->RegiTrabConsecutivo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/regi_trab_consecutivo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/regi_trab_consecutivo_edit.php');
    }
