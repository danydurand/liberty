<?php
	 ...
	 */
	abstract class NewOpcionListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list NewOpcions
		/**
		 * @var NewOpcionDataGrid dtgNewOpcions
		 */
		protected $dtgNewOpcions;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'NewOpcions';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgNewOpcions);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgNewOpcions->ShowFilter = !$this->dtgNewOpcions->ShowFilter;
        }
