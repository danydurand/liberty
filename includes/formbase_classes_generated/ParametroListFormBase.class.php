<?php
	 ...
	 */
	abstract class ParametroListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Parametros
		/**
		 * @var ParametroDataGrid dtgParametros
		 */
		protected $dtgParametros;
		...
		protected function Form_Create() {
			...
			$this->dtgParametros->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
			...
			$this->dtgParametros->MetaAddColumn('DescPara');
			...
			$this->dtgParametros->MetaAddColumn('ParaVal2');
			$this->dtgParametros->MetaAddColumn('ParaVal3');
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgParametros);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgParametros->ShowFilter = !$this->dtgParametros->ShowFilter;
        }
