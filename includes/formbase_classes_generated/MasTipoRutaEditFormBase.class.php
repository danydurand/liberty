 ...
 * of the MasTipoRuta class.  It uses the code-generated
 * MasTipoRutaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a MasTipoRuta columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both mas_tipo_ruta_edit.php AND
 * mas_tipo_ruta_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class MasTipoRutaEditFormBase extends QForm {
	// Local instance of the MasTipoRutaMetaControl
	/**
	 * @var MasTipoRutaMetaControlGen mctMasTipoRuta
	 */
	protected $mctMasTipoRuta;
	...
	// Controls for MasTipoRuta's Data Fields
	protected $txtTipoRuta;
	protected $txtDescTrut;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the MasTipoRutaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctMasTipoRuta = MasTipoRutaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on MasTipoRuta's data fields
		$this->txtTipoRuta = $this->mctMasTipoRuta->txtTipoRuta_Create();
		$this->txtDescTrut = $this->mctMasTipoRuta->txtDescTrut_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctMasTipoRuta->MasTipoRuta && !isset($_SESSION['DataMasTipoRuta'])) {
            $_SESSION['DataMasTipoRuta'] = serialize(array($this->mctMasTipoRuta->MasTipoRuta));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataMasTipoRuta']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctMasTipoRuta->MasTipoRuta->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'MasTipoRuta';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctMasTipoRuta->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('MasTipoRuta'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctMasTipoRuta->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('MasTipoRuta',$this->mctMasTipoRuta->MasTipoRuta->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctMasTipoRuta->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctMasTipoRuta->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objMasTipoRuta = MasTipoRuta::LoadByDescTrut($this->txtDescTrut->Text)) && ($objMasTipoRuta->TipoRuta != $this->mctMasTipoRuta->MasTipoRuta->TipoRuta )){
				$blnToReturn = false;
				$this->txtDescTrut->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/mas_tipo_ruta_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctMasTipoRuta->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the MasTipoRutaMetaControl
		$this->mctMasTipoRuta->SaveMasTipoRuta();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctMasTipoRuta->TablasRelacionadasMasTipoRuta();
		if (count($arrTablRela)) {
			$strTablRela = implode(',',$arrTablRela);
				
			//$this->txtTipoRuta->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the MasTipoRutaMetaControl
			$this->mctMasTipoRuta->DeleteMasTipoRuta();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctMasTipoRuta->MasTipoRuta->Id;
        $_SESSION['TablRefe'] = 'MasTipoRuta';
        $_SESSION['RegiReto'] = 'mas_tipo_ruta_edit.php/'.$this->mctMasTipoRuta->MasTipoRuta->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/mas_tipo_ruta_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/mas_tipo_ruta_edit.php');
    }
