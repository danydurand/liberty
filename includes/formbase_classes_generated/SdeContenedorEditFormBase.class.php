 ...
 */
abstract class SdeContenedorEditFormBase extends QForm {
	// Local instance of the SdeContenedorMetaControl
	/**
	 * @var SdeContenedorMetaControlGen mctSdeContenedor
	 */
	protected $mctSdeContenedor;
	...
	// Controls for SdeContenedor's Data Fields
	...
	protected $dtgParentSdeContenedorsAsSdeContCont;
	protected $dtgSdeContenedorsAsSdeContCont;
	protected $dtgGuias;
	...
	protected function Form_Create() {
		...
		$this->txtHora = $this->mctSdeContenedor->txtHora_Create();
			...
			$this->dtgGuias = $this->mctSdeContenedor->dtgGuias_Create();
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctSdeContenedor->SdeContenedor->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'SdeContenedor';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctSdeContenedor->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('SdeContenedor'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctSdeContenedor->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('SdeContenedor',$this->mctSdeContenedor->SdeContenedor->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctSdeContenedor->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctSdeContenedor->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/sde_contenedor_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the SdeContenedorMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if (count($arrTablRela)) {
			...
			//$this->txtNumeCont->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the SdeContenedorMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctSdeContenedor->SdeContenedor->Id;
        $_SESSION['TablRefe'] = 'SdeContenedor';
        $_SESSION['RegiReto'] = 'sde_contenedor_edit.php/'.$this->mctSdeContenedor->SdeContenedor->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/sde_contenedor_list.php');
    }
