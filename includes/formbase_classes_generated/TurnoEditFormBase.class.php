 ...
 * of the Turno class.  It uses the code-generated
 * TurnoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Turno columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both turno_edit.php AND
 * turno_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class TurnoEditFormBase extends QForm {
	// Local instance of the TurnoMetaControl
	/**
	 * @var TurnoMetaControlGen mctTurno
	 */
	protected $mctTurno;
	...
	// Controls for Turno's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the TurnoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctTurno = TurnoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Turno's data fields
		$this->lblId = $this->mctTurno->lblId_Create();
		$this->txtDescripcion = $this->mctTurno->txtDescripcion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctTurno->Turno && !isset($_SESSION['DataTurno'])) {
            $_SESSION['DataTurno'] = serialize(array($this->mctTurno->Turno));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataTurno']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctTurno->Turno->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTurno->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Turno'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTurno->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Turno',$this->mctTurno->Turno->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTurno->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTurno->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/turno_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TurnoMetaControl
		$this->mctTurno->SaveTurno();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctTurno->TablasRelacionadasTurno();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TurnoMetaControl
			$this->mctTurno->DeleteTurno();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTurno->Turno->Id;
        $_SESSION['TablRefe'] = 'Turno';
        $_SESSION['RegiReto'] = 'turno_edit.php/'.$this->mctTurno->Turno->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/turno_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/turno_edit.php');
    }
