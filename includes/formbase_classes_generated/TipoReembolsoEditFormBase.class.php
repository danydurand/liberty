 ...
 * of the TipoReembolso class.  It uses the code-generated
 * TipoReembolsoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a TipoReembolso columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both tipo_reembolso_edit.php AND
 * tipo_reembolso_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class TipoReembolsoEditFormBase extends QForm {
	// Local instance of the TipoReembolsoMetaControl
	/**
	 * @var TipoReembolsoMetaControlGen mctTipoReembolso
	 */
	protected $mctTipoReembolso;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the TipoReembolsoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctTipoReembolso = TipoReembolsoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on TipoReembolso's data fields
		$this->lblId = $this->mctTipoReembolso->lblId_Create();
		$this->txtCodigo = $this->mctTipoReembolso->txtCodigo_Create();
		$this->txtNombre = $this->mctTipoReembolso->txtNombre_Create();
		$this->chkActivo = $this->mctTipoReembolso->chkActivo_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctTipoReembolso->TipoReembolso && !isset($_SESSION['DataTipoReembolso'])) {
            $_SESSION['DataTipoReembolso'] = serialize(array($this->mctTipoReembolso->TipoReembolso));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataTipoReembolso']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctTipoReembolso->TipoReembolso->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'TipoReembolso';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTipoReembolso->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('TipoReembolso'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTipoReembolso->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('TipoReembolso',$this->mctTipoReembolso->TipoReembolso->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTipoReembolso->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTipoReembolso->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/tipo_reembolso_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctTipoReembolso->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TipoReembolsoMetaControl
		$this->mctTipoReembolso->SaveTipoReembolso();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctTipoReembolso->TablasRelacionadasTipoReembolso();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TipoReembolsoMetaControl
			$this->mctTipoReembolso->DeleteTipoReembolso();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTipoReembolso->TipoReembolso->Id;
        $_SESSION['TablRefe'] = 'TipoReembolso';
        $_SESSION['RegiReto'] = 'tipo_reembolso_edit.php/'.$this->mctTipoReembolso->TipoReembolso->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tipo_reembolso_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/tipo_reembolso_edit.php');
    }
