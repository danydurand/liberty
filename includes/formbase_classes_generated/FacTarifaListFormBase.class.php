<?php
	 ...
	 */
	abstract class FacTarifaListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list FacTarifas
		/**
		 * @var FacTarifaDataGrid dtgFacTarifas
		 */
		protected $dtgFacTarifas;
		...
		protected function Form_Create() {
			...
			$this->dtgFacTarifas->MetaAddColumn('PorcentajeSobreValor');
			$this->dtgFacTarifas->MetaAddColumn('VolumenParaDscto');
			$this->dtgFacTarifas->MetaAddColumn('DsctoPorVolumen');
			$this->dtgFacTarifas->MetaAddColumn('PesoParaDscto');
			$this->dtgFacTarifas->MetaAddColumn('DsctoPorPeso');
			$this->dtgFacTarifas->MetaAddColumn('MontoMinimo');
			$this->dtgFacTarifas->MetaAddColumn('CostoParadaAdicional');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'FacTarifas';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgFacTarifas);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgFacTarifas->ShowFilter = !$this->dtgFacTarifas->ShowFilter;
        }
