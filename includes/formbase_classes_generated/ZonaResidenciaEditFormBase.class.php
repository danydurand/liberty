 ...
 * of the ZonaResidencia class.  It uses the code-generated
 * ZonaResidenciaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ZonaResidencia columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both zona_residencia_edit.php AND
 * zona_residencia_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ZonaResidenciaEditFormBase extends QForm {
	// Local instance of the ZonaResidenciaMetaControl
	/**
	 * @var ZonaResidenciaMetaControlGen mctZonaResidencia
	 */
	protected $mctZonaResidencia;
	...
	// Controls for ZonaResidencia's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $lstCiudad;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ZonaResidenciaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctZonaResidencia = ZonaResidenciaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ZonaResidencia's data fields
		$this->lblId = $this->mctZonaResidencia->lblId_Create();
		$this->txtNombre = $this->mctZonaResidencia->txtNombre_Create();
		$this->lstCiudad = $this->mctZonaResidencia->lstCiudad_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctZonaResidencia->ZonaResidencia && !isset($_SESSION['DataZonaResidencia'])) {
            $_SESSION['DataZonaResidencia'] = serialize(array($this->mctZonaResidencia->ZonaResidencia));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataZonaResidencia']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctZonaResidencia->ZonaResidencia->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ZonaResidencia';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctZonaResidencia->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ZonaResidencia'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctZonaResidencia->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ZonaResidencia',$this->mctZonaResidencia->ZonaResidencia->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctZonaResidencia->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctZonaResidencia->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/zona_residencia_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctZonaResidencia->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ZonaResidenciaMetaControl
		$this->mctZonaResidencia->SaveZonaResidencia();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctZonaResidencia->TablasRelacionadasZonaResidencia();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ZonaResidenciaMetaControl
			$this->mctZonaResidencia->DeleteZonaResidencia();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctZonaResidencia->ZonaResidencia->Id;
        $_SESSION['TablRefe'] = 'ZonaResidencia';
        $_SESSION['RegiReto'] = 'zona_residencia_edit.php/'.$this->mctZonaResidencia->ZonaResidencia->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/zona_residencia_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/zona_residencia_edit.php');
    }
