<?php
	 ...
	 */
	abstract class FacTarifaPesoListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list FacTarifaPesos
		/**
		 * @var FacTarifaPesoDataGrid dtgFacTarifaPesos
		 */
		protected $dtgFacTarifaPesos;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'FacTarifaPesos';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgFacTarifaPesos);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgFacTarifaPesos->ShowFilter = !$this->dtgFacTarifaPesos->ShowFilter;
        }
