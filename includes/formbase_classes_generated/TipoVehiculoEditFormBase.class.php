 ...
 */
abstract class TipoVehiculoEditFormBase extends QForm {
	// Local instance of the TipoVehiculoMetaControl
	/**
	 * @var TipoVehiculoMetaControlGen mctTipoVehiculo
	 */
	protected $mctTipoVehiculo;
	...
	// Controls for TipoVehiculo's Data Fields
	protected $txtTipoVehi;
	protected $txtDescTipo;
	protected $txtCapacidadMaxima;
	protected $txtCostoKm;
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctTipoVehiculo->TipoVehiculo->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'TipoVehiculo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTipoVehiculo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('TipoVehiculo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTipoVehiculo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('TipoVehiculo',$this->mctTipoVehiculo->TipoVehiculo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTipoVehiculo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTipoVehiculo->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TipoVehiculoMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if (count($arrTablRela)) {
			...
			//$this->txtTipoVehi->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TipoVehiculoMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTipoVehiculo->TipoVehiculo->Id;
        $_SESSION['TablRefe'] = 'TipoVehiculo';
        $_SESSION['RegiReto'] = 'tipo_vehiculo_edit.php/'.$this->mctTipoVehiculo->TipoVehiculo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tipo_vehiculo_list.php');
    }
