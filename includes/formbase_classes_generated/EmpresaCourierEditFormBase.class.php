 ...
 */
abstract class EmpresaCourierEditFormBase extends QForm {
	// Local instance of the EmpresaCourierMetaControl
	/**
	 * @var EmpresaCourierMetaControlGen mctEmpresaCourier
	 */
	protected $mctEmpresaCourier;
	...
	// Controls for EmpresaCourier's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $txtCantidadCaracteres;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'EmpresaCourier';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctEmpresaCourier->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('EmpresaCourier'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctEmpresaCourier->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctEmpresaCourier->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctEmpresaCourier->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the EmpresaCourierMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the EmpresaCourierMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctEmpresaCourier->EmpresaCourier->Id;
        $_SESSION['TablRefe'] = 'EmpresaCourier';
        $_SESSION['RegiReto'] = 'empresa_courier_edit.php/'.$this->mctEmpresaCourier->EmpresaCourier->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/empresa_courier_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/empresa_courier_edit.php');
    }
