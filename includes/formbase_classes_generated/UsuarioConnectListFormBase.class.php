<?php
	 ...
	 */
	abstract class UsuarioConnectListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list UsuarioConnects
		/**
		 * @var UsuarioConnectDataGrid dtgUsuarioConnects
		 */
		protected $dtgUsuarioConnects;
		...
		protected function Form_Create() {
			...
			$this->dtgUsuarioConnects->MetaAddColumn(QQN::UsuarioConnect()->Cliente);
			$this->dtgUsuarioConnects->MetaAddColumn('Nombre');
			$this->dtgUsuarioConnects->MetaAddColumn('Direccion');
			$this->dtgUsuarioConnects->MetaAddColumn('Email');
			$this->dtgUsuarioConnects->MetaAddColumn('Telefono');
			$this->dtgUsuarioConnects->MetaAddColumn('LogiUsua');
			$this->dtgUsuarioConnects->MetaAddColumn('ClaveAcceso');
			$this->dtgUsuarioConnects->MetaAddColumn(QQN::UsuarioConnect()->Sucursal);
			$this->dtgUsuarioConnects->MetaAddTypeColumn('StatusId', 'StatusType');
			$this->dtgUsuarioConnects->MetaAddColumn('FechaRegistro');
			$this->dtgUsuarioConnects->MetaAddColumn('CodigoPostal');
			$this->dtgUsuarioConnects->MetaAddColumn('FechaAcceso');
			$this->dtgUsuarioConnects->MetaAddColumn('CantidadIntentos');
			$this->dtgUsuarioConnects->MetaAddColumn('MotivoBloqueo');
			$this->dtgUsuarioConnects->MetaAddColumn('DeletedAt');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'UsuarioConnects';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgUsuarioConnects);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgUsuarioConnects->ShowFilter = !$this->dtgUsuarioConnects->ShowFilter;
        }
