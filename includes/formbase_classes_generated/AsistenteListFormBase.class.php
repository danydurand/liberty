<?php
	 ...
	 */
	abstract class AsistenteListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Asistentes
		/**
		 * @var AsistenteDataGrid dtgAsistentes
		 */
		protected $dtgAsistentes;
		...
		protected function Form_Create() {
			...
			$this->dtgAsistentes->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
			...
			$this->dtgAsistentes->MetaAddColumn('CodiAsis');
			$this->dtgAsistentes->MetaAddColumn('NombAsis');
			$this->dtgAsistentes->MetaAddColumn('ApelAsis');
			$this->dtgAsistentes->MetaAddColumn('NumeCedu');
			$this->dtgAsistentes->MetaAddColumn('NumeTele');
			$this->dtgAsistentes->MetaAddColumn('TextObse');
			$this->dtgAsistentes->MetaAddColumn(QQN::Asistente()->CodiEstaObject);
			$this->dtgAsistentes->MetaAddTypeColumn('CodiDisp', 'DisponibleType');
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgAsistentes);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgAsistentes->ShowFilter = !$this->dtgAsistentes->ShowFilter;
        }

		public function dtgAsistentesRow_Click($strFormId, $strControlId, $strParameter) {
		  $intId = intval($strParameter);
		  QApplication::Redirect("asistente_edit.php/$intId");
		}
