 ...
 * of the FacPeriFact class.  It uses the code-generated
 * FacPeriFactMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacPeriFact columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both fac_peri_fact_edit.php AND
 * fac_peri_fact_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacPeriFactEditFormBase extends QForm {
	// Local instance of the FacPeriFactMetaControl
	/**
	 * @var FacPeriFactMetaControlGen mctFacPeriFact
	 */
	protected $mctFacPeriFact;
	...
	// Controls for FacPeriFact's Data Fields
	protected $lblCodiRegi;
	protected $lstTipoCortObject;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacPeriFactMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacPeriFact = FacPeriFactMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacPeriFact's data fields
		$this->lblCodiRegi = $this->mctFacPeriFact->lblCodiRegi_Create();
		$this->lstTipoCortObject = $this->mctFacPeriFact->lstTipoCortObject_Create();
		$this->calFechInic = $this->mctFacPeriFact->calFechInic_Create();
		$this->calFechFina = $this->mctFacPeriFact->calFechFina_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacPeriFact->FacPeriFact && !isset($_SESSION['DataFacPeriFact'])) {
            $_SESSION['DataFacPeriFact'] = serialize(array($this->mctFacPeriFact->FacPeriFact));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacPeriFact']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacPeriFact->FacPeriFact->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacPeriFact';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacPeriFact->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacPeriFact'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacPeriFact->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacPeriFact',$this->mctFacPeriFact->FacPeriFact->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacPeriFact->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacPeriFact->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/fac_peri_fact_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacPeriFact->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacPeriFactMetaControl
		$this->mctFacPeriFact->SaveFacPeriFact();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacPeriFact->TablasRelacionadasFacPeriFact();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacPeriFactMetaControl
			$this->mctFacPeriFact->DeleteFacPeriFact();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacPeriFact->FacPeriFact->Id;
        $_SESSION['TablRefe'] = 'FacPeriFact';
        $_SESSION['RegiReto'] = 'fac_peri_fact_edit.php/'.$this->mctFacPeriFact->FacPeriFact->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/fac_peri_fact_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/fac_peri_fact_edit.php');
    }
