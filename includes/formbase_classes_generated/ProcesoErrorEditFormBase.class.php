 ...
 */
abstract class ProcesoErrorEditFormBase extends QForm {
	// Local instance of the ProcesoErrorMetaControl
	/**
	 * @var ProcesoErrorMetaControlGen mctProcesoError
	 */
	protected $mctProcesoError;
	...
	// Controls for ProcesoError's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $txtUsuario;
	protected $calFecha;
	protected $calHoraInicial;
	protected $calHoraFinal;
	protected $txtComentario;
	protected $chkNotificarAdmin;
	protected $chkNotificarUsuario;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ProcesoError';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctProcesoError->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ProcesoError'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctProcesoError->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctProcesoError->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctProcesoError->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ProcesoErrorMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ProcesoErrorMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctProcesoError->ProcesoError->Id;
        $_SESSION['TablRefe'] = 'ProcesoError';
        $_SESSION['RegiReto'] = 'proceso_error_edit.php/'.$this->mctProcesoError->ProcesoError->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/proceso_error_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/proceso_error_edit.php');
    }
