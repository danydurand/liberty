 ...
 */
abstract class IncidenciaEditFormBase extends QForm {
	// Local instance of the IncidenciaMetaControl
	/**
	 * @var IncidenciaMetaControlGen mctIncidencia
	 */
	protected $mctIncidencia;
	...
	// Controls for Incidencia's Data Fields
	protected $lblId;
	protected $txtCodigo;
	protected $txtNumero;
	protected $calFechaRegistro;
	protected $calFechaIncidencia;
	...
	protected $lstTipoReembolso;
	protected $txtEstatus;
	protected $txtContenidoEntregado;
	protected $txtContenidoEsperado;
	protected $txtMontoPagado;
	protected $txtNroFactura;
	protected $txtNombreTitular;
	protected $txtCedula;
	protected $txtEmail;
	protected $txtTipoCuenta;
	protected $txtNroCuenta;
	protected $txtBanco;
	protected $calFechaPago;
	protected $txtFormaPago;
	protected $txtNroReferencia;
	...
	protected function Form_Create() {
		...
		$this->txtCodigo = $this->mctIncidencia->txtCodigo_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctIncidencia->Incidencia && !isset($_SESSION['DataIncidencia'])) {
            $_SESSION['DataIncidencia'] = serialize(array($this->mctIncidencia->Incidencia));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataIncidencia']);
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Incidencia';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctIncidencia->EditMode;
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctIncidencia->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctIncidencia->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/incidencia_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the IncidenciaMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctIncidencia->TablasRelacionadasIncidencia();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the IncidenciaMetaControl
			$this->mctIncidencia->DeleteIncidencia();
			$this->RedirectToListPage();
		}
	}
    ...
    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/incidencia_list.php');
    }
