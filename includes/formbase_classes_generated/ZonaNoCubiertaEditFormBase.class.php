 ...
 * of the ZonaNoCubierta class.  It uses the code-generated
 * ZonaNoCubiertaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ZonaNoCubierta columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both zona_no_cubierta_edit.php AND
 * zona_no_cubierta_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ZonaNoCubiertaEditFormBase extends QForm {
	// Local instance of the ZonaNoCubiertaMetaControl
	/**
	 * @var ZonaNoCubiertaMetaControlGen mctZonaNoCubierta
	 */
	protected $mctZonaNoCubierta;
	...
	// Controls for ZonaNoCubierta's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ZonaNoCubiertaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctZonaNoCubierta = ZonaNoCubiertaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ZonaNoCubierta's data fields
		$this->lblId = $this->mctZonaNoCubierta->lblId_Create();
		$this->lstCodiEstaObject = $this->mctZonaNoCubierta->lstCodiEstaObject_Create();
		$this->txtDescripcion = $this->mctZonaNoCubierta->txtDescripcion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctZonaNoCubierta->ZonaNoCubierta && !isset($_SESSION['DataZonaNoCubierta'])) {
            $_SESSION['DataZonaNoCubierta'] = serialize(array($this->mctZonaNoCubierta->ZonaNoCubierta));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataZonaNoCubierta']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctZonaNoCubierta->ZonaNoCubierta->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ZonaNoCubierta';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctZonaNoCubierta->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ZonaNoCubierta'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctZonaNoCubierta->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ZonaNoCubierta',$this->mctZonaNoCubierta->ZonaNoCubierta->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctZonaNoCubierta->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctZonaNoCubierta->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/zona_no_cubierta_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctZonaNoCubierta->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ZonaNoCubiertaMetaControl
		$this->mctZonaNoCubierta->SaveZonaNoCubierta();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctZonaNoCubierta->TablasRelacionadasZonaNoCubierta();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ZonaNoCubiertaMetaControl
			$this->mctZonaNoCubierta->DeleteZonaNoCubierta();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctZonaNoCubierta->ZonaNoCubierta->Id;
        $_SESSION['TablRefe'] = 'ZonaNoCubierta';
        $_SESSION['RegiReto'] = 'zona_no_cubierta_edit.php/'.$this->mctZonaNoCubierta->ZonaNoCubierta->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/zona_no_cubierta_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/zona_no_cubierta_edit.php');
    }
