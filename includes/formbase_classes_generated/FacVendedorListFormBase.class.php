<?php
	 ...
	 */
	abstract class FacVendedorListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list FacVendedors
		/**
		 * @var FacVendedorDataGrid dtgFacVendedors
		 */
		protected $dtgFacVendedors;
		...
		protected function Form_Create() {
			...
			$this->dtgFacVendedors->MetaAddColumn('Cedula');
			$this->dtgFacVendedors->MetaAddColumn('DireccionEmail');
			$this->dtgFacVendedors->MetaAddColumn('PorcentajeComision');
			$this->dtgFacVendedors->MetaAddColumn('FechaRegistro');
			$this->dtgFacVendedors->MetaAddColumn(QQN::FacVendedor()->Pais);
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'FacVendedors';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgFacVendedors);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgFacVendedors->ShowFilter = !$this->dtgFacVendedors->ShowFilter;
        }
