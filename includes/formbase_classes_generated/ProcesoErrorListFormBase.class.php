<?php
	 ...
	 */
	abstract class ProcesoErrorListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list ProcesoErrors
		/**
		 * @var ProcesoErrorDataGrid dtgProcesoErrors
		 */
		protected $dtgProcesoErrors;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'ProcesoErrors';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgProcesoErrors);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgProcesoErrors->ShowFilter = !$this->dtgProcesoErrors->ShowFilter;
        }
