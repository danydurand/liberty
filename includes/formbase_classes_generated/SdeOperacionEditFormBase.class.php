 ...
 */
abstract class SdeOperacionEditFormBase extends QForm {
	// Local instance of the SdeOperacionMetaControl
	/**
	 * @var SdeOperacionMetaControlGen mctSdeOperacion
	 */
	protected $mctSdeOperacion;
	...
	// Controls for SdeOperacion's Data Fields
	protected $lblCodiOper;
	protected $lstCodiRutaObject;
	protected $lstCodiChofObject;
	protected $lstCodiVehiObject;
	...
	protected function Form_Create() {
		...
		$this->lstCodiRutaObject = $this->mctSdeOperacion->lstCodiRutaObject_Create();
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctSdeOperacion->SdeOperacion->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'SdeOperacion';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctSdeOperacion->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('SdeOperacion'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctSdeOperacion->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('SdeOperacion',$this->mctSdeOperacion->SdeOperacion->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctSdeOperacion->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctSdeOperacion->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the SdeOperacionMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if (count($arrTablRela)) {
			...
			//$this->lblCodiOper->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the SdeOperacionMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctSdeOperacion->SdeOperacion->Id;
        $_SESSION['TablRefe'] = 'SdeOperacion';
        $_SESSION['RegiReto'] = 'sde_operacion_edit.php/'.$this->mctSdeOperacion->SdeOperacion->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/sde_operacion_list.php');
    }
