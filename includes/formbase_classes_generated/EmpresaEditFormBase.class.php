 ...
 */
abstract class EmpresaEditFormBase extends QForm {
	// Local instance of the EmpresaMetaControl
	/**
	 * @var EmpresaMetaControlGen mctEmpresa
	 */
	...
	protected $txtTelefonos;
	protected $txtEmail;
	protected $txtPersonaContacto;
	protected $txtClaveSecreta;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the EmpresaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctEmpresa = EmpresaMetaControl::CreateFromPathInfo($this);
		...
		$this->txtId = $this->mctEmpresa->txtId_Create();
		$this->txtNombre = $this->mctEmpresa->txtNombre_Create();
		$this->txtDireccionFiscal = $this->mctEmpresa->txtDireccionFiscal_Create();
		$this->txtTelefonos = $this->mctEmpresa->txtTelefonos_Create();
		$this->txtEmail = $this->mctEmpresa->txtEmail_Create();
		$this->txtPersonaContacto = $this->mctEmpresa->txtPersonaContacto_Create();
		$this->txtClaveSecreta = $this->mctEmpresa->txtClaveSecreta_Create();
		$this->calFechaRegistro = $this->mctEmpresa->calFechaRegistro_Create();
		$this->lstVendedor = $this->mctEmpresa->lstVendedor_Create();
		$this->lstPais = $this->mctEmpresa->lstPais_Create();
		$this->lstStatus = $this->mctEmpresa->lstStatus_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctEmpresa->Empresa && !isset($_SESSION['DataEmpresa'])) {
            $_SESSION['DataEmpresa'] = serialize(array($this->mctEmpresa->Empresa));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataEmpresa']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctEmpresa->Empresa->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctEmpresa->EditMode;
    }
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Empresa',$this->mctEmpresa->Empresa->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctEmpresa->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctEmpresa->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/empresa_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctEmpresa->TablasRelacionadasEmpresa();
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctEmpresa->Empresa->Id;
        $_SESSION['TablRefe'] = 'Empresa';
        $_SESSION['RegiReto'] = 'empresa_edit.php/'.$this->mctEmpresa->Empresa->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/empresa_list.php');
    }
