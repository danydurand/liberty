 ...
 */
abstract class GuiaCacesaEditFormBase extends QForm {
	// Local instance of the GuiaCacesaMetaControl
	/**
	 * @var GuiaCacesaMetaControlGen mctGuiaCacesa
	 */
	protected $mctGuiaCacesa;
	...
	// Controls for GuiaCacesa's Data Fields
	protected $lblId;
	...
	protected $txtOrigGuia;
	protected $txtDestGuia;
	...
	protected $calHoraProc;
	protected $chkAjustar;
	protected $txtOtroDestino;
	...
	protected function Form_Create() {
		...
		$this->lblId = $this->mctGuiaCacesa->lblId_Create();
		$this->calFechCarg = $this->mctGuiaCacesa->calFechCarg_Create();
		$this->calHoraCarg = $this->mctGuiaCacesa->calHoraCarg_Create();
		$this->chkProcesada = $this->mctGuiaCacesa->chkProcesada_Create();
		$this->txtNumeGuia = $this->mctGuiaCacesa->txtNumeGuia_Create();
		$this->txtGuiaExte = $this->mctGuiaCacesa->txtGuiaExte_Create();
		$this->txtOrigGuia = $this->mctGuiaCacesa->txtOrigGuia_Create();
		$this->txtDestGuia = $this->mctGuiaCacesa->txtDestGuia_Create();
		$this->txtNombRemi = $this->mctGuiaCacesa->txtNombRemi_Create();
		$this->txtDireRemi = $this->mctGuiaCacesa->txtDireRemi_Create();
		$this->txtTeleRemi = $this->mctGuiaCacesa->txtTeleRemi_Create();
		...
		$this->txtCeluDest = $this->mctGuiaCacesa->txtCeluDest_Create();
		...
		$this->calFechProc = $this->mctGuiaCacesa->calFechProc_Create();
		$this->calHoraProc = $this->mctGuiaCacesa->calHoraProc_Create();
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaCacesa';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaCacesa->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaCacesa'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaCacesa->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaCacesa->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaCacesa->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaCacesaMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaCacesaMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaCacesa->GuiaCacesa->Id;
        $_SESSION['TablRefe'] = 'GuiaCacesa';
        $_SESSION['RegiReto'] = 'guia_cacesa_edit.php/'.$this->mctGuiaCacesa->GuiaCacesa->Id;
