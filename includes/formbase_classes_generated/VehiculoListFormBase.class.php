<?php
	 ...
	 */
	abstract class VehiculoListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Vehiculos
		/**
		 * @var VehiculoDataGrid dtgVehiculos
		 */
		protected $dtgVehiculos;
		...
		protected function Form_Create() {
			...
			$this->dtgVehiculos->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
			...
			$this->dtgVehiculos->MetaAddColumn('CodiVehi');
			$this->dtgVehiculos->MetaAddColumn('DescVehi');
			$this->dtgVehiculos->MetaAddColumn('NumePlac');
			$this->dtgVehiculos->MetaAddColumn('TextObse');
			$this->dtgVehiculos->MetaAddColumn(QQN::Vehiculo()->CodiEstaObject);
			$this->dtgVehiculos->MetaAddColumn(QQN::Vehiculo()->TipoVehiObject);
			$this->dtgVehiculos->MetaAddTypeColumn('CodiDisp', 'DisponibleType');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'Vehiculos';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgVehiculos);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgVehiculos->ShowFilter = !$this->dtgVehiculos->ShowFilter;
        }

		public function dtgVehiculosRow_Click($strFormId, $strControlId, $strParameter) {
		  $intId = intval($strParameter);
		  QApplication::Redirect("vehiculo_edit.php/$intId");
		}
