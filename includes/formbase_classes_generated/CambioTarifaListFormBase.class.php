<?php
	 ...
	 */
	abstract class CambioTarifaListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list CambioTarifas
		/**
		 * @var CambioTarifaDataGrid dtgCambioTarifas
		 */
		protected $dtgCambioTarifas;
		...
		protected function Form_Create() {
			...
			$this->dtgCambioTarifas->MetaAddColumn('Comentario');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'CambioTarifas';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgCambioTarifas);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgCambioTarifas->ShowFilter = !$this->dtgCambioTarifas->ShowFilter;
        }
