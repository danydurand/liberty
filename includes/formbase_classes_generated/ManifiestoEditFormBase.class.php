 ...
 * of the Manifiesto class.  It uses the code-generated
 * ManifiestoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Manifiesto columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both manifiesto_edit.php AND
 * manifiesto_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ManifiestoEditFormBase extends QForm {
	// Local instance of the ManifiestoMetaControl
	/**
	 * @var ManifiestoMetaControlGen mctManifiesto
	 */
	protected $mctManifiesto;
	...
	// Controls for Manifiesto's Data Fields
	protected $txtId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ManifiestoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctManifiesto = ManifiestoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Manifiesto's data fields
		$this->txtId = $this->mctManifiesto->txtId_Create();
		$this->lstProducto = $this->mctManifiesto->lstProducto_Create();
		$this->calFecha = $this->mctManifiesto->calFecha_Create();
		$this->txtMontoFlete = $this->mctManifiesto->txtMontoFlete_Create();
			$this->dtgGuiasAsMani = $this->mctManifiesto->dtgGuiasAsMani_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctManifiesto->Manifiesto && !isset($_SESSION['DataManifiesto'])) {
            $_SESSION['DataManifiesto'] = serialize(array($this->mctManifiesto->Manifiesto));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataManifiesto']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctManifiesto->Manifiesto->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctManifiesto->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Manifiesto'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctManifiesto->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Manifiesto',$this->mctManifiesto->Manifiesto->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctManifiesto->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctManifiesto->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/manifiesto_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctManifiesto->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ManifiestoMetaControl
		$this->mctManifiesto->SaveManifiesto();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctManifiesto->TablasRelacionadasManifiesto();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ManifiestoMetaControl
			$this->mctManifiesto->DeleteManifiesto();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctManifiesto->Manifiesto->Id;
        $_SESSION['TablRefe'] = 'Manifiesto';
        $_SESSION['RegiReto'] = 'manifiesto_edit.php/'.$this->mctManifiesto->Manifiesto->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/manifiesto_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/manifiesto_edit.php');
    }
