 ...
 */
abstract class UsuarioEditFormBase extends QForm {
	// Local instance of the UsuarioMetaControl
	/**
	 * @var UsuarioMetaControlGen mctUsuario
	 */
	...
	protected $lblCodiUsua;
	protected $lstCodiGrupObject;
	protected $txtNombUsua;
	protected $txtApelUsua;
	protected $txtLogiUsua;
	protected $txtPassUsua;
	protected $lstCodiStatObject;
	protected $lstCodiEstaObject;
	protected $lstTipoUsuaObject;
	protected $txtCantInte;
	protected $txtMailUsua;
	protected $calFechAcce;
	protected $txtMotiBloq;
	protected $calFechClav;
	protected $txtCargUsua;
	protected $chkSupervisor;
	protected $lstGrupo;
	...
	protected function Form_Create() {
		...
		$this->lstCodiEstaObject = $this->mctUsuario->lstCodiEstaObject_Create();
		...
		$this->calDeleteAt = $this->mctUsuario->calDeleteAt_Create();
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctUsuario->Usuario->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctUsuario->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Usuario'))));
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Usuario',$this->mctUsuario->Usuario->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctUsuario->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctUsuario->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objUsuario = Usuario::LoadByLogiUsua($this->txtLogiUsua->Text)) && ($objUsuario->CodiUsua != $this->mctUsuario->Usuario->CodiUsua )){
				$blnToReturn = false;
				$this->txtLogiUsua->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/usuario_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctUsuario->Usuario->Id;
        $_SESSION['TablRefe'] = 'Usuario';
        $_SESSION['RegiReto'] = 'usuario_edit.php/'.$this->mctUsuario->Usuario->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/usuario_list.php');
    }
