 ...
 * of the PilaAcceso class.  It uses the code-generated
 * PilaAccesoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a PilaAcceso columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both pila_acceso_edit.php AND
 * pila_acceso_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PilaAccesoEditFormBase extends QForm {
	// Local instance of the PilaAccesoMetaControl
	/**
	 * @var PilaAccesoMetaControlGen mctPilaAcceso
	 */
	protected $mctPilaAcceso;
	...
	// Controls for PilaAcceso's Data Fields
	protected $lblId;
	protected $txtLogin;
	protected $calFecha;
	protected $txtPrograma;
	protected $calHora;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PilaAccesoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPilaAcceso = PilaAccesoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on PilaAcceso's data fields
		$this->lblId = $this->mctPilaAcceso->lblId_Create();
		$this->txtLogin = $this->mctPilaAcceso->txtLogin_Create();
		$this->calFecha = $this->mctPilaAcceso->calFecha_Create();
		$this->txtPrograma = $this->mctPilaAcceso->txtPrograma_Create();
		$this->calHora = $this->mctPilaAcceso->calHora_Create();
		$this->txtParametros = $this->mctPilaAcceso->txtParametros_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPilaAcceso->PilaAcceso && !isset($_SESSION['DataPilaAcceso'])) {
            $_SESSION['DataPilaAcceso'] = serialize(array($this->mctPilaAcceso->PilaAcceso));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPilaAcceso']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPilaAcceso->PilaAcceso->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PilaAcceso';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPilaAcceso->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PilaAcceso'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPilaAcceso->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('PilaAcceso',$this->mctPilaAcceso->PilaAcceso->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPilaAcceso->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPilaAcceso->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/pila_acceso_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctPilaAcceso->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PilaAccesoMetaControl
		$this->mctPilaAcceso->SavePilaAcceso();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPilaAcceso->TablasRelacionadasPilaAcceso();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PilaAccesoMetaControl
			$this->mctPilaAcceso->DeletePilaAcceso();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPilaAcceso->PilaAcceso->Id;
        $_SESSION['TablRefe'] = 'PilaAcceso';
        $_SESSION['RegiReto'] = 'pila_acceso_edit.php/'.$this->mctPilaAcceso->PilaAcceso->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/pila_acceso_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/pila_acceso_edit.php');
    }
