 ...
 * of the DspMotivoNoco class.  It uses the code-generated
 * DspMotivoNocoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a DspMotivoNoco columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both dsp_motivo_noco_edit.php AND
 * dsp_motivo_noco_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class DspMotivoNocoEditFormBase extends QForm {
	// Local instance of the DspMotivoNocoMetaControl
	/**
	 * @var DspMotivoNocoMetaControlGen mctDspMotivoNoco
	 */
	protected $mctDspMotivoNoco;
	...
	// Controls for DspMotivoNoco's Data Fields
	protected $txtMotiNoco;
	protected $txtDescMoti;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the DspMotivoNocoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctDspMotivoNoco = DspMotivoNocoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on DspMotivoNoco's data fields
		$this->txtMotiNoco = $this->mctDspMotivoNoco->txtMotiNoco_Create();
		$this->txtDescMoti = $this->mctDspMotivoNoco->txtDescMoti_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctDspMotivoNoco->DspMotivoNoco && !isset($_SESSION['DataDspMotivoNoco'])) {
            $_SESSION['DataDspMotivoNoco'] = serialize(array($this->mctDspMotivoNoco->DspMotivoNoco));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataDspMotivoNoco']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctDspMotivoNoco->DspMotivoNoco->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'DspMotivoNoco';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctDspMotivoNoco->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('DspMotivoNoco'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctDspMotivoNoco->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('DspMotivoNoco',$this->mctDspMotivoNoco->DspMotivoNoco->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctDspMotivoNoco->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctDspMotivoNoco->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/dsp_motivo_noco_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctDspMotivoNoco->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the DspMotivoNocoMetaControl
		$this->mctDspMotivoNoco->SaveDspMotivoNoco();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctDspMotivoNoco->TablasRelacionadasDspMotivoNoco();
		if (count($arrTablRela)) {
			$strTablRela = implode(',',$arrTablRela);
				
			//$this->txtMotiNoco->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the DspMotivoNocoMetaControl
			$this->mctDspMotivoNoco->DeleteDspMotivoNoco();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctDspMotivoNoco->DspMotivoNoco->Id;
        $_SESSION['TablRefe'] = 'DspMotivoNoco';
        $_SESSION['RegiReto'] = 'dsp_motivo_noco_edit.php/'.$this->mctDspMotivoNoco->DspMotivoNoco->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/dsp_motivo_noco_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/dsp_motivo_noco_edit.php');
    }
