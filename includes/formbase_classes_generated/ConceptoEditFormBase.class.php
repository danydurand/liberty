 ...
 * of the Concepto class.  It uses the code-generated
 * ConceptoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Concepto columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both concepto_edit.php AND
 * concepto_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ConceptoEditFormBase extends QForm {
	// Local instance of the ConceptoMetaControl
	/**
	 * @var ConceptoMetaControlGen mctConcepto
	 */
	protected $mctConcepto;
	...
	// Controls for Concepto's Data Fields
	protected $lblId;
	protected $txtDescripcion;
	protected $lstOperacion;
	protected $lstModo;
	protected $txtMontoPorcentaje;
	protected $lstStatus;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ConceptoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctConcepto = ConceptoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Concepto's data fields
		$this->lblId = $this->mctConcepto->lblId_Create();
		$this->txtDescripcion = $this->mctConcepto->txtDescripcion_Create();
		$this->lstOperacion = $this->mctConcepto->lstOperacion_Create();
		$this->lstModo = $this->mctConcepto->lstModo_Create();
		$this->txtMontoPorcentaje = $this->mctConcepto->txtMontoPorcentaje_Create();
		$this->lstStatus = $this->mctConcepto->lstStatus_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctConcepto->Concepto && !isset($_SESSION['DataConcepto'])) {
            $_SESSION['DataConcepto'] = serialize(array($this->mctConcepto->Concepto));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataConcepto']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctConcepto->Concepto->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Concepto';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctConcepto->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Concepto'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctConcepto->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Concepto',$this->mctConcepto->Concepto->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctConcepto->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctConcepto->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/concepto_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ConceptoMetaControl
		$this->mctConcepto->SaveConcepto();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctConcepto->TablasRelacionadasConcepto();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ConceptoMetaControl
			$this->mctConcepto->DeleteConcepto();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctConcepto->Concepto->Id;
        $_SESSION['TablRefe'] = 'Concepto';
        $_SESSION['RegiReto'] = 'concepto_edit.php/'.$this->mctConcepto->Concepto->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/concepto_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/concepto_edit.php');
    }
