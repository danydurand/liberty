<?php
	 ...
	 */
	abstract class OpcionListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Opcions
		/**
		 * @var OpcionDataGrid dtgOpcions
		 */
		protected $dtgOpcions;
		...
		protected function Form_Create() {
			...
			$this->dtgOpcions->ShowFilter = false;

			// Add Pagination (if desired)
			$this->dtgOpcions->Paginator = new QPaginator($this->dtgOpcions);
			$this->dtgOpcions->ItemsPerPage = __FORM_DRAFTS_FORM_LIST_ITEMS_PER_PAGE__;
			...
			$this->dtgOpcions->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
			...
			$this->dtgOpcions->MetaAddColumn('CodiOpci');
			$this->dtgOpcions->MetaAddColumn(QQN::Opcion()->CodiSistObject);
			$this->dtgOpcions->MetaAddColumn('DescOpci');
			$this->dtgOpcions->MetaAddTypeColumn('CodiTipo', 'TipoOpciType');
			$this->dtgOpcions->MetaAddColumn('NombProg');
			$this->dtgOpcions->MetaAddColumn('NumeDepe');
			$this->dtgOpcions->MetaAddColumn('ImagOpci');
			$this->dtgOpcions->MetaAddColumn('AnchImag');
			$this->dtgOpcions->MetaAddColumn('AltoImag');
			$this->dtgOpcions->MetaAddTypeColumn('CodiStat', 'StatusType');
			$this->dtgOpcions->MetaAddColumn('TextObse');
			$this->dtgOpcions->MetaAddColumn('PosiOpci');
			$this->dtgOpcions->MetaAddColumn('PathOpci');
			$this->dtgOpcions->MetaAddColumn('NombreClase');
			$this->dtgOpcions->MetaAddColumn('Nivel');
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgOpcions);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgOpcions->ShowFilter = !$this->dtgOpcions->ShowFilter;
        }
