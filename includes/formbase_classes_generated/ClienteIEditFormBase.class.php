 ...
 * ClienteIMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ClienteI columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both cliente_i_edit.php AND
 * cliente_i_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ClienteIEditFormBase extends QForm {
	// Local instance of the ClienteIMetaControl
	/**
	 * @var ClienteIMetaControlGen mctClienteI
	 */
	protected $mctClienteI;
	...
	// Controls for ClienteI's Data Fields
	protected $txtId;
	protected $txtCedulaRif;
	protected $txtRazonSocial;
	protected $txtNombreContacto;
	protected $calFechaRegistro;
	protected $txtEmail;
	protected $txtTelefono;
	protected $txtTelefono2;
	protected $txtAvenidaCalle;
	protected $txtSectorResidencia;
	protected $txtEdificioCasa;
	protected $txtPisoApto;
	protected $txtReferencia;
	protected $txtDireccionCompleta;
	protected $lstPais;
	protected $lstSucursal;
	protected $txtClaveAcceso;
	protected $calUltimoAcceso;
	protected $lstStatus;
	protected $lstBloqueado;
	protected $txtMotivoBloqueo;
	protected $lstCiudad;
	protected $txtZonaResidenciaId;
	protected $lstEmpresa;
	protected $calFechaModificacion;
	protected $txtReceptoriaId;
	protected $txtAutorizacionTsa;
	protected $txtPrimerNombre;
	protected $txtSegundoNombre;
	protected $txtPrimerApellido;
	protected $txtSegundoApellido;
	...
	protected $txtReceptoriaHgvId;
	protected $calFechaModificacionIpostel;
	protected $txtDireccionIp;
	protected $calFechaAceptacion;
	protected $txtAceptaTerminosId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ClienteIMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctClienteI = ClienteIMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ClienteI's data fields
		$this->txtId = $this->mctClienteI->txtId_Create();
		$this->txtCedulaRif = $this->mctClienteI->txtCedulaRif_Create();
		$this->txtRazonSocial = $this->mctClienteI->txtRazonSocial_Create();
		$this->txtNombreContacto = $this->mctClienteI->txtNombreContacto_Create();
		$this->calFechaRegistro = $this->mctClienteI->calFechaRegistro_Create();
		$this->txtEmail = $this->mctClienteI->txtEmail_Create();
		$this->txtTelefono = $this->mctClienteI->txtTelefono_Create();
		$this->txtTelefono2 = $this->mctClienteI->txtTelefono2_Create();
		$this->txtAvenidaCalle = $this->mctClienteI->txtAvenidaCalle_Create();
		$this->txtSectorResidencia = $this->mctClienteI->txtSectorResidencia_Create();
		$this->txtEdificioCasa = $this->mctClienteI->txtEdificioCasa_Create();
		$this->txtPisoApto = $this->mctClienteI->txtPisoApto_Create();
		$this->txtReferencia = $this->mctClienteI->txtReferencia_Create();
		$this->txtDireccionCompleta = $this->mctClienteI->txtDireccionCompleta_Create();
		$this->lstPais = $this->mctClienteI->lstPais_Create();
		$this->lstSucursal = $this->mctClienteI->lstSucursal_Create();
		$this->txtClaveAcceso = $this->mctClienteI->txtClaveAcceso_Create();
		$this->calUltimoAcceso = $this->mctClienteI->calUltimoAcceso_Create();
		$this->lstStatus = $this->mctClienteI->lstStatus_Create();
		$this->lstBloqueado = $this->mctClienteI->lstBloqueado_Create();
		$this->txtMotivoBloqueo = $this->mctClienteI->txtMotivoBloqueo_Create();
		$this->lstCiudad = $this->mctClienteI->lstCiudad_Create();
		$this->txtZonaResidenciaId = $this->mctClienteI->txtZonaResidenciaId_Create();
		$this->lstEmpresa = $this->mctClienteI->lstEmpresa_Create();
		$this->calFechaModificacion = $this->mctClienteI->calFechaModificacion_Create();
		$this->txtReceptoriaId = $this->mctClienteI->txtReceptoriaId_Create();
		$this->txtAutorizacionTsa = $this->mctClienteI->txtAutorizacionTsa_Create();
		$this->txtPrimerNombre = $this->mctClienteI->txtPrimerNombre_Create();
		$this->txtSegundoNombre = $this->mctClienteI->txtSegundoNombre_Create();
		$this->txtPrimerApellido = $this->mctClienteI->txtPrimerApellido_Create();
		$this->txtSegundoApellido = $this->mctClienteI->txtSegundoApellido_Create();
		$this->calFechaNacimiento = $this->mctClienteI->calFechaNacimiento_Create();
		$this->txtSexo = $this->mctClienteI->txtSexo_Create();
		$this->txtEstadoCivil = $this->mctClienteI->txtEstadoCivil_Create();
		$this->txtFax = $this->mctClienteI->txtFax_Create();
		$this->txtEstadoId = $this->mctClienteI->txtEstadoId_Create();
		$this->txtMunicipioId = $this->mctClienteI->txtMunicipioId_Create();
		$this->txtParroquiaId = $this->mctClienteI->txtParroquiaId_Create();
		$this->txtSecurbarId = $this->mctClienteI->txtSecurbarId_Create();
		$this->txtReceptoriaHgvId = $this->mctClienteI->txtReceptoriaHgvId_Create();
		$this->calFechaModificacionIpostel = $this->mctClienteI->calFechaModificacionIpostel_Create();
		$this->txtDireccionIp = $this->mctClienteI->txtDireccionIp_Create();
		$this->calFechaAceptacion = $this->mctClienteI->calFechaAceptacion_Create();
		$this->txtAceptaTerminosId = $this->mctClienteI->txtAceptaTerminosId_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctClienteI->ClienteI && !isset($_SESSION['DataClienteI'])) {
            $_SESSION['DataClienteI'] = serialize(array($this->mctClienteI->ClienteI));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataClienteI']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctClienteI->ClienteI->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ClienteI';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctClienteI->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ClienteI'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctClienteI->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ClienteI',$this->mctClienteI->ClienteI->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctClienteI->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctClienteI->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/cliente_i_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ClienteIMetaControl
		$this->mctClienteI->SaveClienteI();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctClienteI->TablasRelacionadasClienteI();
		if (count($arrTablRela)) {
			$strTablRela = implode(',',$arrTablRela);
				
			//$this->txtId->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ClienteIMetaControl
			$this->mctClienteI->DeleteClienteI();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctClienteI->ClienteI->Id;
        $_SESSION['TablRefe'] = 'ClienteI';
        $_SESSION['RegiReto'] = 'cliente_i_edit.php/'.$this->mctClienteI->ClienteI->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/cliente_i_list.php');
    }
