 ...
 * of the ContenedorCkpt class.  It uses the code-generated
 * ContenedorCkptMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ContenedorCkpt columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both contenedor_ckpt_edit.php AND
 * contenedor_ckpt_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ContenedorCkptEditFormBase extends QForm {
	// Local instance of the ContenedorCkptMetaControl
	/**
	 * @var ContenedorCkptMetaControlGen mctContenedorCkpt
	 */
	protected $mctContenedorCkpt;
	...
	// Controls for ContenedorCkpt's Data Fields
	protected $lblId;
	protected $lstValijaObject;
	protected $lstSucursalObject;
	protected $lstCheckpointObject;
	protected $calFecha;
	protected $txtHora;
	protected $txtObservacion;
	protected $lstUsuarioObject;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ContenedorCkptMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctContenedorCkpt = ContenedorCkptMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ContenedorCkpt's data fields
		$this->lblId = $this->mctContenedorCkpt->lblId_Create();
		$this->lstValijaObject = $this->mctContenedorCkpt->lstValijaObject_Create();
		$this->lstSucursalObject = $this->mctContenedorCkpt->lstSucursalObject_Create();
		$this->lstCheckpointObject = $this->mctContenedorCkpt->lstCheckpointObject_Create();
		$this->calFecha = $this->mctContenedorCkpt->calFecha_Create();
		$this->txtHora = $this->mctContenedorCkpt->txtHora_Create();
		$this->txtObservacion = $this->mctContenedorCkpt->txtObservacion_Create();
		$this->lstUsuarioObject = $this->mctContenedorCkpt->lstUsuarioObject_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctContenedorCkpt->ContenedorCkpt && !isset($_SESSION['DataContenedorCkpt'])) {
            $_SESSION['DataContenedorCkpt'] = serialize(array($this->mctContenedorCkpt->ContenedorCkpt));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataContenedorCkpt']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctContenedorCkpt->ContenedorCkpt->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ContenedorCkpt';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctContenedorCkpt->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ContenedorCkpt'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctContenedorCkpt->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ContenedorCkpt',$this->mctContenedorCkpt->ContenedorCkpt->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctContenedorCkpt->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctContenedorCkpt->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/contenedor_ckpt_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctContenedorCkpt->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ContenedorCkptMetaControl
		$this->mctContenedorCkpt->SaveContenedorCkpt();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctContenedorCkpt->TablasRelacionadasContenedorCkpt();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ContenedorCkptMetaControl
			$this->mctContenedorCkpt->DeleteContenedorCkpt();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctContenedorCkpt->ContenedorCkpt->Id;
        $_SESSION['TablRefe'] = 'ContenedorCkpt';
        $_SESSION['RegiReto'] = 'contenedor_ckpt_edit.php/'.$this->mctContenedorCkpt->ContenedorCkpt->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/contenedor_ckpt_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/contenedor_ckpt_edit.php');
    }
