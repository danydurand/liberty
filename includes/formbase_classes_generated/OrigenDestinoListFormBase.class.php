<?php
	 ...
	 */
	abstract class OrigenDestinoListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list OrigenDestinos
		/**
		 * @var OrigenDestinoDataGrid dtgOrigenDestinos
		 */
		protected $dtgOrigenDestinos;
		...
		protected function Form_Create() {
			...
			$this->dtgOrigenDestinos->MetaAddColumn(QQN::OrigenDestino()->OrigenObject);
			$this->dtgOrigenDestinos->MetaAddColumn(QQN::OrigenDestino()->DestinoObject);
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'OrigenDestinos';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgOrigenDestinos);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgOrigenDestinos->ShowFilter = !$this->dtgOrigenDestinos->ShowFilter;
        }
