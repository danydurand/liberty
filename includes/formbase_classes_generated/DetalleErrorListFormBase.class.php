<?php
	 ...
	 */
	abstract class DetalleErrorListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list DetalleErrors
		/**
		 * @var DetalleErrorDataGrid dtgDetalleErrors
		 */
		protected $dtgDetalleErrors;
		...
		protected function Form_Create() {
			...
			$this->dtgDetalleErrors->AddRowAction(new QMouseOverEvent(), new QCssClassAction('selectedStyle'));
			$this->dtgDetalleErrors->AddRowAction(new QMouseOutEvent(), new QCssClassAction());

			// Add a click handler for the rows.
			// We can use $_CONTROL->CurrentRowIndex to pass the row index to dtgPersonsRow_Click()
			// or $_ITEM->Id to pass the object's id, or any other data grid variable
			$this->dtgDetalleErrors->RowActionParameterHtml = '<?= $_ITEM->Id ?>';
			$this->dtgDetalleErrors->AddRowAction(new QClickEvent(), new QAjaxAction('dtgDetalleErrorsRow_Click'));
			...
			$this->dtgDetalleErrors->MetaAddColumn('Id');
			$this->dtgDetalleErrors->MetaAddColumn('ProcesoId');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'DetalleErrors';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgDetalleErrors);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgDetalleErrors->ShowFilter = !$this->dtgDetalleErrors->ShowFilter;
        }

		public function dtgDetalleErrorsRow_Click($strFormId, $strControlId, $strParameter) {
		  $intId = intval($strParameter);
		  QApplication::Redirect("detalle_error_edit.php/$intId");
		}
