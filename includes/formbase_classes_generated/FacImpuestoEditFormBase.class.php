 ...
 * of the FacImpuesto class.  It uses the code-generated
 * FacImpuestoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacImpuesto columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both fac_impuesto_edit.php AND
 * fac_impuesto_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacImpuestoEditFormBase extends QForm {
	// Local instance of the FacImpuestoMetaControl
	/**
	 * @var FacImpuestoMetaControlGen mctFacImpuesto
	 */
	protected $mctFacImpuesto;
	...
	// Controls for FacImpuesto's Data Fields
	protected $txtSiglImpu;
	protected $calFechVige;
	protected $txtMontImpu;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacImpuestoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacImpuesto = FacImpuestoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacImpuesto's data fields
		$this->txtSiglImpu = $this->mctFacImpuesto->txtSiglImpu_Create();
		$this->calFechVige = $this->mctFacImpuesto->calFechVige_Create();
		$this->txtMontImpu = $this->mctFacImpuesto->txtMontImpu_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacImpuesto->FacImpuesto && !isset($_SESSION['DataFacImpuesto'])) {
            $_SESSION['DataFacImpuesto'] = serialize(array($this->mctFacImpuesto->FacImpuesto));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacImpuesto']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacImpuesto->FacImpuesto->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacImpuesto';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacImpuesto->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacImpuesto'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacImpuesto->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacImpuesto',$this->mctFacImpuesto->FacImpuesto->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacImpuesto->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacImpuesto->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/fac_impuesto_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacImpuesto->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacImpuestoMetaControl
		$this->mctFacImpuesto->SaveFacImpuesto();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacImpuesto->TablasRelacionadasFacImpuesto();
		if (count($arrTablRela)) {
			$strTablRela = implode(',',$arrTablRela);
				
			//$this->txtSiglImpu->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
				
			//$this->calFechVige->Warning = sprintf('Existen registros relacionados en %s',$strTablRela);
            $this->mensaje(sprintf('Existen registros relacionados en %s',$strTablRela),'m','d','hand-stop-o');
			$blnTodoOkey = false;
		}
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacImpuestoMetaControl
			$this->mctFacImpuesto->DeleteFacImpuesto();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacImpuesto->FacImpuesto->Id;
        $_SESSION['TablRefe'] = 'FacImpuesto';
        $_SESSION['RegiReto'] = 'fac_impuesto_edit.php/'.$this->mctFacImpuesto->FacImpuesto->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/fac_impuesto_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/fac_impuesto_edit.php');
    }
