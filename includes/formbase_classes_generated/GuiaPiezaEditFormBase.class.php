 ...
 * GuiaPiezaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaPieza columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_pieza_edit.php AND
 * guia_pieza_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaPiezaEditFormBase extends QForm {
	// Local instance of the GuiaPiezaMetaControl
	/**
	 * @var GuiaPiezaMetaControlGen mctGuiaPieza
	 */
	protected $mctGuiaPieza;
	...
	// Controls for GuiaPieza's Data Fields
	protected $txtId;
	protected $txtGuiaId;
	protected $txtAlto;
	protected $txtAncho;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaPiezaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaPieza = GuiaPiezaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaPieza's data fields
		$this->txtId = $this->mctGuiaPieza->txtId_Create();
		$this->txtGuiaId = $this->mctGuiaPieza->txtGuiaId_Create();
		$this->txtAlto = $this->mctGuiaPieza->txtAlto_Create();
		$this->txtAncho = $this->mctGuiaPieza->txtAncho_Create();
		$this->txtLargo = $this->mctGuiaPieza->txtLargo_Create();
		$this->txtPesoVolumetrico = $this->mctGuiaPieza->txtPesoVolumetrico_Create();
		$this->txtPesoBalanza = $this->mctGuiaPieza->txtPesoBalanza_Create();
		$this->txtDescripcion = $this->mctGuiaPieza->txtDescripcion_Create();
		$this->txtVolMaritimoPies = $this->mctGuiaPieza->txtVolMaritimoPies_Create();
		$this->txtVolMaritimoMts = $this->mctGuiaPieza->txtVolMaritimoMts_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaPieza->GuiaPieza && !isset($_SESSION['DataGuiaPieza'])) {
            $_SESSION['DataGuiaPieza'] = serialize(array($this->mctGuiaPieza->GuiaPieza));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaPieza']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaPieza->GuiaPieza->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaPieza';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaPieza->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaPieza'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaPieza->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaPieza',$this->mctGuiaPieza->GuiaPieza->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaPieza->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaPieza->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_pieza_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaPiezaMetaControl
		$this->mctGuiaPieza->SaveGuiaPieza();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaPieza->TablasRelacionadasGuiaPieza();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaPiezaMetaControl
			$this->mctGuiaPieza->DeleteGuiaPieza();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaPieza->GuiaPieza->Id;
        $_SESSION['TablRefe'] = 'GuiaPieza';
        $_SESSION['RegiReto'] = 'guia_pieza_edit.php/'.$this->mctGuiaPieza->GuiaPieza->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_pieza_list.php');
    }
