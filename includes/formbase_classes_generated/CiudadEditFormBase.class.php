 ...
 * of the Ciudad class.  It uses the code-generated
 * CiudadMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Ciudad columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both ciudad_edit.php AND
 * ciudad_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class CiudadEditFormBase extends QForm {
	// Local instance of the CiudadMetaControl
	/**
	 * @var CiudadMetaControlGen mctCiudad
	 */
	protected $mctCiudad;
	...
	// Controls for Ciudad's Data Fields
	protected $txtId;
	protected $txtNombre;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the CiudadMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctCiudad = CiudadMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Ciudad's data fields
		$this->txtId = $this->mctCiudad->txtId_Create();
		$this->txtNombre = $this->mctCiudad->txtNombre_Create();
		$this->lstSucursal = $this->mctCiudad->lstSucursal_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctCiudad->Ciudad && !isset($_SESSION['DataCiudad'])) {
            $_SESSION['DataCiudad'] = serialize(array($this->mctCiudad->Ciudad));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataCiudad']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctCiudad->Ciudad->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctCiudad->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Ciudad'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctCiudad->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Ciudad',$this->mctCiudad->Ciudad->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctCiudad->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctCiudad->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/ciudad_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the CiudadMetaControl
		$this->mctCiudad->SaveCiudad();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctCiudad->TablasRelacionadasCiudad();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the CiudadMetaControl
			$this->mctCiudad->DeleteCiudad();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctCiudad->Ciudad->Id;
        $_SESSION['TablRefe'] = 'Ciudad';
        $_SESSION['RegiReto'] = 'ciudad_edit.php/'.$this->mctCiudad->Ciudad->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/ciudad_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/ciudad_edit.php');
    }
