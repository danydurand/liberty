<?php
	 ...
	 */
	abstract class NewGrupoListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list NewGrupos
		/**
		 * @var NewGrupoDataGrid dtgNewGrupos
		 */
		protected $dtgNewGrupos;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'NewGrupos';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgNewGrupos);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgNewGrupos->ShowFilter = !$this->dtgNewGrupos->ShowFilter;
        }
