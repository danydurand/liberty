 ...
 * of the PlantillaPago class.  It uses the code-generated
 * PlantillaPagoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a PlantillaPago columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both plantilla_pago_edit.php AND
 * plantilla_pago_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PlantillaPagoEditFormBase extends QForm {
	// Local instance of the PlantillaPagoMetaControl
	/**
	 * @var PlantillaPagoMetaControlGen mctPlantillaPago
	 */
	protected $mctPlantillaPago;
	...
	// Controls for PlantillaPago's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PlantillaPagoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPlantillaPago = PlantillaPagoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on PlantillaPago's data fields
		$this->lblId = $this->mctPlantillaPago->lblId_Create();
		$this->txtFechaEmail = $this->mctPlantillaPago->txtFechaEmail_Create();
		$this->calFechaRegistro = $this->mctPlantillaPago->calFechaRegistro_Create();
		$this->txtHoraRegistro = $this->mctPlantillaPago->txtHoraRegistro_Create();
		$this->txtEmail = $this->mctPlantillaPago->txtEmail_Create();
		$this->txtProcesado = $this->mctPlantillaPago->txtProcesado_Create();
		$this->calFechaProcesado = $this->mctPlantillaPago->calFechaProcesado_Create();
		$this->txtHoraProcesado = $this->mctPlantillaPago->txtHoraProcesado_Create();
		$this->txtStatus = $this->mctPlantillaPago->txtStatus_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPlantillaPago->PlantillaPago && !isset($_SESSION['DataPlantillaPago'])) {
            $_SESSION['DataPlantillaPago'] = serialize(array($this->mctPlantillaPago->PlantillaPago));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPlantillaPago']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPlantillaPago->PlantillaPago->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PlantillaPago';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPlantillaPago->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PlantillaPago'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPlantillaPago->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('PlantillaPago',$this->mctPlantillaPago->PlantillaPago->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPlantillaPago->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPlantillaPago->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/plantilla_pago_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctPlantillaPago->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PlantillaPagoMetaControl
		$this->mctPlantillaPago->SavePlantillaPago();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPlantillaPago->TablasRelacionadasPlantillaPago();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PlantillaPagoMetaControl
			$this->mctPlantillaPago->DeletePlantillaPago();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPlantillaPago->PlantillaPago->Id;
        $_SESSION['TablRefe'] = 'PlantillaPago';
        $_SESSION['RegiReto'] = 'plantilla_pago_edit.php/'.$this->mctPlantillaPago->PlantillaPago->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/plantilla_pago_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/plantilla_pago_edit.php');
    }
