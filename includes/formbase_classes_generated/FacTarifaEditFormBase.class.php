 ...
 */
abstract class FacTarifaEditFormBase extends QForm {
	// Local instance of the FacTarifaMetaControl
	/**
	 * @var FacTarifaMetaControlGen mctFacTarifa
	 */
	protected $mctFacTarifa;
	...
	// Controls for FacTarifa's Data Fields
	protected $lblId;
	protected $txtDescripcion;
	protected $lstTipoTarifaObject;
	protected $txtPesoInicial;
	protected $txtValorIncremento;
	protected $lstMedidaIncrementoObject;
	protected $txtPorcentajeSobreValor;
	protected $txtVolumenParaDscto;
	protected $txtDsctoPorVolumen;
	protected $txtPesoParaDscto;
	protected $txtDsctoPorPeso;
	protected $txtMontoMinimo;
	protected $txtCostoParadaAdicional;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacTarifa';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacTarifa->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacTarifa'))));
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacTarifa->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacTarifa->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objFacTarifa = FacTarifa::LoadByDescripcion($this->txtDescripcion->Text)) && ($objFacTarifa->Id != $this->mctFacTarifa->FacTarifa->Id )){
				$blnToReturn = false;
				$this->txtDescripcion->Warning = QApplication::Translate("Already in Use");
			}
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacTarifaMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacTarifaMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacTarifa->FacTarifa->Id;
        $_SESSION['TablRefe'] = 'FacTarifa';
        $_SESSION['RegiReto'] = 'fac_tarifa_edit.php/'.$this->mctFacTarifa->FacTarifa->Id;
    ...
    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/fac_tarifa_edit.php');
    }
