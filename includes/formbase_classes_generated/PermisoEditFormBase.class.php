 ...
 * of the Permiso class.  It uses the code-generated
 * PermisoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Permiso columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both permiso_edit.php AND
 * permiso_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PermisoEditFormBase extends QForm {
	// Local instance of the PermisoMetaControl
	/**
	 * @var PermisoMetaControlGen mctPermiso
	 */
	protected $mctPermiso;
	...
	// Controls for Permiso's Data Fields
	protected $lblId;
	protected $lstGrupo;
	protected $lstOpcion;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PermisoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPermiso = PermisoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Permiso's data fields
		$this->lblId = $this->mctPermiso->lblId_Create();
		$this->lstGrupo = $this->mctPermiso->lstGrupo_Create();
		$this->lstOpcion = $this->mctPermiso->lstOpcion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPermiso->Permiso && !isset($_SESSION['DataPermiso'])) {
            $_SESSION['DataPermiso'] = serialize(array($this->mctPermiso->Permiso));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPermiso']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPermiso->Permiso->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPermiso->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Permiso'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPermiso->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Permiso',$this->mctPermiso->Permiso->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPermiso->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPermiso->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objPermiso = Permiso::LoadByGrupoIdOpcionId($this->lstGrupo->SelectedValue,$this->lstOpcion->SelectedValue)) && ($objPermiso->Id != $this->mctPermiso->Permiso->Id )){
				$blnToReturn = false;
				$this->lstGrupo->Warning = QApplication::Translate("Already in Use");
				$this->lstOpcion->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/permiso_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PermisoMetaControl
		$this->mctPermiso->SavePermiso();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPermiso->TablasRelacionadasPermiso();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PermisoMetaControl
			$this->mctPermiso->DeletePermiso();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPermiso->Permiso->Id;
        $_SESSION['TablRefe'] = 'Permiso';
        $_SESSION['RegiReto'] = 'permiso_edit.php/'.$this->mctPermiso->Permiso->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/permiso_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/permiso_edit.php');
    }
