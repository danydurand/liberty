<?php
	 ...
	 */
	abstract class FormaPagoListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list FormaPagos
		/**
		 * @var FormaPagoDataGrid dtgFormaPagos
		 */
		protected $dtgFormaPagos;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'FormaPagos';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgFormaPagos);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgFormaPagos->ShowFilter = !$this->dtgFormaPagos->ShowFilter;
        }
