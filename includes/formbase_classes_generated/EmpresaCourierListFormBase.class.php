<?php
	 ...
	 */
	abstract class EmpresaCourierListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list EmpresaCouriers
		/**
		 * @var EmpresaCourierDataGrid dtgEmpresaCouriers
		 */
		protected $dtgEmpresaCouriers;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'EmpresaCouriers';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgEmpresaCouriers);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgEmpresaCouriers->ShowFilter = !$this->dtgEmpresaCouriers->ShowFilter;
        }
