 ...
 * GuiaCkptMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaCkpt columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_ckpt_edit.php AND
 * guia_ckpt_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaCkptEditFormBase extends QForm {
	// Local instance of the GuiaCkptMetaControl
	/**
	 * @var GuiaCkptMetaControlGen mctGuiaCkpt
	 */
	protected $mctGuiaCkpt;
	...
	// Controls for GuiaCkpt's Data Fields
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaCkptMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaCkpt = GuiaCkptMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaCkpt's data fields
		$this->lstNumeGuiaObject = $this->mctGuiaCkpt->lstNumeGuiaObject_Create();
		$this->lstCodiEstaObject = $this->mctGuiaCkpt->lstCodiEstaObject_Create();
		$this->lstCodiCkptObject = $this->mctGuiaCkpt->lstCodiCkptObject_Create();
		$this->calFechCkpt = $this->mctGuiaCkpt->calFechCkpt_Create();
		$this->txtHoraCkpt = $this->mctGuiaCkpt->txtHoraCkpt_Create();
		$this->txtTextObse = $this->mctGuiaCkpt->txtTextObse_Create();
		$this->txtCodiRuta = $this->mctGuiaCkpt->txtCodiRuta_Create();
		$this->lstCodiUsuaObject = $this->mctGuiaCkpt->lstCodiUsuaObject_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaCkpt->GuiaCkpt && !isset($_SESSION['DataGuiaCkpt'])) {
            $_SESSION['DataGuiaCkpt'] = serialize(array($this->mctGuiaCkpt->GuiaCkpt));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaCkpt']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaCkpt->GuiaCkpt->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaCkpt';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaCkpt->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaCkpt'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaCkpt->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaCkpt',$this->mctGuiaCkpt->GuiaCkpt->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaCkpt->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaCkpt->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_ckpt_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaCkptMetaControl
		$this->mctGuiaCkpt->SaveGuiaCkpt();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaCkpt->TablasRelacionadasGuiaCkpt();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaCkptMetaControl
			$this->mctGuiaCkpt->DeleteGuiaCkpt();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaCkpt->GuiaCkpt->Id;
        $_SESSION['TablRefe'] = 'GuiaCkpt';
        $_SESSION['RegiReto'] = 'guia_ckpt_edit.php/'.$this->mctGuiaCkpt->GuiaCkpt->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_ckpt_list.php');
    }
