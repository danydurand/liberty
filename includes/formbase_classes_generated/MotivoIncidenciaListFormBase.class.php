<?php
	 ...
	 */
	abstract class MotivoIncidenciaListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list MotivoIncidencias
		/**
		 * @var MotivoIncidenciaDataGrid dtgMotivoIncidencias
		 */
		protected $dtgMotivoIncidencias;
		...
		protected function Form_Create() {
			...
			$this->dtgMotivoIncidencias->ShowFilter = false;

			// Add Pagination (if desired)
			$this->dtgMotivoIncidencias->Paginator = new QPaginator($this->dtgMotivoIncidencias);
			$this->dtgMotivoIncidencias->ItemsPerPage = __FORM_DRAFTS_FORM_LIST_ITEMS_PER_PAGE__;
			...
			$this->dtgMotivoIncidencias->MetaAddColumn('Id');
			$this->dtgMotivoIncidencias->MetaAddColumn('Codigo');
			$this->dtgMotivoIncidencias->MetaAddColumn('Nombre');
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'MotivoIncidencias';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgMotivoIncidencias);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgMotivoIncidencias->ShowFilter = !$this->dtgMotivoIncidencias->ShowFilter;
        }
