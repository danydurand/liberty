 ...
 */
abstract class ClientePmnEditFormBase extends QForm {
	// Local instance of the ClientePmnMetaControl
	/**
	 * @var ClientePmnMetaControlGen mctClientePmn
	 */
	protected $mctClientePmn;
	...
	// Controls for ClientePmn's Data Fields
	protected $txtCedulaRif;
	protected $txtNombre;
	protected $txtTelefonoFijo;
	protected $txtTelefonoMovil;
	protected $txtDireccion;
	protected $txtSucursalId;
	protected $calRegistradoEl;
	protected $lstRegistradoPorObject;
	protected $txtEmail;
    ...
    protected function determinarPosicion() {
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctClientePmn->ClientePmn->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ClientePmn';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctClientePmn->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ClientePmn'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctClientePmn->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ClientePmn',$this->mctClientePmn->ClientePmn->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctClientePmn->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctClientePmn->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/cliente_pmn_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ClientePmnMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctClientePmn->TablasRelacionadasClientePmn();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ClientePmnMetaControl
			$this->mctClientePmn->DeleteClientePmn();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctClientePmn->ClientePmn->Id;
        $_SESSION['TablRefe'] = 'ClientePmn';
        $_SESSION['RegiReto'] = 'cliente_pmn_edit.php/'.$this->mctClientePmn->ClientePmn->Id;
