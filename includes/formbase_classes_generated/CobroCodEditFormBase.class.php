 ...
 * of the CobroCod class.  It uses the code-generated
 * CobroCodMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a CobroCod columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both cobro_cod_edit.php AND
 * cobro_cod_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class CobroCodEditFormBase extends QForm {
	// Local instance of the CobroCodMetaControl
	/**
	 * @var CobroCodMetaControlGen mctCobroCod
	 */
	protected $mctCobroCod;
	...
	// Controls for CobroCod's Data Fields
	protected $lstNumeGuiaObject;
	protected $txtMontoCancelado;
	protected $txtRecibioElPago;
	protected $lstTipoDocumentoObject;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the CobroCodMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctCobroCod = CobroCodMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on CobroCod's data fields
		$this->lstNumeGuiaObject = $this->mctCobroCod->lstNumeGuiaObject_Create();
		$this->txtMontoCancelado = $this->mctCobroCod->txtMontoCancelado_Create();
		$this->txtRecibioElPago = $this->mctCobroCod->txtRecibioElPago_Create();
		$this->lstTipoDocumentoObject = $this->mctCobroCod->lstTipoDocumentoObject_Create();
		$this->txtNumeroDocumento = $this->mctCobroCod->txtNumeroDocumento_Create();
		$this->calFechaPago = $this->mctCobroCod->calFechaPago_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctCobroCod->CobroCod && !isset($_SESSION['DataCobroCod'])) {
            $_SESSION['DataCobroCod'] = serialize(array($this->mctCobroCod->CobroCod));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataCobroCod']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctCobroCod->CobroCod->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'CobroCod';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctCobroCod->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('CobroCod'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctCobroCod->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('CobroCod',$this->mctCobroCod->CobroCod->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctCobroCod->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctCobroCod->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/cobro_cod_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the CobroCodMetaControl
		$this->mctCobroCod->SaveCobroCod();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctCobroCod->TablasRelacionadasCobroCod();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the CobroCodMetaControl
			$this->mctCobroCod->DeleteCobroCod();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctCobroCod->CobroCod->Id;
        $_SESSION['TablRefe'] = 'CobroCod';
        $_SESSION['RegiReto'] = 'cobro_cod_edit.php/'.$this->mctCobroCod->CobroCod->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/cobro_cod_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/cobro_cod_edit.php');
    }
