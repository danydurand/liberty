 ...
 * of the TipoDocumento class.  It uses the code-generated
 * TipoDocumentoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a TipoDocumento columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both tipo_documento_edit.php AND
 * tipo_documento_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class TipoDocumentoEditFormBase extends QForm {
	// Local instance of the TipoDocumentoMetaControl
	/**
	 * @var TipoDocumentoMetaControlGen mctTipoDocumento
	 */
	protected $mctTipoDocumento;
	...
	// Controls for TipoDocumento's Data Fields
	protected $txtId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the TipoDocumentoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctTipoDocumento = TipoDocumentoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on TipoDocumento's data fields
		$this->txtId = $this->mctTipoDocumento->txtId_Create();
		$this->txtDescripcion = $this->mctTipoDocumento->txtDescripcion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctTipoDocumento->TipoDocumento && !isset($_SESSION['DataTipoDocumento'])) {
            $_SESSION['DataTipoDocumento'] = serialize(array($this->mctTipoDocumento->TipoDocumento));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataTipoDocumento']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctTipoDocumento->TipoDocumento->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'TipoDocumento';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTipoDocumento->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('TipoDocumento'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTipoDocumento->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('TipoDocumento',$this->mctTipoDocumento->TipoDocumento->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTipoDocumento->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTipoDocumento->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/tipo_documento_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctTipoDocumento->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TipoDocumentoMetaControl
		$this->mctTipoDocumento->SaveTipoDocumento();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctTipoDocumento->TablasRelacionadasTipoDocumento();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TipoDocumentoMetaControl
			$this->mctTipoDocumento->DeleteTipoDocumento();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTipoDocumento->TipoDocumento->Id;
        $_SESSION['TablRefe'] = 'TipoDocumento';
        $_SESSION['RegiReto'] = 'tipo_documento_edit.php/'.$this->mctTipoDocumento->TipoDocumento->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tipo_documento_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/tipo_documento_edit.php');
    }
