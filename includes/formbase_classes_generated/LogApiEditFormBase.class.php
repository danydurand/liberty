 ...
 * of the LogApi class.  It uses the code-generated
 * LogApiMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a LogApi columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both log_api_edit.php AND
 * log_api_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class LogApiEditFormBase extends QForm {
	// Local instance of the LogApiMetaControl
	/**
	 * @var LogApiMetaControlGen mctLogApi
	 */
	protected $mctLogApi;
	...
	// Controls for LogApi's Data Fields
	protected $lblId;
	protected $calFecha;
	protected $calHora;
	protected $txtTabla;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the LogApiMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctLogApi = LogApiMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on LogApi's data fields
		$this->lblId = $this->mctLogApi->lblId_Create();
		$this->calFecha = $this->mctLogApi->calFecha_Create();
		$this->calHora = $this->mctLogApi->calHora_Create();
		$this->txtTabla = $this->mctLogApi->txtTabla_Create();
		$this->txtReferencia = $this->mctLogApi->txtReferencia_Create();
		$this->txtNombre = $this->mctLogApi->txtNombre_Create();
		$this->txtAccion = $this->mctLogApi->txtAccion_Create();
		$this->txtDescripcion = $this->mctLogApi->txtDescripcion_Create();
		$this->txtResultadoId = $this->mctLogApi->txtResultadoId_Create();
		$this->txtTipo = $this->mctLogApi->txtTipo_Create();
		$this->txtToken = $this->mctLogApi->txtToken_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctLogApi->LogApi && !isset($_SESSION['DataLogApi'])) {
            $_SESSION['DataLogApi'] = serialize(array($this->mctLogApi->LogApi));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataLogApi']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctLogApi->LogApi->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctLogApi->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('LogApi'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctLogApi->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('LogApi',$this->mctLogApi->LogApi->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctLogApi->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctLogApi->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/log_api_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the LogApiMetaControl
		$this->mctLogApi->SaveLogApi();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctLogApi->TablasRelacionadasLogApi();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the LogApiMetaControl
			$this->mctLogApi->DeleteLogApi();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctLogApi->LogApi->Id;
        $_SESSION['TablRefe'] = 'LogApi';
        $_SESSION['RegiReto'] = 'log_api_edit.php/'.$this->mctLogApi->LogApi->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/log_api_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/log_api_edit.php');
    }
