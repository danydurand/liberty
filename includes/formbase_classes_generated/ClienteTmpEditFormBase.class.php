 ...
 */
abstract class ClienteTmpEditFormBase extends QForm {
	// Local instance of the ClienteTmpMetaControl
	/**
	 * @var ClienteTmpMetaControlGen mctClienteTmp
	 */
	protected $mctClienteTmp;
	...
	// Controls for ClienteTmp's Data Fields
	protected $lblId;
	...
	protected $txtEmail;
	protected $txtMasterId;
	protected $calFechCarg;
	protected $calHoraCarg;
	protected $txtOtraSucursal;
	...
	protected function Form_Create() {
		...
		$this->lblId = $this->mctClienteTmp->lblId_Create();
		...
		$this->txtPersCona = $this->mctClienteTmp->txtPersCona_Create();
		$this->txtTeleCona = $this->mctClienteTmp->txtTeleCona_Create();
		$this->txtEmail = $this->mctClienteTmp->txtEmail_Create();
		$this->txtMasterId = $this->mctClienteTmp->txtMasterId_Create();
		$this->calFechCarg = $this->mctClienteTmp->calFechCarg_Create();
		$this->calHoraCarg = $this->mctClienteTmp->calHoraCarg_Create();
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ClienteTmp';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctClienteTmp->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ClienteTmp'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctClienteTmp->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctClienteTmp->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctClienteTmp->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objClienteTmp = ClienteTmp::LoadByCodigoContrato($this->txtCodigoContrato->Text)) && ($objClienteTmp->Id != $this->mctClienteTmp->ClienteTmp->Id )){
				$blnToReturn = false;
				$this->txtCodigoContrato->Warning = QApplication::Translate("Already in Use");
			}
			if (($objClienteTmp = ClienteTmp::LoadByEmail($this->txtEmail->Text)) && ($objClienteTmp->Id != $this->mctClienteTmp->ClienteTmp->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ClienteTmpMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ClienteTmpMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctClienteTmp->ClienteTmp->Id;
        $_SESSION['TablRefe'] = 'ClienteTmp';
        $_SESSION['RegiReto'] = 'cliente_tmp_edit.php/'.$this->mctClienteTmp->ClienteTmp->Id;
