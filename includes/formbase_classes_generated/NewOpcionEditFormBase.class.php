 ...
 */
abstract class NewOpcionEditFormBase extends QForm {
	// Local instance of the NewOpcionMetaControl
	/**
	 * @var NewOpcionMetaControlGen mctNewOpcion
	 */
	protected $mctNewOpcion;
	...
	// Controls for NewOpcion's Data Fields
	protected $lblId;
	protected $txtNombre;
	...
	protected $txtDirectorio;
	protected $lstDependenciaObject;
	protected $txtPosicion;
	protected $txtImagen;
	protected $txtNivel;
	protected $chkUsoGeneral;
    ...
    protected function determinarPosicion() {
        if ($this->mctNewOpcion->NewOpcion && !isset($_SESSION['DataNewOpcion'])) {
            $_SESSION['DataNewOpcion'] = serialize(array($this->mctNewOpcion->NewOpcion));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataNewOpcion']);
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'NewOpcion';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctNewOpcion->EditMode;
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctNewOpcion->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctNewOpcion->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the NewOpcionMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctNewOpcion->TablasRelacionadasNewOpcion();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the NewOpcionMetaControl
			$this->mctNewOpcion->DeleteNewOpcion();
			$this->RedirectToListPage();
		}
	}
