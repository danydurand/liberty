 ...
 * of the Promocion class.  It uses the code-generated
 * PromocionMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Promocion columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both promocion_edit.php AND
 * promocion_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PromocionEditFormBase extends QForm {
	// Local instance of the PromocionMetaControl
	/**
	 * @var PromocionMetaControlGen mctPromocion
	 */
	protected $mctPromocion;
	...
	// Controls for Promocion's Data Fields
	protected $txtId;
	...
	protected $lstStatus;
	protected $lstPais;
	protected $txtFormaAplicaId;
	protected $txtParaTodasId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PromocionMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPromocion = PromocionMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Promocion's data fields
		$this->txtId = $this->mctPromocion->txtId_Create();
		$this->txtDescripcion = $this->mctPromocion->txtDescripcion_Create();
		$this->txtMontoBase = $this->mctPromocion->txtMontoBase_Create();
		$this->txtPorcentajeSgro = $this->mctPromocion->txtPorcentajeSgro_Create();
		$this->lstStatus = $this->mctPromocion->lstStatus_Create();
		$this->lstPais = $this->mctPromocion->lstPais_Create();
		$this->txtFormaAplicaId = $this->mctPromocion->txtFormaAplicaId_Create();
		$this->txtParaTodasId = $this->mctPromocion->txtParaTodasId_Create();
		$this->calFechaInicial = $this->mctPromocion->calFechaInicial_Create();
		$this->calFechaFinal = $this->mctPromocion->calFechaFinal_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPromocion->Promocion && !isset($_SESSION['DataPromocion'])) {
            $_SESSION['DataPromocion'] = serialize(array($this->mctPromocion->Promocion));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPromocion']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPromocion->Promocion->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Promocion';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPromocion->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Promocion'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPromocion->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Promocion',$this->mctPromocion->Promocion->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPromocion->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPromocion->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/promocion_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PromocionMetaControl
		$this->mctPromocion->SavePromocion();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPromocion->TablasRelacionadasPromocion();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PromocionMetaControl
			$this->mctPromocion->DeletePromocion();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPromocion->Promocion->Id;
        $_SESSION['TablRefe'] = 'Promocion';
        $_SESSION['RegiReto'] = 'promocion_edit.php/'.$this->mctPromocion->Promocion->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/promocion_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/promocion_edit.php');
    }
