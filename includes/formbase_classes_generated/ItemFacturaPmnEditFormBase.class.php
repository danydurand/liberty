 ...
 * ItemFacturaPmnMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ItemFacturaPmn columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both item_factura_pmn_edit.php AND
 * item_factura_pmn_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ItemFacturaPmnEditFormBase extends QForm {
	// Local instance of the ItemFacturaPmnMetaControl
	/**
	 * @var ItemFacturaPmnMetaControlGen mctItemFacturaPmn
	 */
	protected $mctItemFacturaPmn;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ItemFacturaPmnMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctItemFacturaPmn = ItemFacturaPmnMetaControl::CreateFromPathInfo($this);
		...
		$this->txtMontoFranqueo = $this->mctItemFacturaPmn->txtMontoFranqueo_Create();
		$this->txtPorcentajeIva = $this->mctItemFacturaPmn->txtPorcentajeIva_Create();
		$this->txtMontoIva = $this->mctItemFacturaPmn->txtMontoIva_Create();
		$this->txtMontoSeguro = $this->mctItemFacturaPmn->txtMontoSeguro_Create();
		$this->txtMontoOtros = $this->mctItemFacturaPmn->txtMontoOtros_Create();
		$this->txtMontoTotal = $this->mctItemFacturaPmn->txtMontoTotal_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctItemFacturaPmn->ItemFacturaPmn && !isset($_SESSION['DataItemFacturaPmn'])) {
            $_SESSION['DataItemFacturaPmn'] = serialize(array($this->mctItemFacturaPmn->ItemFacturaPmn));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataItemFacturaPmn']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctItemFacturaPmn->ItemFacturaPmn->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ItemFacturaPmn';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctItemFacturaPmn->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ItemFacturaPmn'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctItemFacturaPmn->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ItemFacturaPmn',$this->mctItemFacturaPmn->ItemFacturaPmn->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctItemFacturaPmn->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctItemFacturaPmn->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/item_factura_pmn_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctItemFacturaPmn->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ItemFacturaPmnMetaControl
		$this->mctItemFacturaPmn->SaveItemFacturaPmn();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctItemFacturaPmn->TablasRelacionadasItemFacturaPmn();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ItemFacturaPmnMetaControl
			$this->mctItemFacturaPmn->DeleteItemFacturaPmn();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctItemFacturaPmn->ItemFacturaPmn->Id;
        $_SESSION['TablRefe'] = 'ItemFacturaPmn';
        $_SESSION['RegiReto'] = 'item_factura_pmn_edit.php/'.$this->mctItemFacturaPmn->ItemFacturaPmn->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/item_factura_pmn_list.php');
    }
