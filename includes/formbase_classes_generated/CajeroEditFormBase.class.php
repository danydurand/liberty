 ...
 * of the Cajero class.  It uses the code-generated
 * CajeroMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Cajero columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both cajero_edit.php AND
 * cajero_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class CajeroEditFormBase extends QForm {
	// Local instance of the CajeroMetaControl
	/**
	 * @var CajeroMetaControlGen mctCajero
	 */
	protected $mctCajero;
	...
	// Controls for Cajero's Data Fields
	protected $lblId;
	protected $lstUsuario;
	protected $lstCounter;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the CajeroMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctCajero = CajeroMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Cajero's data fields
		$this->lblId = $this->mctCajero->lblId_Create();
		$this->lstUsuario = $this->mctCajero->lstUsuario_Create();
		$this->lstCounter = $this->mctCajero->lstCounter_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctCajero->Cajero && !isset($_SESSION['DataCajero'])) {
            $_SESSION['DataCajero'] = serialize(array($this->mctCajero->Cajero));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataCajero']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctCajero->Cajero->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctCajero->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Cajero'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctCajero->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Cajero',$this->mctCajero->Cajero->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctCajero->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctCajero->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objCajero = Cajero::LoadByUsuarioId($this->lstUsuario->SelectedValue)) && ($objCajero->Id != $this->mctCajero->Cajero->Id )){
				$blnToReturn = false;
				$this->lstUsuario->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/cajero_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the CajeroMetaControl
		$this->mctCajero->SaveCajero();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctCajero->TablasRelacionadasCajero();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the CajeroMetaControl
			$this->mctCajero->DeleteCajero();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctCajero->Cajero->Id;
        $_SESSION['TablRefe'] = 'Cajero';
        $_SESSION['RegiReto'] = 'cajero_edit.php/'.$this->mctCajero->Cajero->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/cajero_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/cajero_edit.php');
    }
