 ...
 */
abstract class NewGrupoEditFormBase extends QForm {
	// Local instance of the NewGrupoMetaControl
	/**
	 * @var NewGrupoMetaControlGen mctNewGrupo
	 */
	protected $mctNewGrupo;
	...
	// Controls for NewGrupo's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $chkActivo;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'NewGrupo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctNewGrupo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('NewGrupo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctNewGrupo->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctNewGrupo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctNewGrupo->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the NewGrupoMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the NewGrupoMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctNewGrupo->NewGrupo->Id;
        $_SESSION['TablRefe'] = 'NewGrupo';
        $_SESSION['RegiReto'] = 'new_grupo_edit.php/'.$this->mctNewGrupo->NewGrupo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/new_grupo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/new_grupo_edit.php');
    }
