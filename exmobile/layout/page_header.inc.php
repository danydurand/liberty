        <?php
            if (isset($_SESSION['User'])) {
                ...
                $strLogiUsua = $objUsuaMobi->Nombre; 
                //$strAcceMobi = $objUsuaMobi->FechaAccesoMobile.' '.$objUsuaMobi->HoraAccesoMobile;
        ...
        <div data-role="panel" id="panel" data-position="right" data-theme="a" data-display="overlay">
            ...
            <nav>
                ...
                <!-- <div class="ui-block-a"><a href="menu.php?m=o" type="button" data-role="button" id="pbtn" data-theme="b"><i class="fa fa-lg fa-list pull-left"></i>Opciones Extra</a></div> -->
                <div class="ui-block-a"><a href="perfil.php" type="button" data-role="button" id="pbtn" data-theme="d"><i class="fa fa-lg fa-user pull-left"></i>Mi Perfil</a></div>
