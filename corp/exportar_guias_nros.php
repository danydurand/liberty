<?php
//---------------------------------------------------------------------------------------------------
// Programa       : exportar_guias_nros.php
// Realizado por  : Daniel Durand
// Fecha Elab.    : 03/05/2018
...
if (!isset($_SESSION['NrosGuia'])) {
    echo "No se han propocionado las guías a Exportar";
    return;
}

$objUsuario    = unserialize($_SESSION['User']);
$arrNrosGuia   = $_SESSION['NrosGuia'];
$objClauWher   = QQ::Clause();
$objClauWher[] = QQ::In(QQN::Guia()->NumeGuia,$arrNrosGuia) ;
