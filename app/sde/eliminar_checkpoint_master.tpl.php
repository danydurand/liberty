<?php
$strPageTitle = QApplication::Translate('Eliminar Checkpoint Master');
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12" style="margin-top: 1em;">
                    <?php $this->txtBuscMani->RenderWithName(); ?>
                    <?php $this->lstManiCkpt->RenderWithName(); ?>
                    <?php $this->lstChecMani->RenderWithName(); ?>
                </div>
            </div>
        </div>
    </div>
