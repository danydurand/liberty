<?php
// This is the HTML template include file (.tpl.php) for the ruta_edit.php
// form DRAFT page.  Remember that this is a DRAFT.  It is MEANT to be altered/modified.

// Be sure to move this out of the generated/ subdirectory before modifying to ensure that subsequent
// code re-generations do not overwrite your changes.
$strPageTitle = $this->mctRuta->TitleVerb.' Ruta';
    ...
    <div class="form-controls">
	    <div class="container-fluid">
	        ...
	        <div class="row">
	            ...
	            <?php $this->txtCodiRuta->RenderWithName(); ?>
					<?php $this->txtDescRuta->RenderWithName(); ?>
					<?php $this->txtTextObse->RenderWithName(); ?>
					<?php $this->lstCodiEstaObject->RenderWithName(); ?>
					<?php $this->lstTipoRutaObject->RenderWithName(); ?>
