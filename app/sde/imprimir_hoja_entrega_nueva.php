...
if ($objManifiesto) {
    ...
    $strDescRuta  = $objManifiesto->CodiOperObject->CodiRutaObject->DescRuta.' (';
    $strDescRuta .= $objManifiesto->NombreChofer.')';
    //--------------------------------------------------------------------------------------------
    ...
    $strMensaje .= 'He recibido la cantidad de '.count($arrRegiDato).' bultos pertenecientes a Clientes de |'.$strNombEmpr.', para ser distribuidas ';
...
//    $pdf->setVariables($arrEncaColu,$arrJustColu,$arrAnchColu,2,$strlogo,$strMensaje,$objManifiesto->CodiOperObject->CodiRuta,$strNumeMani);
