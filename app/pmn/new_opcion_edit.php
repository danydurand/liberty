...
class NewOpcionEditForm extends NewOpcionEditFormBase {
	...
	protected function Form_Create() {
        ...
        $objSistOpci = Sistema::LoadByCodiSist($_SESSION['Sistema']);

		$this->lstSistema = $this->mctNewOpcion->lstSistema_Create();
        $this->lstSistema->RemoveAllItems();
        $this->lstSistema->AddItem($objSistOpci->DescSist, $objSistOpci->CodiSist, true);
        ...
        $this->lstSistema->Enabled = false;
        $this->lstSistema->ForeColor = 'blue';
        ...
        $objClauWher[] = QQ::Equal(QQN::NewOpcion()->Sistema->CodiSist,$_SESSION['Sistema']);
