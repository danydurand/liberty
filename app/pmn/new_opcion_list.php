...
class NewOpcionListForm extends NewOpcionListFormBase {
	...
	protected function Form_Create() {
        ...
        $this->dtgNewOpcions->AdditionalConditions = QQ::Equal(QQN::NewOpcion()->SistemaId,'pmn');
		...
		//$colOpciDepe->Filter = QQ::Like(QQN::NewOpcion()->DependenciaObject->Dependencia,null);
		//$colOpciDepe->FilterPrefix = $colOpciDepe->FilterPostfix = '%';
