...
require_once(__FORMBASE_CLASSES__ . '/LugarIncidenciaEditFormBase.class.php');
 ...
 * @subpackage Drafts
 */
class LugarIncidenciaEditForm extends LugarIncidenciaEditFormBase {
...
//	protected function Form_Load() {}
	...
	protected function lblTituForm_Create() {
		...
		$this->lblTituForm->Text = 'Crear/Editar Lugar Incidencia';
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__INC__.'/lugar_incidencia_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		...
		//--------------------------------------------
		$objRegiViej = clone $this->mctLugarIncidencia->LugarIncidencia;
		...
		if ($this->mctLugarIncidencia->EditMode) {
			...
			//---------------------------------------------------------------------
			$objRegiNuev = $this->mctLugarIncidencia->LugarIncidencia;
			$objResuComp = QObjectDiff::Compare($objRegiViej, $objRegiNuev);
			if ($objResuComp->FriendlyComparisonStatus == 'different') {
				//------------------------------------------
				// En caso de que el objeto haya cambiado 
				//------------------------------------------
				$arrLogxCamb['strNombTabl'] = 'LugarIncidencia';
				$arrLogxCamb['intRefeRegi'] = $this->mctLugarIncidencia->LugarIncidencia->Id;
				$arrLogxCamb['strNombRegi'] = $this->mctLugarIncidencia->LugarIncidencia->Nombre;
...
// lugar_incidencia_edit.tpl.php as the included HTML template file
LugarIncidenciaEditForm::Run('LugarIncidenciaEditForm');
?>
